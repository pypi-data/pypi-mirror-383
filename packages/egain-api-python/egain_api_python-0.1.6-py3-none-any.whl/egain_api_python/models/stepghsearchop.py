...
class StepGHSearchRequestTypedDict(TypedDict):
    ...
    gh_step_search_request: GHStepSearchRequestTypedDict
...
class StepGHSearchRequest(BaseModel):
    ...
    gh_step_search_request: Annotated[
        GHStepSearchRequest,
