...
class CreateFederatedSearchResultEventRequestTypedDict(TypedDict):
    ...
    create_federated_search_event: CreateFederatedSearchEventTypedDict


class CreateFederatedSearchResultEventRequest(BaseModel):
    ...
    create_federated_search_event: Annotated[
        CreateFederatedSearchEvent,
