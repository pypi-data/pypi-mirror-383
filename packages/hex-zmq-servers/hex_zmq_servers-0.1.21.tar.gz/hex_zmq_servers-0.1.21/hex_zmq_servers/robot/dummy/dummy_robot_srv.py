...
try:
    ...
    from hex_zmq_servers.robot.dummy.dummy_robot import HexDummyRobot
...
class HexDummyRobotServer(HexRobotServerBase):
    ...
    def __init__(
        ...
        # robot
        self._device = HexDummyRobot(params_config)
...
if __name__ == "__main__":
    ...
    hex_server_helper(cfg, HexDummyRobotServer)
