#!/usr/bin/env python3
"""
System prompts, templates, and user-facing strings for the Codex weather demo.
"""
...
WELCOME_MESSAGE = """🌤️ Welcome to the Codex Client Weather Demo!

I'm your weather assistant powered by the Codex Client framework with real-time weather data from wttr.in. I can help you with:
