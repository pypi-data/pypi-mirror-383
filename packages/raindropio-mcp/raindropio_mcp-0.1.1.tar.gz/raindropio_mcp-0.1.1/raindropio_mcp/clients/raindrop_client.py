...
class RaindropClient(BaseHTTPClient):
    ...
    async def update_bookmark(
        self, bookmark_id: int, data: BookmarkUpdate
    ) -> Bookmark:
        payload = await self.get_json(
            "PUT",
    ...
    async def create_highlight(self, bookmark_id: int, data: HighlightCreate) -> Highlight:
    ...
    async def batch_move_bookmarks(self, data: BatchMoveBookmarks) -> BatchOperationResponse:
        ...
        if "processed_count" not in payload:
            raise APIError(
                f"Failed to move bookmarks {data.bookmark_ids} to collection {data.collection_id}",
                response_data=payload,
            )
        return BatchOperationResponse.model_validate(payload)

    async def batch_delete_bookmarks(self, data: BatchDeleteBookmarks) -> BatchOperationResponse:
    ...
    async def batch_update_bookmarks(self, data: BatchUpdateBookmarks) -> BatchOperationResponse:
    ...
    async def batch_tag_bookmarks(self, data: BatchTagBookmarks) -> BatchOperationResponse:
    ...
    async def batch_untag_bookmarks(self, data: BatchUntagBookmarks) -> BatchOperationResponse:
    ...
    async def apply_filters(self, filter_params: BookmarkFilter) -> FilteredBookmarksResponse:
    ...
    async def import_bookmarks(self, import_source: ImportSource, collection_id: int | None = None) -> ImportResult:
        """Import bookmarks from an external source into Raindrop.io."""
        # This would typically involve uploading a file or providing data in a specific format
    ...
    async def export_bookmarks(self, export_format: ExportFormat, collection_id: int | None = None) -> str:
