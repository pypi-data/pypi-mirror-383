...
class Highlight(BaseModel):
    ...
    color: str | None = None
    position: int | None = None  # Character position in the content where highlight starts
...
__all__ = ["Highlight", "HighlightCreate", "HighlightUpdate", "HighlightResponse", "HighlightsResponse"]
