...
class ToolRegistration:
    ...
    decorated: Any  # FunctionTool from FastMCP doesn't match Callable[P, Awaitable[R]] exactly
...
class FastMCPToolRegistry:
    ...
    def register(
        ...
        def decorator(func: Any) -> Any:  # Simplified type annotation to avoid complex generics
