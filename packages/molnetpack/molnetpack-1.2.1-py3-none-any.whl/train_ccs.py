...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Molecular Collisional Cross Section Prediction (Train)"
    )
    parser.add_argument(
        "--train_data",
        type=str,
        default="./data/allccs_etkdgv3_train.pkl",
        help="path to training data (pkl)",
    )
    parser.add_argument(
        "--test_data",
        type=str,
        default="./data/allccs_etkdgv3_test.pkl",
        help="path to test data (pkl)",
    )
    parser.add_argument(
        "--model_config_path",
        type=str,
        default="./config/molnet_rt.yml",
    ...
    parser.add_argument(
        "--checkpoint_path",
        type=str,
        default="./check_point/molnet_ccs_etkdgv3.pt",
