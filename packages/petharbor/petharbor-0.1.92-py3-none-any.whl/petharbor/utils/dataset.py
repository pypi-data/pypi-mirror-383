...
class DatasetProcessor:
    ...
    def save_dataset_file(
        ...
        base_name = "petharbor_anonymised"
        if save_path is None:
            # Default to petharbor_anonymised.csv if no save_path is provided
            save_format = (
                self._last_input_format
                if hasattr(self, "_last_input_format") and self._last_input_format in save_extensions
                else ".csv"
            )
            ...
            if ext in save_extensions:
                ...
                # Default to .csv if no or unsupported extension given
                save_format = ".csv"
                save_path = f"{save_path}/{base_name}{save_format}"


        # check is output directory exists, if not create it
