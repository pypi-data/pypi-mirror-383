...
class BaseProvider(ABC):
    ...
    def _auto_structure_response(
        ...
        try:
            ...
            # Fall back to outlines if native failed or not supported
            if parsed_result is None:
                parsed_result = _apply_outlines_fallback(raw_response, result_type)
                if parsed_result is not None:
                    fallback_used = "outlines"
