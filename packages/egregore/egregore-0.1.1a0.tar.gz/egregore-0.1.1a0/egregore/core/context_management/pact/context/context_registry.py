...
class ContextRegistry:
    ...
    def register_tool_pair(self, tool_call_id: str, call_id: str, result_id: str) -> None:
        """Register a tool call/result pair."""
    ...
    def get_tool_pair(self, tool_call_id: str) -> Optional[Tuple[str, str]]:
        ...
        return self._tool_pairs_registry.get(tool_call_id)
