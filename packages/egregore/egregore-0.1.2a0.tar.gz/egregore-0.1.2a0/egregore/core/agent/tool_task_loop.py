            ...
            if self.agent and hasattr(self.agent, 'context'):
                try:
                    ...
                    if update_type == 'tool_completed':
                        ...
                        # Add to active message context
                        self.agent.context.active_message.add_child(tool_result_component)
                    ...
                    # Create snapshot after context update
