...
if __name__ == "__main__":
    ...
    root_path2 = '/Users/stela/Documents/teste'
    folder_with_runs_path = f'{root_path2}/ICGS_on_failures_v24_v31_done/'
    model_output_table_path = f'{root_path2}/ICGS_on_failures_v24_v31_done/all_models_summary.csv'
    true_and_rtmodel_fits_path = f'{root_path2}/ICGS_on_failures_v24_v31_done/ICGS_true_and_rtmodel_fits.csv'
