"""
Setup script for the rai-agent package.
This script uses setuptools to package the rai-agent library, which contains modules for faster Copilot Development.
Attributes:
...
setup(
    ...
    author_email="pavulurik@maqsoftware.com",
    url="https://github.com/tanuk-824/rai_Agent",
