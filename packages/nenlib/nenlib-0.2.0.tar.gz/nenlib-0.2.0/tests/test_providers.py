...
import os
from nenlib.mlops.providers import MLopsConfig
...
class TestMLopsConfig:
    ...
    def test_provider_config_with_env_vars(self):
        ...
        import nenlib.mlops.providers
        reload(nenlib.mlops.providers)
        
        config = nenlib.mlops.providers.MLopsConfig.get_provider_config("openai")
    ...
    def test_ollama_models_parsing(self):
        with patch.dict(os.environ, {"OLLAMA_MODELS": "llama2, phi , starcoder "}):
            ...
            config = nenlib.mlops.providers.MLopsConfig.get_provider_config("ollama")
