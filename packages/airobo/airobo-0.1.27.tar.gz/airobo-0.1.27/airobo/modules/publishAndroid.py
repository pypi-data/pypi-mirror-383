...
def build_android_bundle(app_path):
    ...
    try:
        ...
        if os.name == 'nt':  # Windows
            subprocess.run(["gradlew.bat", "clean"], check=True, capture_output=True, shell=True)
        else:  # macOS/Linux
            subprocess.run(["./gradlew", "clean"], check=True, capture_output=True)
        
        print("Building release bundle...")
        if os.name == 'nt':  # Windows
            subprocess.run(["gradlew.bat", "bundleRelease"], check=True, capture_output=True, shell=True)
        else:  # macOS/Linux
            subprocess.run(["./gradlew", "bundleRelease"], check=True, capture_output=True)
