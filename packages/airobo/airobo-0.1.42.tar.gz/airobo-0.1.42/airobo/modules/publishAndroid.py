...
def _ensure_java_config(android_path):
    ...
    try:
        ...
        if major_version >= 17:
            # Use Java 17 for compatibility (works with most Android projects)
            gradle_props['org.gradle.java.home'] = ''  # Let Gradle find Java
            gradle_props['android.compileSdk'] = '34'
            gradle_props['android.targetSdk'] = '34'
            gradle_props['android.minSdk'] = '21'
        else:
            # Use detected Java version
            gradle_props['org.gradle.java.home'] = ''
