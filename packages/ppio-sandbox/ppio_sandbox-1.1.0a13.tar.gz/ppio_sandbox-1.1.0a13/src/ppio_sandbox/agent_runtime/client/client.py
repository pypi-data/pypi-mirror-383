...
class AgentRuntimeClient:
    ...
    async def create_session(
        ...
        try:
            ...
            # Wait for service to be ready (only if startup_cmd was provided)
            if sandbox_config.startup_cmd:
                await self._wait_for_service_ready(session, timeout=30)
    ...
    async def invoke_agent(
        ...
        Args:
            ...
            env_vars: Environment variables
            startup_cmd: Startup command to run when session is created
