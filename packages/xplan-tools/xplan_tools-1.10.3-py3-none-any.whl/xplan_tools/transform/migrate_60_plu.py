r"""Module, containing the explicit transformation and mapping rules for XPlan 6.0 to INSPIRE PLU 4.0.
...
class rules_60_plu:
    ...
    Example:
        ...
        rules_60_plu and which is doing the actual transformation of XPlan data
    """
    ...
    def __validate_model(self, model_class: str, data: dict) -> bool:
        ...
        """
        model = model_factory(model_class, "6.0", "xplan")
    ...
    def _bpplan(self, object: dict) -> None:
        ...
        - aenderungenBisDatum, aufstellungsbeschlussDatum, auslegungsStartDatum, auslegungsEndDatum, traegerbeteiligungsStartDatum, traegerbeteiligungsEndDatum, satzungsbeschlussDatum, rechtsverordnungsDatum, ausfertigungsDatum to ordinance \n
    ...
    def _sogrenze(self, object: dict) -> None:
        ...
        """
        object["supplementaryRegulation"] = [
            "https://inspire.ec.europa.eu/codelist/SupplementaryRegulationValue/10_OtherSupplementaryRegulation",
        ]
        object["specificSupplementaryRegulation"] = [
            "https://registry.gdi-de.org/codelist/de.xleitstelle.inspire_plu/LandUse/5_5_Grenze",
        ]
