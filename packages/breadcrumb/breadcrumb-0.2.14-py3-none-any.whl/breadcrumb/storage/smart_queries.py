...
def gaps_query(
    ...
    Returns:
        Dictionary with:
            ...
            - each call includes: function name, call count, caller context
    ...
    try:
        ...
        #     tip = "\n".join(tip_lines)
        # else:
        tip = "Never do full namespace includes like breadcrumb config edit <name> --add-include'module.*'. If possible, be more specific and use fully qualified names."
