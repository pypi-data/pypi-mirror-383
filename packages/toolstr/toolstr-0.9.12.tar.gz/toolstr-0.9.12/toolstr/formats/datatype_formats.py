...
def format_number(
    ...
    *,
    ...
    prefix_after_sign: typing.Optional[str] = None,
    ...
    if prefix_after_sign is not None:
        if signed:
            if formatted[0] in ('+', '-'):
                formatted = (
                    formatted[0] + prefix_after_sign + formatted[1:]
                )
            else:
                formatted = prefix_after_sign + formatted
        else:
            formatted = prefix_after_sign + formatted
