...
class MixClient:
    ...
    def get_evaluation(self, evaluation_id: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "GET", f"/workspaces/{self._workspace_name}/evaluations/{evaluation_id}"
        )
        return response.json()
    ...
    def update_evaluation(
        ...
        response = self._make_request(
            "PUT",
            f"/workspaces/{self._workspace_name}/evaluations/{evaluation_id}",
            json=payload,
        )
        return response.json()
    ...
    def delete_evaluation(self, evaluation_id: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "DELETE", f"/workspaces/{self._workspace_name}/evaluations/{evaluation_id}"
        )
        return response.json()
    ...
    def get_evaluation_data(
        ...
        Args:
            ...
            evaluation_id: Optional evaluation id for caching.
            limit: Page size.
    ...
    def get_workflow(self, workflow_id: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "GET", f"/workspaces/{self._workspace_name}/workflows/{workflow_id}"
        )
        return response.json()
    ...
    def update_workflow(
        ...
        response = self._make_request(
            "PUT",
            f"/workspaces/{self._workspace_name}/workflows/{workflow_id}",
            json=payload,
        )
        return response.json()
    ...
    def delete_workflow(self, workflow_id: int) -> Dict[str, Any]:
        """Delete a workflow."""
        response = self._make_request(
            "DELETE", f"/workspaces/{self._workspace_name}/workflows/{workflow_id}"
        )
        return response.json()

    def list_workflow_runs(self, workflow_id: int) -> Dict[str, Any]:
        """List all runs for a workflow."""
        response = self._make_request(
            "GET", f"/workspaces/{self._workspace_name}/workflows/{workflow_id}/runs"
        )
        return response.json()

    def start_workflow_run(
        self, workflow_id: int, json_config: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "POST",
            f"/workspaces/{self._workspace_name}/workflows/{workflow_id}/runs",
            json=payload,
        )
        return response.json()
    ...
    def get_workflow_run(self, workflow_id: int, run_id: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "GET",
            f"/workspaces/{self._workspace_name}/workflows/{workflow_id}/runs/{run_id}",
        )
        return response.json()
    ...
    def cancel_workflow_run(self, workflow_id: int, run_id: int) -> Dict[str, Any]:
        """Cancel a running workflow."""
        response = self._make_request(
            "POST",
            f"/workspaces/{self._workspace_name}/workflows/{workflow_id}/runs/{run_id}/cancel",
            json={},
        )
        return response.json()
...
def get_evaluation(evaluation_id: int) -> Dict[str, Any]:
    ...
    client = MixClient()
    return client.get_evaluation(evaluation_id)
...
def delete_evaluation(evaluation_id: int) -> Dict[str, Any]:
    """Delete an evaluation using the default MixClient instance."""
    client = MixClient()
    return client.delete_evaluation(evaluation_id)
...
def get_evaluation_data(
    ...
    return client.get_evaluation_data(
        datasets=datasets, evaluation_id=evaluation_id, limit=limit, offset=offset
    )
