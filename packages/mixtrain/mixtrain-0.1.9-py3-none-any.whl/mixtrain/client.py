...
class MixClient:
    ...
    def get_workflow(self, workflow_name: str) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "GET", f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}"
        )
        return response.json()
    ...
    def update_workflow(
        ...
        response = self._make_request(
            "PUT",
            f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}",
            json=payload,
        )
        return response.json()
    ...
    def delete_workflow(self, workflow_name: str) -> Dict[str, Any]:
        ...
        from urllib.parse import quote
        response = self._make_request(
            "DELETE", f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}"
        )
        return response.json()
    ...
    def list_workflow_runs(self, workflow_name: str) -> Dict[str, Any]:
        ...
        from urllib.parse import quote
        response = self._make_request(
            "GET", f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}/runs"
        )
        return response.json()
    ...
    def start_workflow_run(
        ...
        response = self._make_request(
            "POST",
            f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}/runs",
            json=payload,
        )
        return response.json()
    ...
    def get_workflow_run(self, workflow_name: str, run_number: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "GET",
            f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}/runs/{run_number}",
        )
        return response.json()
    ...
    def cancel_workflow_run(self, workflow_name: str, run_number: int) -> Dict[str, Any]:
        ...
        response = self._make_request(
            "POST",
            f"/workspaces/{self._workspace_name}/workflows/{quote(workflow_name)}/runs/{run_number}/cancel",
            json={},
        )
        return response.json()
