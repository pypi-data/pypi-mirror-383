...
class TestClientAPI:
    ...
    def test_call_api_with_auth_token(self, mock_config, mock_platform_url):
        ...
        with patch("httpx.Client") as mock_client:
            mock_client.return_value.__enter__.return_value.request = Mock(return_value=mock_response)
    ...
    def test_call_api_with_api_key(self, mock_config, mock_platform_url, mock_api_key):
    ...
    def test_call_api_error_response(self, mock_config, mock_platform_url):
...
class TestAuthenticationMethods:
    ...
    def test_authenticate_with_token(self, mock_config):
        ...
        with patch("mixtrain.utils.auth.authenticate_with_token") as mock_auth:
            ...
            assert result == "test_token"
            mock_auth.assert_called_once_with("oauth_token", "github", client.get_config, client.call_api)
