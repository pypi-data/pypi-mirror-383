...
mirix_agent = Mirix(
  ...
  config_path="debug/mirix_gpt4o-mini.yaml",
  # model_provider="azure_opena",
  # config_path=".local/mirix_jplml_azure.yaml",
)
alice = mirix_agent.create_user(user_name="Alice")
# mirix_agent.update_core_memory(text="My name is Alice John Doe", label="persona", user_id=alice.id)
...
memories = mirix_agent.visualize_memories(user_id=alice.id)
