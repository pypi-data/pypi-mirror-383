...
class SPService:
    ...
    async def get_service_parameter_definition(self, sp_id: str) -> SPResult:
        ...
        try:
            ...
            logger.info(f"Retrieved SP {sp_id} definition: {description}")
            
            return SPResult(
                success=True,
                data={"id": sp_id, "description": description},
                count=1
            )
    ...
    def format_sp_value_display(self, sp_data: Dict[str, Any], sp_description: str = None) -> str:
