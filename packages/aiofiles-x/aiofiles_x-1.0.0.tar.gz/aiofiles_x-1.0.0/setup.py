...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        if sys.platform.startswith("darwin"):
            ...
            if archs:
                # Fix macOS architecture flag parsing
        ...
        # Set CMAKE_BUILD_PARALLEL_LEVEL for faster builds
        ...
        # Windows debug: List built files
        ...
        # Enhanced Windows file copy fix
        if sys.platform.startswith("win"):
            # Multiple possible locations for Windows DLL
            search_paths = [
