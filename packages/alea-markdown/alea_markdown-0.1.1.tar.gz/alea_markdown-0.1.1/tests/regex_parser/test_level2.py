"""
Tests for the Regex HTML to Markdown parser with Level 2 (more complex HTML) files.
"""
...
def test_regex_parser_eurlex_example(resources_dir):
    """Test Regex parser with EURLex example HTML."""
    # Setup parser with standard configuration
...
def test_regex_parser_html_fragment(resources_dir):
    """Test Regex parser with HTML fragment."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_regex_parser_html_with_comments(resources_dir):
    """Test Regex parser with HTML containing comments."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_regex_parser_html_with_entities(resources_dir):
    """Test Regex parser with HTML containing entities."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_regex_parser_html_with_script_style(resources_dir):
    """Test Regex parser with HTML containing script and style tags."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_regex_parser_html_with_tables(resources_dir):
    """Test Regex parser with HTML containing tables."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_regex_parser_minimal_html(resources_dir):
    """Test Regex parser with minimal HTML document."""
    # Setup parser
    parser = RegexHTMLParser(ParserConfig())
...
def test_benchmark_regex_parser_level2(
    benchmark, resources_dir, test_file, description
):
    """Benchmark Regex parser with more complex HTML documents.
