"""
Test for definition list conversion in the RegexHTMLParser.
"""
...
logger = get_logger("test_regex_definition_list")
...
# Parse the HTML
logger.info("Parsing HTML with definition list using Regex parser")
regex_result = regex_parser.parse(html_with_definition_list)
...
if expected_format in regex_result:
