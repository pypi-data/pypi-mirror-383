...
try:
    ...
    spotify.SetAuthTokenAuthorizationCode(CLIENT_ID, CLIENT_SECRET, SPOTIFY_SCOPES, 'thlucas2010@gmail.com')
    #spotify.SetAuthTokenAuthorizationCode(CLIENT_ID, CLIENT_SECRET, SPOTIFY_SCOPES, 'thlucas2010@gmail.com', forceAuthorize=True)
