...
class PresentationController:
    def __init__(
        ...
        self.recognizer = OnlineRecognizer.from_transducer(
            tokens=str(model_base_path / "tokens.txt"),
            encoder=str(model_base_path / "encoder.int8.onnx"),
            decoder=str(model_base_path / "decoder.int8.onnx"),
            joiner=str(model_base_path / "joiner.int8.onnx"),
            num_threads=8,
