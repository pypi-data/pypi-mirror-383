...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "hidden", "pulp_created", "prn", "pulp_href", "content_guard", "no_content_change_since", "name", "pulp_last_updated", "base_path", "pulp_labels"]
