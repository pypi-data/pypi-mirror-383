...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "name", "hidden", "content_guard", "base_url", "pulp_labels", "pulp_created", "base_path", "prn", "pulp_href", "pulp_last_updated"]
