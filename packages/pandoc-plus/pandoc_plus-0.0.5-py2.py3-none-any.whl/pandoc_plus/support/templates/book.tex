...
\fancyfoot[LE]{\thepage}
%%\fancyfoot[CE]{\thepage}
\fancyfoot[RE]{$title$\\ \textcopyright 2025 $author$, All Rights Reserved}
\fancyfoot[LO]{$title$\\ \textcopyright 2025 $author$, All Rights Reserved}
%%\fancyfoot[CO]{\thepage}
\fancyfoot[RO]{\thepage}
}
...
\fancyfoot[LE]{\thepage}
%%\fancyfoot[CE]{\thepage}
%%\fancyfoot[RE]{\textcopyright 2025 Daniel Aukes, All Rights Reserved}
%%\fancyfoot[LO]{\textcopyright 2025 Daniel Aukes, All Rights Reserved}
%%\fancyfoot[CO]{\thepage}
\fancyfoot[RO]{\thepage}
}
\pagestyle{plain}
