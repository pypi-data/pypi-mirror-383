...
def extract(
    ...
    extractor = MigManExtract(nl=nl, cfg=cfg, logger=logger, fh=fh)
    extractor.extract()
...
def transform(
    ...
    """
    logger.info("Transforming MigMan objects")
    transformer = MigManTransform(nl=nl, cfg=cfg, logger=logger, fh=fh)
...
def load(
    ...
    loader = MigManLoad(nl=nl, cfg=cfg, logger=logger, fh=fh)
    loader.load()
