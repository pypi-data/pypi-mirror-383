"""
RepIntercompany ETL Load Module.

This module handles the loading phase of the RepIntercompany ETL pipeline.
...
Classes:
    RepIntercompanyLoad: Main class handling RepIntercompany data loading.
"""
...
PROJECT_NAME_INTERCOMPANY = "Intercompany pA --> hit"


class RepIntercompanyLoad:
    """
    Handles loading of transformed RepIntercompany data into target system.
    
    This class manages the loading phase of the RepIntercompany ETL pipeline,
    ...
    Attributes:
        ...
        cfg (PipelineRepIntercompany): Pipeline configuration with loading settings.
    """
    ...
    def __init__(
        ...
        """
        Initialize the RepIntercompany Load instance.
    ...
    def load(self) -> None:
        """
        Execute the main loading process for RepIntercompany data.
        ...
        """
        self.logger.info("Loading all RepIntercompany objects")
        ...
        self.nl.ReUploadDataFrame(
            projectname=PROJECT_NAME_INTERCOMPANY,
            df=pd.DataFrame(data),
            update_project_settings=self.cfg.analyze_table,
        )
