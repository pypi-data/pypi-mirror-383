...
class MigManLoad:
    ...
    def load(self) -> None:
        ...
        for entity in self.cfg.load.entities:
            ...
            # This could involve reading from transformed tables
            # and inserting into the target database
            # Example (pseudo-code):
            # data = self.local_database.fetch_data(f"SELECT * FROM transformed_{entity}")
            # self.nl.target_system.insert_data(entity, data)
