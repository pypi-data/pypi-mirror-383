...
from nemo_library_etl.adapter.hubspotforecast.config_models import (
    PipelineHubSpotForecast,
)
...
class HubSpotForecastLoad:
    ...
    def load(self) -> None:
        ...
        xlsx_file = Path(
            self.cfg.forecast_call_xlsx_file.replace(
