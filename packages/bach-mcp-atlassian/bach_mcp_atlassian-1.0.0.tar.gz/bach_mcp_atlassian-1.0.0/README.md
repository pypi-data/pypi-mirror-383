...
The easiest way to get started is using `uvx`:

```bash
uvx bach-mcp-atlassian
```
...
**📦 Package**: [pypi.org/project/bach-mcp-atlassian](https://pypi.org/project/bach-mcp-atlassian/)

**📖 Full UVX Guide**: See [QUICKSTART_UVX.md](QUICKSTART_UVX.md) for detailed instructions, OAuth setup, and troubleshooting.
