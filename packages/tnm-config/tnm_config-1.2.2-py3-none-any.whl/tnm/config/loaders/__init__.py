...
# _try_register_builtin(
#     short_module="toml_loader",
#     suffixes=[".toml"],
#     class_name_candidates=["TomlLoader"],
#     absolute_module_candidates=[
#         "tnm.config.loaders.toml_loader",
#         "src.tnm.config.loaders.toml_loader",
#     ],
# )
#
# _try_register_builtin(
#     short_module="ini_loader",
#     suffixes=[".ini"],
#     class_name_candidates=["IniLoader"],
#     absolute_module_candidates=[
#         "tnm.config.loaders.ini_loader",
#         "src.tnm.config.loaders.ini_loader",
#     ],
# )
