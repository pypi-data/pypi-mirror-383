...
class ResourceMonitor:
    def __init__(
        ...
        publisher: Optional[PubslisherHandler] = None,
    ...
    async def _measure(
        self, operation_id: UUID, log: bool = True, publish: bool = True
    ...
    ) -> Optional[SingleDataResponse[RegularMeasurement, None]]:
    ...
    def get_average_usage(
        ...
        *,
        ...
        authorization: OptionalAnyAuthorization = None,
        impersonation: OptionalImpersonation = None,
    ) -> Optional[SingleDataResponse[AverageMeasurement, None]]:
        """
    ...
    def get_peak_usage(
        ...
        *,
        ...
        authorization: OptionalAnyAuthorization = None,
        impersonation: OptionalImpersonation = None,
    ) -> Optional[SingleDataResponse[PeakMeasurement, None]]:
        """
