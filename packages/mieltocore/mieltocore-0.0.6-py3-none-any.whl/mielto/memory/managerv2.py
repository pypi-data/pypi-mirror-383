...
class MemoryManager:
    ...
    def create_or_update_user_profile_memory(
        ...
        instructions = [
            ...
            "You will need to extract, synthesize, and organize information across multiple memories to build a cohesive understanding of the user.",
            ...
            "- romantic_history: Past relationships, breakup context, duration",
                    ...
                    "relationships": {
                        ...
                        "romantic_history": {
                            "exes": [{
                                ...
                                "ended_reason": "We broke up because we were not compatible",
                            }],
                            "talking_stages": [{
                                "name": "Eva",
                                "duration": 8,
        ...
        if not user_memory:
            ...
            metadata = user_memory.metadata or {}
            structured_profile = metadata.get("structured_profile", {})
            new_structured_profile = structured_profile.copy()
            new_structured_profile.update(response_object.get("data"))
            if memories:
                metadata["last_memory_id"] = memories[-1].memory_id
            user_profile = UserMemory(
