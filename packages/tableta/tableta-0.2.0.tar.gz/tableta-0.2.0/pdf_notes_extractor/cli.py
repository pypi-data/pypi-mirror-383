...
Ejemplos de uso:
  ...
  %(prog)s documento.pdf --notas 1 6 --csv-dir ./tablas
  %(prog)s documento.pdf --notas all --excel todo.xlsx --verbose
  %(prog)s documento.pdf --notas 1-5 --excel resultado.xlsx --engine camelot
        """,
    )
    ...
    parser.add_argument(
        ...
        default="pdfplumber",
        help="Motor de extracción (default: pdfplumber - recomendado)",
    )
