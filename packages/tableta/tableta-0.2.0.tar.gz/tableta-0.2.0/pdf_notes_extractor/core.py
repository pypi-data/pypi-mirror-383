...
from .extractors import CamelotExtractor, TabulaExtractor, PDFPlumberExtractor
...
def extract_tables_from_notes(
    ...
    Args:
        ...
        engine: Motor de extracción ('pdfplumber', 'camelot' o 'tabula')
    ...
    if engine not in ["pdfplumber", "camelot", "tabula"]:
        raise ValueError(f"Engine '{engine}' no válido. Use 'pdfplumber', 'camelot' o 'tabula'")
