...
class EvaluationModules(BaseModel):
    ...
    edubench_tasks: Optional[List[str]] = Field(default=["QA", "EC", "IP"], description="EduBench tasks to run. Options: QA, EC, IP, AG. Set to [] or None to skip.")
...
class UnifiedEvaluationResponse(BaseModel):
    ...
    edubench_results: Optional[List[Dict[str, Any]]] = None  # None if edubench_tasks=[] or None
