...
from arbitrium.utils.markdown import adjust_markdown_headers, sanitize_content_dict
...
class ReportGenerator:
    ...
    async def save_report(
        ...
        # Generate filename
        prefix = f"round{round_number}_{content_type}" if round_number else content_type
