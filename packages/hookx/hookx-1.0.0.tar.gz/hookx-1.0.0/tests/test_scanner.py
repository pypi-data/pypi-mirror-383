...
from hookx.core.scanner import HookScanner
from hookx.core.models import HookDefinition, HookType
...
''')
    ...
    @patch('hookx.utils.frappe_utils.FrappeUtils.parse_hooks_file')
