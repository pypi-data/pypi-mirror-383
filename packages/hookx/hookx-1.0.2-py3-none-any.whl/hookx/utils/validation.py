"""
Validation utilities for hookx with comprehensive input validation.
...
class ValidationUtils:
    """Comprehensive validation utilities for hookx operations."""
    ...
    def validate_severity_level(severity: Union[str, ConflictSeverity]) -> ConflictSeverity:
        ...
        try:
            ...
            raise ValueError(f"No matching severity for: {severity}")
