#!/usr/bin/env python3
"""
Improved GPH (Geweke-Porter-Hudak) Hurst parameter estimator.

This module implements an improved GPH estimator with adaptive frequency range selection
...
class ImprovedGPHEstimator(BaseEstimator):
    """
    Improved GPH (Geweke-Porter-Hudak) Hurst parameter estimator.

    This estimator uses log-periodogram regression with adaptive frequency range
    selection and robust error handling for better performance across different
    data lengths and conditions.
    ...
    def estimate(self, data: Union[np.ndarray, list]) -> Dict[str, Any]:
        """
        Estimate the Hurst parameter using improved GPH analysis.
            ...
            if len(freqs_sel) < 3:
                ...
                if len(freqs_sel) < 3:
                    ...
                    return {
                        ...
                        "r_squared": 0.0,
                        "m": 0,
                        "log_regressor": np.array([]),
                        "log_periodogram": np.array([]),
    ...
    def _estimate_numba(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        # This can be extended with Numba-optimized spectral estimation
    ...
    def _estimate_jax(self, data: np.ndarray) -> Dict[str, Any]:
        ...
        # This can be extended with JAX-optimized spectral estimation
        result = self._estimate_numpy(data)
        result["method"] = "jax"
        return result
