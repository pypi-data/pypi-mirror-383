...
class MeasureModule(BaseModule):
    ...
    def get_requested_averaging_time(self):
        """Returns the requested averaging time of the module in Power Line Cycles. Not relevant in lock-in mode."""

        return float(self.device.query(f'SENSe{self.module_number}:NPLCycles:REQuested?'))

    def get_actual_averaging_time(self):
        """Returns the actual averaging time of the module in Power Line Cycles. Not relevant in lock-in mode."""

        return float(self.device.query(f'SENSe{self.module_number}:NPLCycles:ACTual?'))
    ...
    def get_lowpass_corner_frequency(self):
        """Returns the analog low pass filter cutoff frequency.
    ...
    def get_lowpass_rolloff(self):
        """Returns the analog low pass filter roll-off.
    ...
    def configure_input_lowpass_filter(self, corner_frequency, rolloff='R12'):
        """Configure the analog input low pass filter.
    ...
    def configure_input_highpass_filter(self, corner_frequency, rolloff='R12'):
        """Configure the analog input high pass filter.
    ...
    def get_lock_in_lowpass_state(self):
        """Returns the state of the lock-in (PSD) output IIR filter."""

        return bool(int(self.device.query(f'SENSe{self.module_number}:LIA:LPASs:STATe?')))

    def get_lock_in_iir_state(self):
        """
        This function is deprecated. Use get_lock_in_lowpass_state() instead.

        .. deprecated:: 1.9.0
            Use get_lock_in_lowpass_state instead.
        """

        warn("The get_lock_in_iir_state method is deprecated, use get_lock_in_lowpass_state instead", DeprecationWarning)

        return self.get_lock_in_lowpass_state()

    def set_lock_in_lowpass_state(self, state):
        ...
        self.device.command(f'SENSe{self.module_number}:LIA:LPASs:STATe {str(int(state))}')

    def set_lock_in_iir_state(self, state):
        """
        This function is deprecated. Use set_lock_in_lowpass_state() instead.

        .. deprecated:: 1.9.0
            Use set_lock_in_lowpass_state instead.
        """

        warn("The set_lock_in_iir_state method is deprecated, use set_lock_in_lowpass_state instead", DeprecationWarning)

        self.set_lock_in_lowpass_state(state)

    def enable_lock_in_lowpass(self):
        """Sets the state of the lock-in (PSD) output IIR filter to True."""

        self.set_lock_in_lowpass_state(True)

    def enable_lock_in_iir(self):
        """
        This function is deprecated. Use enable_lock_in_lowpass() instead.

        .. deprecated:: 1.9.0
            Use enable_lock_in_lowpass instead.
        """

        warn("The enable_lock_in_iir method is deprecated, use enable_lock_in_lowpass instead", DeprecationWarning)

        self.set_lock_in_iir_state(True)

    def disable_lock_in_lowpass(self):
        """Sets the state of the lock-in (PSD) output IIR filter to False."""

        self.set_lock_in_lowpass_state(False)

    def disable_lock_in_iir(self):
        """
        This function is deprecated. Use disable_lock_in_lowpass() instead.

        .. deprecated:: 1.9.0
            Use disable_lock_in_lowpass instead.
        """

        warn("The disable_lock_in_iir method is deprecated, use disable_lock_in_lowpass instead", DeprecationWarning)

        self.set_lock_in_iir_state(False)

    def get_lock_in_averaging_state(self):
        """Returns the state of the lock-in (PSD) output averaging (FIR) filter."""

        return bool(int(self.device.query(f'SENSe{self.module_number}:LIA:AVERage:STATe?')))

    def get_lock_in_fir_state(self):
        """
        This function is deprecated. Use get_lock_in_averaging_state() instead.

        .. deprecated:: 1.9.0
            Use get_lock_in_averaging_state instead.
        """

        warn("The get_lock_in_fir_state method is deprecated, use get_lock_in_averaging_state instead", DeprecationWarning)

        return self.get_lock_in_averaging_state()

    def set_lock_in_averaging_state(self, state):
        """Sets the state of the lock-in (PSD) output averaging (FIR) filter.

            Args:
                state (bool):
                    The new state of the (PSD) output averaging (FIR) filter.
        """

        self.device.command(f'SENSe{self.module_number}:LIA:AVERage:STATe {str(int(state))}')

    def set_lock_in_fir_state(self, state):
        """
        This function is deprecated. Use set_lock_in_averaging_state() instead.

        .. deprecated:: 1.9.0
            Use set_lock_in_averaging_state instead.
        """

        warn("The set_lock_in_fir_state method is deprecated, use set_lock_in_averaging_state instead", DeprecationWarning)

        self.set_lock_in_averaging_state(state)

    def enable_lock_in_averaging(self):
        """Sets the state of the lock-in (PSD) output averaging (FIR) filter to True."""

        self.set_lock_in_averaging_state(True)

    def enable_lock_in_fir(self):
        """
        This function is deprecated. Use enable_lock_in_averaging() instead.

        .. deprecated:: 1.9.0
            Use enable_lock_in_averaging instead.
        """

        warn("The enable_lock_in_averaging (FIR) method is deprecated, use enable_lock_in_averaging instead", DeprecationWarning)

        self.set_lock_in_fir_state(True)

    def disable_lock_in_averaging(self):
        """Sets the state of the lock-in (PSD) output averaging (FIR) filter to False."""

        self.set_lock_in_averaging_state(False)

    def disable_lock_in_fir(self):
        """
        This function is deprecated. Use disable_lock_in_averaging() instead.

        .. deprecated:: 1.9.0
            Use disable_lock_in_averaging instead.
        """

        warn("The disable_lock_in_averaging (FIR) method is deprecated, use disable_lock_in_averaging instead", DeprecationWarning)

        self.set_lock_in_fir_state(False)

    def get_lock_in_reference_cycles(self):
        """Returns the number of averaging (FIR) cycles."""

        return int(self.device.query(f'SENSe{self.module_number}:LIA:REFerence:CYCLes?'))

    def get_lock_in_fir_cycles(self):
        """
        This function is deprecated. Use get_lock_in_reference_cycles() instead.

        .. deprecated:: 1.9.0
            Use get_lock_in_reference_cycles instead.
        """

        warn("The get_lock_in_fir_cycles method is deprecated, use get_lock_in_reference_cycles instead", DeprecationWarning)

        return self.get_lock_in_reference_cycles()

    def set_lock_in_reference_cycles(self, cycles):
        """Sets the number of averaging (FIR) cycles.

            Args:
                cycles (int):
                    The desired number of averaging (FIR) cycles, between 1 and 100.
        """

        self.device.command(f'SENSe{self.module_number}:LIA:REFerence:CYCLes {str(int(cycles))}')

    def set_lock_in_fir_cycles(self, cycles):
        """
        This function is deprecated. Use set_lock_in_reference_cycles() instead.

        .. deprecated:: 1.9.0
            Use set_lock_in_reference_cycles instead.
        """

        warn("The set_lock_in_fir_cycles method is deprecated, use set_lock_in_reference_cycles instead", DeprecationWarning)

        self.set_lock_in_reference_cycles(cycles)
    ...
    def setup_ac_measurement(self, nplc=1):
        """Set up the module for AC measurement.
    ...
    def setup_lock_in_measurement(self,
        ...
        """Set up the module for lock-in measurement.
            ...
            Args:
                ...
                reference_harmonic (int):
                    ...
                    etc.
                use_averaging (FIR) (bool):
                    Enable or disable the (PSD) output averaging (FIR) filter.
        """
        ...
        self.set_lock_in_averaging_state(use_fir)
    ...
    def get_lock_in_dc(self):
        """Returns the present dc measurement from the lock-in."""

        return float(self.device.query(f'FETCh:SENSe{self.module_number}:LIA:DC?'))

    def get_lock_in_dc_immediate(self):
        """Returns the immediate dc measurement from the lock-in."""

        return float(self.device.query(f'FETCh:SENSe{self.module_number}:LIA:DC:IMMediate?'))
    ...
    def set_frequency_range_threshold(self, threshold):
        """Sets the frequency range threshold for the module.
    ...
    def get_resistance(self):
        """Returns the present resistance measurement in Ohms. 

            A valid source must be configured.
            When resistance excitation type is DC, the returned value is the DC resistance.
            When resistance excitation type is AC, the returned value is the in-phase resistance.
    ...
    def get_resistance_dc(self):
        """Returns the present DC resistance measurement in Ohms.

            A valid source must be configured.
            The resistance excitation type must be DC.

        Returns:
            float: Present DC resistance measurement in Ohms.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:DC?'))

    def get_resistance_inphase(self):
        """Returns the present in-phase component of the AC resistance measurement in Ohms.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present in-phase component of the AC resistance measurement in Ohms.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:INPhase?'))

    def get_resistance_quadrature(self):
        """Returns the present quadrature component of the AC resistance measurement in Ohms.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present quadrature component of the AC resistance measurement in Ohms.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:QUADrature?'))

    def get_resistance_magnitude(self):
        """Returns the present magnitude of the AC resistance measurement in Ohms.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present magnitude of the AC resistance measurement in Ohms.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:MAGNitude?'))

    def get_resistance_phase(self):
        """Returns the present phase of the AC resistance measurement in degrees.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present phase of the AC resistance measurement in degrees.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:PHASe?'))

    def get_resistance_compensated(self):
        """Returns the present compensated resistance of the resistance measurement in Ohms.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present compensated resistance measurement in Ohms.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:COMPensated?'))

    def get_resistance_capacitance(self):
        """Returns the present capacitance of the resistance measurement in Farads.

            A valid source must be configured.
            The resistance excitation type must be AC.

        Returns:
            float: Present capacitance measurement in Farads.
        """

        return float(self.device.query(f'CALCulate:SENSe{self.module_number}:RESistance:CAPacitance?'))
    ...
    def set_resistance_excitation_type(self, excitation_type):
        """Sets the present resistance excitation type of the module.
    ...
    def get_resistance_excitation_type(self):
        """Returns the present resistance excitation type of the module.

            This represents the combination of the measure module mode and the selected source module shape.
            For "DC", the measure mode is DC and source shape is DC.
            For "AC", the measure mode is Lock-in and source shape is Sine.
    ...
    def set_resistance_mode(self, resistance_mode):
        """Sets the resistance optimization mode of the module.
    ...
    def get_resistance_mode(self):
        """Returns the preset resistance optimization mode of the module.
    ...
    def set_resistance_range(self, resistance_range):
        """Sets the resistance range of the module.
    ...
    def get_resistance_range(self):
        """Returns the present resistance range of the module.
    ...
    def set_resistance_auto_range(self, state):
        """Sets the resistance auto-range state of the module.

        Args:
            state (bool): The desired state of resistance auto-range. True to enable; else false.
        """

        self.device.command(f"CALCulate:SENSe{self.module_number}:RESistance:RANGe:AUTO {int(state)}")

    def get_resistance_auto_range(self):
        """Gets the state of resistance auto-range on the module.
    ...
    def get_resistance_optimization_state(self):
        """Returns the present state of optimization on the module.
    ...
    def get_resistance_observation_time_state(self):
        """Gets the present state of the observation time on the module.
    ...
    def set_resistance_observation_time_requested(self, requested_time):
        """Sets the requested observation time on the module.
    ...
    def get_resistance_observation_time_requested(self):
        """Gets the present requested observation time on the module.
    ...
    def get_resistance_relative_dc(self):
        """Gets the present relative dc resistance calculation. This is calculated by subtracting the baseline
            resistance value from the present dc resistance calculation.

        Returns:
            float: The calculated relative dc resistance.
        """

        return float(self.device.query(f"CALCulate:SENSe{self.module_number}:RESistance:DC:RELative?"))

    def set_resistance_relative_baseline(self, baseline):
        """Sets the present relative baseline value to be subtracted from the dc resistance calculation in order to
            calculate the relative dc resistance.

        Args:
            baseline (float): The requested baseline.
        """

        self.device.command(f"CALCulate:SENSe{self.module_number}:RESistance:DC:RELative:BASeline {baseline}")

    def get_resistance_relative_baseline(self):
        """Gets the present relative resistance baseline that is used to calculate relative dc resistance.

        Returns:
            float: The resistance baseline.
        """

        return float(self.device.query(f"CALCulate:SENSe{self.module_number}:RESistance:DC:RELative:BASeline?"))

    def zero_dc_resistance(self):
        """Sets the baseline value for calculating relative resistance to the present DC resistance value.
            This sets the relative resistance calculation to zero in an ideal configuration.
        """

        self.device.command(f"CALCulate:SENSe{self.module_number}:RESistance:DC:RELative:ZERO")

    def clear_relative_resistance_baseline(self):
        """Sets the baseline value for calculating relative resistance to 0.
            The resistance calculation and relative resistance calculation are equivalent when the baseline is zero."""

        self.device.command(f"CALCulate:SENSe{self.module_number}:RESistance:DC:RELative:CLEar")
    ...
    def get_measure_function(self):
        """Returns whether the measure function is current or voltage"""

        return self.device.query(f'SENSe{self.module_number}:FUNCtion?')

    def set_measure_function(self, value):
        """Sets the measure function of the module.

            Args:
                value (str):
                    The new measure function ('CURRent' or 'VOLTage').
        """

        self.device.command(f'SENSe{self.module_number}:FUNCtion {value}')

    def get_voltage_sense_mode(self):
        """Returns the voltage measure sense of the specified module"""

        return self.device.query(f'SENSe{self.module_number}:VOLTage:SMODe?')

    def set_voltage_sense_mode(self, value):
        """Sets the voltage measure sense of the specified module

            Args:
                value (str):
                    LOCal for 2-wire local
                    REMote for 4-wire remote
        """

        self.device.command(f'SENSe{self.module_number}:VOLTage:SMODe {value}')
