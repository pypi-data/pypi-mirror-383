...
class TestCartography:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Cartography(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
...
class TestAsyncCartography:
    ...
    def test_base_url_trailing_slash(self, client: AsyncCartography) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCartography) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCartography) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncCartography(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
