...
class TradingService:
    ...
    def create_token(
        ...
        Args:
            ...
            custom_mint: Custom mint address/keypair for token creation
        ...
        # Use custom mint if provided, otherwise generate random
        if custom_mint:
            self.logger.info(f"Using custom mint: {custom_mint}")
