...
def register_create_wallet_tool(server: FastMCP):
    ...
    def create_wallet() -> Dict[str, Any]:
        ...
        try:
            ...
            # Create reminder message for environment setup
            env_reminder = (
                "\n\n⚠️  IMPORTANT: Add these to your MCP server configuration:\n\n"
                '"env": {\n'
                f'  "API_KEY": "{result["apiKey"]}",\n'
                f'  "WALLET_ADDRESS": "{result["walletPublicKey"]}"\n'
                "}\n\n"
            ...
            return {
                ...
                "message": f"Wallet created successfully. Keep the private key secure!{env_reminder}",
