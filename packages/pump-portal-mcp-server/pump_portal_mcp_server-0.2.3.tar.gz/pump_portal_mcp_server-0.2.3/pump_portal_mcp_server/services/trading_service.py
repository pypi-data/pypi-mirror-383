...
class TradingService:
    ...
    def create_token(
        ...
        # Only use custom keypair if provided - no fallback to random
        if custom_keypair:
            try:
                import json
            ...
            # Generate a random mint address (only when no custom keypair provided)
            import secrets
            import base58
            ...
            self.logger.info("No custom keypair provided - generated random mint keypair")
