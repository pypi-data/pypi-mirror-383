...
class PumpPortalMCP:
    ...
    def _register_tools(self):
        ...
        from ..tools.check_balance import register_check_balance_tool
        ...
        register_check_balance_tool(self.server)

    def _register_resources(self):
        """Register all resources with the server."""
        from ..resources.wallet_info import register_wallet_info_resource, register_trading_status_resource

        register_wallet_info_resource(self.server)
        register_trading_status_resource(self.server)
