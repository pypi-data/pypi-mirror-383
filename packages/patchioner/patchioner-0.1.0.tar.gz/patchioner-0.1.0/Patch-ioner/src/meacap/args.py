...
def get_args():
    ...
    parser.add_argument('--use_t2d', type=bool, default=False, help='whether to use talk2dino for textual feature extraction')
    parser.add_argument("--talk2dino_config_path", type=str, default=r'../../configs_talk2dino/vitb_mlp_infonce.yaml')
    parser.add_argument("--talk2dino_weights_path", type=str, default=r'../../weights_talk2dino/vitb_mlp_infonce.pth')
