...
def main(args) -> None:
    ...
    memory_base_path = args.memory_base_path
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path', default = '/raid/datasets/viecap_files/checkpoints/train_coco/coco_prefix-0014.pt')
    ...
    #parser.add_argument("--memory_caption_path", type=str, default='data/memory/coco/memory_captions.json') # unused
