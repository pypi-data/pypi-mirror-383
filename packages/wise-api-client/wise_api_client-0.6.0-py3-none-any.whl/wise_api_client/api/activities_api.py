...
class ActivitiesApi:
    ...
    def list_activities(
        ...
        since: Annotated[Optional[StrictStr], Field(description="Filter activities created after this timestamp (ISO 8601 format with milliseconds)")] = None,
        until: Annotated[Optional[StrictStr], Field(description="Filter activities created before this timestamp (ISO 8601 format with milliseconds)")] = None,
        ...
        :type status: str
        :param since: Filter activities created after this timestamp (ISO 8601 format with milliseconds)
        :type since: str
        :param until: Filter activities created before this timestamp (ISO 8601 format with milliseconds)
        :type until: str
