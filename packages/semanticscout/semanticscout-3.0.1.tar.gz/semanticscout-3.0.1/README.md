...
- ✅ **UUID-Based Collection Naming** - Collections now use unique identifiers for better multi-project support
- ✅ **Embedding Dimensions Metadata** - Embedding model and dimensions stored as separate metadata fields
- ✅ **Enhanced Collection Management** - Improved collection naming scheme (e.g., `morfeus_qt_<uuid>` instead of `morfeus_qt_nomic_embed_text`)
...
- 🌳 **AST-Based Parsing** - tree-sitter for accurate symbol extraction and dependency tracking (11 languages)
...
- ⚡ **High Performance** - <100ms queries, <2s per file indexing, <1GB memory
...
│   ├── dependency_analysis/       # Language-aware analysis
