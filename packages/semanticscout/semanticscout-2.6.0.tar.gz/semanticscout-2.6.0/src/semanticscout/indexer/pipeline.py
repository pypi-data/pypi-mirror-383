...
class IndexingPipeline:
    ...
    def index_codebase(
        ...
        try:
            ...
            # Resolve C# namespace dependencies to actual files
            if self.dependency_graph and self.symbol_table:
                try:
                    logger.info("Attempting to resolve C# namespace dependencies...")
                    resolved = self.dependency_graph.resolve_csharp_namespace_dependencies(self.symbol_table)
                    if resolved > 0:
