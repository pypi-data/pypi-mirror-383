...
class FileDiscovery:
    ...
    def discover_files(self, root_path: str | Path) -> List[Path]:
        """
        ...
        # Discover files
        discovered_files = []
        self._discover_recursive(root, root, gitignore_spec, discovered_files, depth=0)
        ...
        for entry in entries:
            ...
            if entry.is_file():
                ...
                self._discover_recursive(
                    entry, root_path, gitignore_spec, discovered_files, depth + 1
                )
