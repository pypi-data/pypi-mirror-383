                ...
                chunk_dicts = [
                    {
                        ...
                        "metadata": {
                            "content_hash": chunk.content_hash,  # NEW: Store hash for future matching
                        }
                    }
            ...
            if self.ast_processor and self.symbol_table:
                ...
                if parse_result and parse_result.success:
                    ...
                    if self.dependency_graph:
                        ...
                        result.dependencies_added = len(parse_result.dependencies)
                        logger.debug(f"Added {len(parse_result.dependencies)} new dependencies")
