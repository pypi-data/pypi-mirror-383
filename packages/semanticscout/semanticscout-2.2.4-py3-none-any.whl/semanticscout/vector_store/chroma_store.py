...
class ChromaVectorStore:
    ...
    def get_or_create_collection(
        ...
        try:
            ...
            logger.info(
                ...
                f"(model: {model_name}, dimensions: {embedding_dimension})"
            )
            return collection
    ...
    def generate_collection_name(self, codebase_path: str) -> str:
        """
        Generate a collection name from a codebase path using the project name.

        Args:
            codebase_path: Path to the codebase

        Returns:
            Collection name (sanitized project name)
        """
