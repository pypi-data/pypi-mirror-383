...
class ScancodeParser(BaseParser):
    ...
    def _normalize_context(
        self, context: Optional[GraphManager | str | dict]
    ) -> GraphManager:
        """Delegate to BaseParser normalization for callable usage."""

        return super()._normalize_context(context)
    ...
    def __call__(
        ...
        gm = self._normalize_context(context)
        proproc = (
