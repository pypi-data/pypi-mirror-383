...
class Test(Component):
    ...
    - custom_spinner (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        custom_spinner: typing.Optional[typing.Any] = None,
...
setattr(Test, "__init__", _explicitize_args(Test.__init__))
