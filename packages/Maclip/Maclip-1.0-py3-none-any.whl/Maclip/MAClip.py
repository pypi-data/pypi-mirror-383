...
class MA_CLIP(nn.Module):
    ...
    def box_cox(x, lam=0.5, epsilon=1e-6):
    ...
    def fusion(cos, norm, base_cos=1.0, base_norm=0.6, alpha=1.0):
        d = cos - norm 
    ...
    def forward(self, x, lam=0.5, base_cos=1.0, base_norm=0.6, alpha=1.0):
        ...
        image_features_org_abs_box = self.box_cox(image_features_org_abs, lam=lam)
