...
class ModalSingleBG(BaseModal):
    ...
    class Meta:
        verbose_name = "단일배경 팝업"
        verbose_name_plural = "단일배경 팝업"
...
class ModalLinkVideo(BaseModal):
    ...
    class Meta:
        verbose_name = "비디오링크 팝업"
        verbose_name_plural = "비디오링크 팝업"
...
class ModalRotateBG(BaseModal):
    ...
    class Meta:
        verbose_name = "순환배경 팝업"
        verbose_name_plural = "순환배경 팝업"