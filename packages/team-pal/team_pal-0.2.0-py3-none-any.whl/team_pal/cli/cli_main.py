...
def _parse_args(argv: Sequence[str] | None) -> argparse.Namespace:
    ...
    parser.add_argument("--multi-project", action="store_true", help="Enable multi-project mode (projects detected under the root directory).")
    parser.add_argument("--root-dir", help="Root directory that contains project subdirectories (defaults to current working directory).")
    parser.add_argument(
        "--python-mode",
        dest="python_mode",
        action="store_true",
        default=None,
        help="Enable Python virtualenv activation before running agents (default).",
    )
    parser.add_argument(
        "--no-python-mode",
        dest="python_mode",
        action="store_false",
        help="Disable Python virtualenv activation.",
    )
