...
class GxV2H5GetStartUrlRequest(BaseRequest):
    """
    预启动请求-请求
...
class GxV2H5GetStartUrlResponse(BaseRequest):
    """
    预启动返回-响应
...
class GxV2H5GetAicStatusRequest(BaseRequest):
    """
    查询个体工商户状态请求-请求
...
class GxV2H5GetAicStatusResponse(BaseRequest):
    """
    查询个体工商户状态返回-响应
...
class NotifyGxV2H5AicRequest(BaseRequest):
    """
    个体工商户注册/注销结果回调通知-请求
