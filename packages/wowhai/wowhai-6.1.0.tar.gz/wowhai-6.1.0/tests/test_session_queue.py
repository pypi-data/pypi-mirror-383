...
def test_cannot_create_bad_batch_nodes_exist(
    ...
    try:
        ...
        return
    pytest.xfail("Batch no longer raises ValidationError when node is missing; backend fix pending.")
...
def test_cannot_create_bad_batch_fields_exist(
    ...
    try:
        ...
        return
    pytest.xfail("Batch no longer raises ValidationError when field is missing; backend fix pending.")
