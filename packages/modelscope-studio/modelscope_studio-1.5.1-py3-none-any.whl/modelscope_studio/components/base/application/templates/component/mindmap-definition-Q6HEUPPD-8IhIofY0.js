import { g as le } from "./chunk-55IACEB6-Dm2OzOmE.js";
import { s as he } from "./chunk-QN33PNHL-DMuJaUDu.js";
import { _ as l, l as C, o as de, r as ge, F as B, c as z, i as F, aF as ue, W as pe, X as fe, Y as ye } from "./mermaid.core-VANNf1YM.js";
const E = [];
for (let t = 0; t < 256; ++t)
...
var Y = function() {
  var t = /* @__PURE__ */ l(function(v, s, i, a) {
    ...
    table: [{
      ...
      19: p,
      22: f
    }), t(S, [2, 18]), t(S, [2, 19]), t(S, [2, 20]), t(S, [2, 21]), t(S, [2, 23]), t(S, [2, 24]), t(S, [2, 26], {
      19: [1, 30]
    }), {
      20: [1, 31]
    }, {
      ...
      7: K,
      11: Q
    }), t(w, [2, 8]), t(w, [2, 9]), t(w, [2, 10]), t(S, [2, 15]), t(S, [2, 16]), t(S, [2, 17]), {
      20: [1, 35]
    }, {
      21: [1, 36]
    }, t(J, [2, 13], {
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, a = [0], o = [], g = [null], r = [], A = this.table, d = "", P = 0, Z = 0, re = 2, ee = 1, ae = r.slice.call(arguments, 1), y = Object.create(this.lexer), T = {
        yy: {}
      };
...
Expecting ` + V.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : W = "Parse error on line " + (P + 1) + ": Unexpected " + (b == ee ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(W, {
        ...
        switch (k[0]) {
          ...
          case 2:
            ...
            }, oe && (I._$.range = [r[r.length - (L || 1)].range[0], r[r.length - 1].range[1]]), $ = this.performAction.apply(I, [d, Z, P, T.yy, k[1], g, r].concat(ae)), typeof $ < "u")
              return $;
...
var De = Y, x = {
  ...
  addNode(e, n, c, u) {
    ...
    if (N)
      ...
      throw new Error(`There can be only one root. No parent could be found for ("${f.descr}")`);
  }
  getType(e, n) {
  ...
  getData() {
    ...
    const p = [], f = [];
    this.flattenNodes(e, p), this.generateEdges(e, f), C.debug(`getData: processed ${p.length} nodes and ${f.length} edges`);
...
` + t);
  ...
  }), await ge(h, p), he(p, ((N = h.config.mindmap) == null ? void 0 : N.padding) ?? B.mindmap.padding, "mindmapDiagram", ((_ = h.config.mindmap) == null ? void 0 : _.useMaxWidth) ?? B.mindmap.useMaxWidth));
}, "draw"), Le = {
  draw: ke
}, xe = /* @__PURE__ */ l((t) => {
  let e = "";
