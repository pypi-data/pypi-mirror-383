...
class LDATrainer:
    ...
    def load_training_data(self):
        ...
        Input: Reads from intermediate directory:
               - training.txt: Document-per-line text file with space-separated tokens
               - annotated_randomid.csv: Sample abundance matrix with random IDs
        
        Output: Sets instance attributes:
                - self.flattened_nested_list: List of document strings
