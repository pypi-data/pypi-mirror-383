...
# These tools are strongly recommended for better code quality and performance
# They can be disabled with: cmake -DENABLE_CLANG_TIDY=OFF -DENABLE_CPPCHECK=OFF -DENABLE_OPENMP=OFF

option(ENABLE_CLANG_TIDY "Enable clang-tidy checks (highly recommended)" ON)
option(ENABLE_CPPCHECK "Enable cppcheck checks (highly recommended)" ON)
option(ENABLE_OPENMP "Enable OpenMP parallel programming support (optional)" ON)
...
if(ENABLE_CPPCHECK AND CPPCHECK_EXE)
  if(CMAKE_CXX_CPPCHECK)
    ...
    set(CMAKE_CXX_CPPCHECK
        "${CPPCHECK_EXE};--inline-suppr;--enable=all;--suppress=missingIncludeSystem"
