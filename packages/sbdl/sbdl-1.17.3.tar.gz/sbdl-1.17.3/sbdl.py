#!/usr/bin/python3
_CX='SteeringFirmware::correctCourse'
_CW='rocket_in_motion'
_CV='rocket_ready'
_CU='correct_course'
_CT='fire_booster'
_CS='steering_requirement_1'
_CR='booster_requirement_1'
_CQ='steering_firmware'
_CP='test/macro.py'
_CO='--custom-mode'
_CN='--custom-directive'
_CM='template-fill'
_CL='openfmea-csv'
_CK='skinparam linetype ortho\n'
_CJ='{} .{}.{} {}{}\n'
_CI='\n{}{} "{}" as {} {}{}'
_CH='Not a file: {}'
_CG='Reading: {}'
...
_CA='customtype'
_C9='arguments'
_C8='skinparam NoteBackgroundColor LightSteelBlue\nskinparam ParticipantBackgroundColor LightGrey\nskinparam backgroundColor transparent'
_C7='multipartite'
_C6='sbdl_unique_identifier_gen_alphabet'
_C5='sbdl_unique_identifier_gen_length'
_C4='profile_output'
_C3='fmea_cause_extension'
_C2='openfmea_bidirectional_import_relations'
_C1='openfmea_include_in_template'
_C0='openfmea_fmeadev_url'
_B_='openfmea_content_based_keys'
_Bz='openfmea_include_cme_unlinked'
_By='openfmea_include_cme_orphans'
_Bx='openfmea_expand_compoundfields'
_Bw='remote_procedure_call_api_endpoint'
_Bv='remote_procedure_call_api_key'
_Bu='remote_procedure_call_enable'
_Bt='remote_resouce_fetch_enable'
_Bs='sbdl_disable_pretty_print'
_Br='sbdl_disable_pretty_print_environ'
_Bq='manual_command'
_Bp='add_description_bsci_property'
_Bo='elision_placeholder'
_Bn='reference_maximum_length'
_Bm='usecase_diagram_style'
_Bl='state_diagram_descriptions'
_Bk='state_diagram_style'
_Bj='uml_text_block_wrap_element'
_Bi='process_diagram_descriptions'
_Bh='function_diagram_aspect'
_Bg='function_diagram_descriptions'
_Bf='aspect_diagram_descriptions'
_Be='aspect_diagram_element'
_Bd='aspect_diagram_aspect'
_Bc='requirement_diagram_legend'
_Bb='requirement_diagram_style'
_Ba='requirement_diagram_title_node_always'
_BZ='requirement_diagram_toplevel_depth'
_BY='requirement_diagram_aspect_groups'
_BX='network_diagram_hide_types'
_BW='network_diagram_dpi'
_BV='network_diagram_layout'
_BU='network_diagram_labels'
_BT='network_diagram_descriptions'
_BS='network_diagram_height'
_BR='network_diagram_width'
_BQ='parser_allow_load_config'
_BP='parser_allow_custom_directive_import'
_BO='parser_custom_attributes'
_BN='parser_allow_preparse_directives'
_BM='plantuml_generate_footer'
_BL='plantuml_output_type'
_BK='plantuml_limit_size'
_BJ='plantuml_command'
_BI='wsl_auto_correct_paths'
_BH='sbdl_import_allows_recurse'
_BG='sbdl_warn_new_config'
_BF='sbdl_update_package'
_BE='sbdl_hash_check'
_BD='sbdl_hash_length'
_BC='sbdl_ast_pre_hooks'
_BB='sbdl_attribute_passthrough'
_BA='sbdl_file_extension'
_B9='sbdl_output_reference'
_B8='sbdl_element_color_map'
_B7='sbdl_grammar_write_statement_separator'
_B6='sbdl_grammar_write_attribute_separator'
_B5='sbdl_grammar_custom_comment'
_B4='sbdl_grammar_custom_noop'
_B3='sbdl_grammar_custom_end'
_B2='sbdl_grammar_custom_begin'
_B1='sbdl_grammar_custom_suffix'
_B0='sbdl_grammar_custom_prefix'
_A_='rocket_launch'
_Az='launch_protocol'
_Ay='system_requirement_1'
_Ax='rocket_steering'
_Aw='rocket_system'
_Av='test/function_test.sbdl'
_Au='from:yaml-tree'
_At='usecase-diagram'
_As='state-diagram'
_Ar='function-process-diagram'
_Aq='function-diagram'
_Ap='network-diagram'
_Ao='requirement-diagram'
_An='element-diagram'
_Am='aspect-diagram'
_Al='from:openfmea'
_Ak='openfmea-portfolio'
_Aj='yaml-tree'
_Ai='compile'
_Ah='format'
_Ag='<<{}>>'
...
_AW='ignore'
_AV='linux'
_AU='openfmea_compoundfield_separator'
_AT='usecase_diagram_descriptions'
_AS='function_diagram_style'
_AR='aspect_diagram_style'
_AQ='network_diagram_node_size'
_AP='parser_allow_global_directive_definition'
_AO='parser_allow_directive_definition'
_AN='plantuml_ortho_line_routing'
_AM='plantuml_layout_tweaks'
_AL='plantuml_raw_output'
_AK='prolog_trace_file'
...
__LOGO=''
__HELP_TEXT=''
_CONFIG_DATA={_B0:'_sbdl\\s?\\(',_B1:'\\)$',_B2:'_sbdl_block_begin',_B3:'_sbdl_block_end',_B4:'^\\.\\.\\.$',_B5:_B,_B6:_A,_B7:_C,_o:_A,_B8:{},_V:_C,_B9:_A,_BA:'.sbdl',_BB:_O,_BC:[],_k:[],_BD:5,_BE:_A,_BF:'sbdl-package.tar.gz',_AJ:_C,_A0:_C,_A1:_C,_BG:_A,_BH:_A,_BI:_A,_l:_A,_A2:_C,_AK:_B,_AL:_C,_BJ:'plantuml',_BK:65536,_BL:'png',_BM:_A,_AM:_C,_AN:_C,_A3:_A,_BN:_A,_AO:_A,_AP:_A,_T:{},_BO:_A,_BP:_A,_BQ:_A,_BR:38,_BS:22,_BT:_C,_BU:_A,_AQ:20000,_BV:_C7,_BW:200,_BX:'',_BY:_C,_BZ:2,_Ba:_C,_W:"skinparam dpi 200\nskinparam backgroundColor transparent\n'skinparam monochrome reverse\n\n",_Bb:'\n<style>\n  node {\n      HorizontalAlignment center\n      MaximumWidth 150\n  }\n  wbsDiagram {\n    Linecolor black\n    arrow {\n      LineColor black\n    }\n    .toplevel {\n    }\n    .source {\n      LineStyle 2\n      RoundCorner 10\n    }\n    .aspect {\n      LineStyle 8.0;3.0\n      LineColor lightgray\n      BackgroundColor lightgray\n      LineThickness 1.0\n      RoundCorner 0\n      Shadowing 0.0\n    }\n  }\n</style>',_Bc:_B,_AR:'hide circle',_Bd:'frame',_Be:'class',_Bf:_C,_AS:_C8,_Bg:_C,_Bh:'participant','process_diagram_style':_C8,_Bi:_C,_p:_C,_c:15,_Bj:40,_Bk:'',_Bl:_C,_Bm:'',_AT:_C,_Bn:0,_Bo:'[...]',_Bp:_C,_Bq:'less -R'if os.name=='posix'else'',_Br:'SBDL_NO_PRETTY',_Bs:_C,_Bt:_A,_Bu:_C,_Bv:'1879da28-0fc2-4f1d-8ff1-407f4c070c44',_Bw:'{base}/{endp}'.format(base=__URL,endp='rest.api'),_AU:'; ',_Bx:'',_By:_A,_Bz:_A,_B_:_C,_C0:'https://fmea.dev',_C1:_A,_C2:_C,_C3:_X,_C4:_B,_C5:8,_C6:'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'}
...
def allow_pretty_print():return not get_config_value(_Br)in os.environ and not get_config_value(_Bs,number=_A)
...
def current_os():
	...
	elif sys.platform.startswith(_AV):return _AV
...
def set_config_value(key,data):
	if not key in _CONFIG_DATA and get_config_value(_BG,number=_A):f_print('WARNING: adding new key ({}) to config registry'.format(key),warning=_A)
...
def safe_stdout_endcode(in_string):
	result=in_string
	if isinstance(result,str):result=result.encode(sys.stdout.encoding,errors=_AW).decode(sys.stdout.encoding)
	return result
...
def rest_api_call(function_name,arguments_dict,print_l=print_null):
	D='result';C='api_version';B='errors';A='api_name';API_END_POINT=get_config_value(_Bw);result_data={}
	def create_rest_object(command,arguments_dict):return{A:name(),C:version_rest_api(),'api_key':get_config_value(_Bv),_AX:command,_C9:{**arguments_dict}}
...
class SBDL_Parser:
	...
	class Parser_Element:
		...
		def shorten_reference(self,reference):
			reference_result=reference;max_length=get_config_value(_Bn,number=_A)
			if max_length!=_B and max_length>0:reference_result=(reference_result[::-1][:max_length]+(reference_result[::-1][max_length:]and get_config_value(_Bo)[::-1]))[::-1]
	...
	def builtin_directive_dict(self):
		...
		def extend_deeper_cause(macros,*inp):
			...
			if SBDL_Parser.Macros.cross_reference_available in macros:
				extend_symbol=get_config_value(_C3)
		...
		def prolog_startup(_,*inp):
			...
			def prolog_element_to_fact(element):
				...
				handle_link_list(links,_AZ);handle_link_list(parents,'parents');handle_link_list(children,'children');handle_link_list(related,'related');return prolog_attr(etype,prolog_separator.join(attr_list),quote=_C)
			...
			if not A in globals():
				...
				trace_file_path=get_config_value(_AK)
		...
		def prolog_trace_file(_,*inp):
			...
			set_config_value(_AK,inp[0]);return''
	...
	def sanitize(self,unclean_string):
		...
		return result.encode(_CE).decode(_Aa).replace('\\\\',_Y)
	@classmethod
	def sanitize_escaped(self,unclean_string,reverse=_C):
		...
		return result
	@classmethod
	def remove_escape_chars(self,escaped_string):return escaped_string.encode(_q).decode(_CE)
	@classmethod
	def attribute_string(self,statement_object):
		...
		for attr in sorted(statement_object.data()):
			...
			if len(content)>0:
				...
				attributes+='{indent}{attrname}{assign}{delimiter}{attrcontent}{delimiter}{separator}{newline}{spacing}'.format(attrname=attr,assign=SBDL_Parser.Tokens.declaration_attribute_assign,delimiter=delim,attrcontent=content,separator=SBDL_Parser.Tokens.declaration_attribute_separator if get_config_value(_B6,number=_A)else'',indent=indent_str,newline=newline_str,spacing=spacing_str)
		return attributes
	@classmethod
...
class SBDL_Semantics:
	...
	def get_language_information_struct(self):
		...
		for type_name in lang_type_struct:
			lang_type_struct[type_name][_AZ]=self.get_valid_link_type_for_type_name(type_name);valid_properties=list(self.global_properties.keys())
		...
		lang_info_struct[_u]=self.property_descriptions;lang_info_struct[_Af]=dict.fromkeys([x for x in vars(SBDL_Parser.Macros).values()if isinstance(x,str)and x!=_j and x!='__main__'],'No Description')
		for directive_description in self.directive_descriptons:lang_info_struct[_Af][directive_description]=self.directive_descriptons[directive_description]
		lang_info_struct['CLI']=help_text();return lang_info_struct
	@classmethod
	def type_color(self,type_name):
		E='#FFFF00';D='#FF6347';C='#FF69B4';B='#9370DB';A='#1E90FF';color_list=['#FFC0CB','#FFA07A','#FFD700','#32CD32','#00FFFF',A,B,C,D,E,'#008000','#00FF7F','#00CED1','#00BFFF',A,B,C,D,'#FF4500',E,'#9ACD32','#ADFF2F','#7FFFD4','#AFEEEE','#ADD8E6','#87CEEB','#8A2BE2','#FF00FF','#FF1493'];color_index_map=get_config_value(_B8)
	...
	def get_unique_id_from_string(self,input_string):
		digest=hashlib.sha256(input_string.encode('utf‑8')).digest();alphabet=get_config_value(_C6);length=get_config_value(_C5,number=_A);num=int.from_bytes(digest,'big');base=len(alphabet);smart_key=[]
...
class SBDL_Element:
	...
	class Element_Link:
		...
		def is_a(self,target):
			...
			if not result:
				if isinstance(target,type)and hasattr(target,_CF):
	...
	def validate_self(self,elements=_B):
		...
		for link in self.links()+self.parents()+self.children()+self.related():
			...
			if get_config_value(_BE,number=_A):
				if link.hash():
	...
	def hash(self):return hashlib.sha256(re.sub('\\s+',_H,self.definition().parser_element().content().strip()).encode()).hexdigest()[:get_config_value(_BD,number=_A)]
	@classmethod
...
class SBDL_AST:
	...
	def elements(self,print_l=print_null,prune_missing_references=_C):
				...
				if isinstance(parsed_object,SBDL_Using_Statement):print_l('USING+=: {}'.format(parsed_object.data()),debug=_A);handle_using(parsed_object.data(),inherit_data)
					...
					try:
						...
						if not statement_element.identifier()in sbdl_elements:
							if get_config_value(_Bp,number=_A)and statement_element.description():statement_element.set_property(SBDL_Parser.Attributes.description_bsci,SBDL_Semantics.calc_bsci(statement_element.description(),'english'))
		...
		if get_config_value(_A3,number=_A):
			...
			if get_config_value(_AO,number=_A)and get_config_value(_AP,number=_A):crossref_dict.update(get_config_value(_T))
...
def make_remote_file_local(file_reference):
	...
	if parsed_file_reference.scheme in['http','https','ftp','file://']and get_config_value(_Bt,number=_A):
...
def get_parser_elements_from_filepath(filepath,elements_list,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	local_directives={}
	if get_config_value(_AP,number=_A):local_directives=get_config_value(_T)
	...
	file_name=os.path.basename(filepath);file_ext=os.path.splitext(filepath)[1:][0];dir_name=filepath.replace(file_name,'');abs_path=os.path.abspath(filepath);native_sbdl_file=_A if get_config_value(_BA)==file_ext else _C;update_per_file_directives()
	...
	def import_directive(_,*inp):
		...
		try:
			print_l('Import: {}'.format(import_path));read_elements,import_errors=aggregate_all_parser_elements_from_files([import_path],do_recurse=get_config_value(_BH,number=_A),do_hidden=_C,print_l=print_l,file_opener=file_opener,read_input_set=read_input_set);elements_list.extend(read_elements);errors+=import_errors
	...
	def strip_comments(line):
		result=line;comment_markers=[SBDL_Parser.Tokens.comment,get_config_value(_B5)]
	...
	def detect_block_start_end(line):
		...
		if re.search(SBDL_Parser.Tokens.prefix_block_start,line)or re.search(get_config_value(_B2),line):native_sbdl_file=_A;result=_A
		elif re.search(SBDL_Parser.Tokens.prefix_block_end,line)or re.search(get_config_value(_B3),line):native_sbdl_file=_C;result=_A
		return result
	def extract_sbdl_line_non_native(line):
		nonlocal non_sbdl_line_prefix;result='';custom_prefix=get_config_value(_B0);custom_suffix=get_config_value(_B1);custom_noop=get_config_value(_B4)
...
def aggregate_all_parser_elements_from_files(input_list,do_recurse,do_hidden,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	for afile in input_list:
		...
		else:errors+=1;print_l(_CH.format(afile),error=_A)
...
def plantuml_writer(file_opener,output_file,content,_):
	...
	if not get_config_value(_AL,number=_A):
		try:
			plantuml_env=os.environ.copy();plantuml_env.pop('LD_LIBRARY_PATH',_B);plantuml_env['PLANTUML_LIMIT_SIZE']=str(get_config_value(_BK));plantuml_command=get_config_value(_BJ)
			if isinstance(plantuml_command,str):plantuml_command=shlex.split(plantuml_command)
			plantuml_command_full=plantuml_command+['-t',get_config_value(_BL),'-p'];debug_out('EXECUTE_PLANTUML: '+str(plantuml_command_full));exec_result=subprocess.run(plantuml_command_full,input=content.encode(),stdout=subprocess.PIPE,stderr=subprocess.STDOUT,env=plantuml_env,check=_C);content_to_output=exec_result.stdout
		except:raise Exception('Error while executing PlantUML')
	with file_opener(output_file,is_text=get_config_value(_AL,number=_A))as plantuml_file:plantuml_file.write(content_to_output)
def plantuml_footer_generator():
	footer_content=''
	if get_config_value(_BM,number=_A):footer_content+='footer \\nGenerated by {generator} on {date}\\n\\n\n'.format(generator='{} version {}'.format(__NAME,__VERSION),date=get_date_string())
...
def write_requirement_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if len(top_level_requirements)==1 and not get_config_value(_Ba):root_requirement=requirements[top_level_requirements[0][A]]
	else:
	...
	def plantuml_requirement_diagram_wrap(content):
		header=plantuml_footer_generator();legend_text='';legend=get_config_value(_Bc)
		if legend!=_B:legend_text='legend\n{legend_content}\nendlegend\n'.format(legend_content=legend)
		plant_uml_prepost='@startwbs\n{style}\n\n{header}\n{content}\n{legend}@endwbs\n';return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bb),header=header,content=content,legend=legend_text)
...
def write_decomposition_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_decomposition_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;content='';notes='';note_count=0;interface_count=0;relations='';descriptions=get_config_value(_Bf,number=_A);interface_mem={};handled_elems=[];indentation_prefix=_M
		...
		def interface_rel_pos(posindex):positions={0:'up',1:'down',2:_A8,3:_A9};return positions[posindex%4]if get_config_value(_AM,number=_A)else''
		def handle_elem(elem_id,pref='',parent_id=_B):
			...
			if not elem_id in handled_elems and elements[elem_id].is_a(SBDL_Aspect):
				...
				for interface in interfaces:add_interface_line(interface,_A4);stereotype=interface.stereotype();relations+='{} -{}- {}{}\n'.format(puml_id(elem_id),interface_rel_pos(interface_count),puml_id(interface.identifier()),''if not stereotype else': '+stereotype);interface_count+=1
				aspect_stereotype=elements[elem_id].stereotype()
				if aspect_stereotype==_B:aspect_stereotype=''
				else:aspect_stereotype=_Ag.format(aspect_stereotype)
				content+=_CI.format(pref,get_config_value(_Bd),elem_id,puml_id(elem_id),aspect_stereotype,''if not SBDL_Parser.Attributes.color in elements[elem_id].properties()else' #'+elements[elem_id].get_property(SBDL_Parser.Attributes.color));children=SBDL_AST.get_all_children_for_element(elements[elem_id],elements)
				...
				for relation in related:
					if parent_id!=relation.identifier():
						...
						relations+=_CJ.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text);interface_count+=1
			else:0
		...
		return plant_uml_prepost.format(style=(_CK if get_config_value(_AN,number=_A)else'')+get_config_value(_W)+get_config_value(_AR),header=header+title,content=content+_D+relations+_D+(_D+notes if descriptions or arguments.source else''))
...
def write_element_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_decomposition_diagram():
		...
		def puml_id(elem_id):return plantuml_identifier(elem_id).replace('(','').replace(')','').replace('[]','').replace(']','').replace(':',_X).encode(_Aa,_AW).decode(_Aa)
		def interface_rel_pos(posindex):positions={0:'up',1:'down',2:_A8,3:_A9};return positions[posindex%4]if get_config_value(_AM,number=_A)else''
		def detailed_content(elem_id):
			props=[];links={};result='\t{}: **{}**\n'.format(SBDL_Parser.Attributes.type,elements[elem_id].type());elem=elements[elem_id]
			for prop in elem.properties():props.append('\t{}:\n\t  {}'.format(prop,textwrap.shorten(elem.get_property(prop),width=get_config_value(_Bj,number=_A),placeholder='...')))
		...
		def handle_elem(elem_id,pref='',_=_B):
			...
			if not elem_id in handled_elems:
				...
				content+=_CI.format(pref,get_config_value(_Be),elem_id,puml_id(elem_id),aspect_stereotype,''if not SBDL_Parser.Attributes.color in elements[elem_id].properties()else' #'+elements[elem_id].get_property(SBDL_Parser.Attributes.color));content+='{{\n{}\n}}\n'.format(detailed_content(elem_id));related=elements[elem_id].related();related.extend([link for link in elements[elem_id].links()])
				for relation in related:
					relation_type=relation.stereotype();relation_type=relation_type if relation_type else'';link_text=': '+relation_type if relation_type else'';relation_end='>'
					if relation_type.startswith(SBDL_Parser.Tokens.inherit):relation_end='|>'
					elif elements[relation.identifier()].is_a(SBDL_Parser.Types.interface):relation_end='('
					elif relation_type.startswith(SBDL_Parser.Tokens.compose):relation_end=_O
					relations+=_CJ.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text)
			else:0
		elements_ordered=list(elements.keys())
		for elem in elements_ordered:handle_elem(elem)
		return plant_uml_prepost.format(style=(_CK if get_config_value(_AN,number=_A)else'')+get_config_value(_W)+get_config_value(_AR),header=header+title,content=content+_D+relations+_D+(_D+''))
	plantuml_writer(file_opener,output_file,plantuml_decomposition_diagram(),print_l);return errors
def write_function_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bg,number=_A);event_count=0;entities={}
	def puml_id(elem_id):return plantuml_identifier(elem_id)
	def plantuml_function_diagram():
		...
		def handle_func(func_id,depth=1):
			...
			def define_aspect(aspect_name):
				...
				if not aspect_name in entities:
					...
					content+='{}{} "{}{}" as {} {}{}\n'.format(_M*depth,get_config_value(_Bh),aspect_name,_G+elements[aspect_name].reference()if arguments.source else'',puml_id(aspect_name),aspect_stereotype,aspect_color)
			content+='group {}<<{}>> {}{} #red\n'.format(elem_colour_prefix(func_element),func_element.stereotype()if func_element.stereotype()else func_element.type(),puml_id(func_element.identifier()),_G+func_element.reference()if arguments.source else'')
		...
		return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_AS),header=header+title,content=content)
...
def write_process_graph_output(sbdl_ast,output_file,file_opener,_,print_l):
	errors=0;elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bi,number=_A);first_event=_A;g_process_elem=_B;note_stagger=_C
	def elem_colour_prefix(elem):
		colour=''
		if SBDL_Parser.Attributes.color in elem.properties():colour=f"#{elem.get_property(SBDL_Parser.Attributes.color)} "
		return colour
	...
	def handle_process_element(process_elem):
		...
		if not get_config_value(_p,number=_A):
			process_cont+=f'group {elem_colour_prefix(process_elem)}"**{process_elem.stereotype()if process_elem.stereotype()else process_elem.type()}** {process_elem.identifier()}" {{\n';description=process_elem.description()
	...
	def plantuml_process_diagram():
		process_dia_cont='';process_dia_cont+='@startuml\n';process_dia_cont+=get_config_value(_W)+get_config_value(_AS)+_f
...
def write_state_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bl,number=_A)
	def plantuml_state_diagram():
		...
		return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bk),header=header+title,content=statedefs+content+_D+relations)
...
def write_usecase_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_usecase_diagram():
		...
		for usecase in[elements[elem]for elem in elements if elements[elem].is_a(SBDL_UseCase)]:
			actor=usecase.get_property(_AY)if _AY in usecase.properties()else'User';content+='actor "{}" as {}\n'.format(actor,puml_id(actor))
		...
		for aspect in aspects:
			...
			for usecase_tuple in aspects[aspect]:content+='  usecase "{}" as {}\n'.format('**{}**\\n{}{}'.format(usecase_tuple[3],_G.join(textwrap.wrap(usecase_tuple[4],get_config_value(_c,number=_A))),_G+usecase_tuple[6]if arguments.source else'')if get_config_value(_AT,number=_A)else usecase_tuple[3],puml_id(usecase_tuple[3]));relations+='\n{} --> {}: {}{}\n'.format(puml_id(usecase_tuple[0]),puml_id(usecase_tuple[3]),'**{}**\\n{}'.format(usecase_tuple[1],_G.join(textwrap.wrap(usecase_tuple[2],get_config_value(_c,number=_A))))if get_config_value(_AT,number=_A)else usecase_tuple[1],_G+usecase_tuple[5]if arguments.source else'')
			content+='}\n'
		content+=relations;return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bm),header=header+title,content=content)
...
def write_network_graph_output(sbdl_ast,output_file,_,arguments,print_l):
	...
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);sbdl_graph=nx.MultiDiGraph();skip_types={x for x in get_config_value(_BX,number=_C).split(_S)};node_name_sep='::';node_text_wrap_width=25
	def node_name(elem_id):
		...
		if get_config_value(_BT,number=_A):node_text+=_f+_D.join(textwrap.wrap(elements[elem_id].description(),width=node_text_wrap_width))
	...
	def dot(graphin):return nx.nx_agraph.graphviz_layout(graphin,prog='dot',args='-Goverlap=false -Goverlap_scaling=1000000 -Gscale={} -Gsep=20 -Gdefaultdist=100000'.format(get_config_value(_AQ,number=_A)))
	def spring(graphin):return nx.spring_layout(graphin,k=1)
	layouts={_C7:mpl,'graphviz':dot,'spring':spring,'spiral':nx.spiral_layout,'random':nx.random_layout,'planar':nx.planar_layout};options={'font_size':10,'node_size':get_config_value(_AQ,number=_A),'edgecolors':'gray','edge_color':'darkgray','linewidths':1,'with_labels':get_config_value(_BU,number=_A),'width':2,'node_color':colour_list,'node_shape':'s','pos':layouts[get_config_value(_BV,number=_C)](sbdl_graph)};plt.figure(figsize=(get_config_value(_BR,number=_A),get_config_value(_BS,number=_A)));nx.draw_networkx(sbdl_graph,**options,alpha=1.);ax=plt.gca();ax.margins(.0);plt.axis('off');plt.tight_layout();plt.plot();plt.savefig(output_file,dpi=get_config_value(_BW,number=_A));return errors
class OpenFMEA:
	@classmethod
	def generate_sbdl_table_from_ast(self,sbdl_ast,id_in_body=_C,source_in_body=_C,print_l=print_null,multi_field_separator=_B):
		A='key'
		if multi_field_separator is _B:multi_field_separator=get_config_value(_AU)
		id_counter=0;sbdl_row={A:_B,_d:_B,_Z:_B,_L:_B,_b:_B,_R:_B,_n:_B,_g:_B,_s:_B,_t:_B,_A6:_B,_r:_B,_A5:_B,_z:_B,_h:_B}
		...
		def generate_table(element,row=_B,path=_B,add_single=_C):
			...
			def add_row():
				...
				rows_to_add=[row];expand_attrs=get_config_value(_Bx)
			...
			if not element.identifier()in path:
				path[element.identifier()]=_A;custom_prop_prefix=SBDL_Parser.Attributes.custom_prefix+get_config_value(_BB)
				...
				if element.identifier()==start_node.identifier():recurse_links(SBDL_Failure_Cause)
					...
					if not is_fully_meta()and(get_config_value(_Bz,number=_A)or not is_partly_meta()):add_row()
				elif element.is_a(SBDL_Failure_Cause):
					events=get_compounded_linked_events();assign_column(_R,_H+events if len(events)>0 else'');assign_column_value(_t,element.rating());assign_column_value(_A6,element.rating(post=_A))
					...
					assign_column(_b);assign_column_value(_s,element.rating())
	...
	def struct_from_table(self,title,sbdl_table,open_fmea_type=_Q):
		result_struct={_Ah:_AA,'version':'1.0',_K:open_fmea_type,_i:{'title':title,'application':name(),'application_version':version(),'cmd_line':str(sys.argv),'date':get_date_string()},_w:sbdl_table,'layout':{}};result_struct[_i]['user']=get_user_string()
		try:result_struct[_i][_A7]=platform.uname()
		except Exception as _:result_struct[_i][_A7]='UNKNOWN'
	...
	def read_struct_from_file(self,open_sbdl_file):
		...
		if not(_Ah in open_sbdl_content and open_sbdl_content[_Ah]==_AA):raise Exception('Not an OpenFMEA file')
	...
	def elements_from_table(self,sbdl_table,_):
		multi_field_separator=get_config_value(_AU);elems_to_consider={_d:SBDL_Parser.Types.aspect,_Z:SBDL_Parser.Types.requirement,_L:SBDL_Parser.Types.mode,_b:SBDL_Parser.Types.effect,_R:SBDL_Parser.Types.cause,_n:SBDL_Parser.Types.current_control,_g:SBDL_Parser.Types.current_detection,_z:SBDL_Parser.Types.action_control,_h:SBDL_Parser.Types.action_detection};elem_rating={_b:_s,_R:_t,_L:_r};elem_rating_post={_R:_A6,_L:_A5};elem_link={_R:[_L,_n,_z,_g,_h],_L:[_d,_b,_g,_Z,_h,_R],_Z:[_d,_L],_b:[_L],_n:[_R],_g:[_L],_z:[_R],_h:[_L]};elem_present_every_row={_g,_h};replace_str=SBDL_Parser.Tokens.replacement_string_default;elements={};id_lookup={}
		if not get_config_value(_C2,number=_A):elem_link[_L].remove(_R);elem_link[_b].remove(_L)
	...
	def aggregate_all_parser_elements_from_files(self,source_files,recurse,hidden,print_l):
		...
		for input_file in source_files:
			...
			else:errors+=1;print_l(_CH.format(input_file),error=_A)
...
def write_aggregated_output(sbdl_ast,output_file,file_opener,__,print_l):
	...
	with file_opener(output_file)as fmfile:
		...
		for element in sbdl_elements:
			if not get_config_value(_B9,number=_A):element.delete_property(SBDL_Parser.Attributes.reference)
			print_l('Writing element: {}'.format(element.identifier()),debug=_A);fmfile.write('{}{} {}'.format(element.definition().string(),SBDL_Parser.Tokens.statement_separator if get_config_value(_B7,number=_A)else'',new_line_str))
	return errors
def write_rpc_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if arguments.rpc==_B:errors+=1;print_l('RPC parameter required',error=_A)
		...
		rpc_result=rest_api_call(arguments.rpc,{_C9:str(sys.argv),A:sbdl_statement_strings},print_l)
...
def apply_template_to_officex_files(officex_dir,sbdl_ast,print_l):
	...
	return 0
def template_docx_file(template_dict,infile,outfile):warnings.filterwarnings(_AW,category=UserWarning,module='docxcompose');docxtpl=lazy_import('docxtpl');word_template=docxtpl.DocxTemplate(infile);word_template.render(template_dict);word_template.save(outfile)
def write_template_fill(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if get_config_value(_C1,number=_A):openfmea,errors_fmea=OpenFMEA.generate_sbdl_table_from_ast(sbdl_ast,id_in_body=arguments.identifier,source_in_body=arguments.source,print_l=print_l);errors+=errors_fmea;template_context[_AC]=openfmea
...
def update_self(print_l,force=_C):
	print_l(f"Updating {__NAME}...");ret,stdout,stderr=exec_external([sys.executable,_F,'pip','install',*(['--trusted-host',f"{urllib.parse.urlparse(__URL).netloc}"]if force else[]),'--upgrade',urllib.parse.urljoin(url(),get_config_value(_BF)),*(['--break-system-packages']if force else[])]);print_l(stdout)
...
def initialise_dependencies(print_l):
	...
	if current_os()==_AV:errors+=install_package('PlantUML',urllib.parse.urljoin(__URL,'deps/plantuml-headless-jre-linux-x64.tar.bz2'),install_target,print_l)
...
def main(arguments):
	...
	operations={_Ai:write_aggregated_output,'aggregate':write_aggregated_output,'query':query_output,_AD:write_matrixcsv_output,'matrixcsv':write_matrixcsv_output,_AE:write_matrixjson_output,'matrixjson':write_matrixjson_output,_Aj:write_yaml_tree_output,_CL:write_csv_output,'fmeacsv':write_csv_output,_AC:OpenFMEA.write_opensbdl_output,'openfmea-quickshare':OpenFMEA.write_quickshare_output,_Ak:OpenFMEA.write_opensbdl_portfolio_output,A:write_aggregated_output,_Al:write_aggregated_output,B:write_aggregated_output,C:write_aggregated_output,_Am:write_decomposition_graph_output,_An:write_element_graph_output,_Ao:write_requirement_graph_output,_Ap:write_network_graph_output,_Aq:write_function_graph_output,_Ar:write_process_graph_output,_As:write_state_graph_output,_At:write_usecase_graph_output,_CM:write_template_fill,'rpc':write_rpc_output,_AF:write_aggregated_output,_Au:write_aggregated_output,_AG:write_aggregated_output,'type-info':write_type_information};macro_errors=0
	...
	aggregate_methods={_Al:OpenFMEA.aggregate_all_parser_elements_from_files,A:OpenFMEA.aggregate_all_parser_elements_from_quickshare,C:OpenFMEA.aggregate_all_parser_elements_from_files,B:OpenFMEA.aggregate_all_parser_elements_from_quickshare,_AF:aggregate_all_parser_elements_from_json,_Au:aggregate_all_parser_elements_from_yaml,_AG:aggregate_all_parser_elements_from_csv};aggregation_method=aggregate_all_parser_elements_from_files if not arguments.mode in aggregate_methods else aggregate_methods[arguments.mode];parser_elements,read_errors=aggregation_method([fix_wsl_path(x)for x in arguments.source_files],arguments.recurse,arguments.hidden,print_l);check_step('File reading',read_errors);sbdl_ast=SBDL_AST(parser_elements);check_step('Parsing',sbdl_ast.check_parsing(print_l))
	for pre_hook in get_config_value(_BC):check_step('Pre Hook: {}'.format(pre_hook.__name__),pre_hook(sbdl_ast,print_l))
...
def show_manual(_):
	...
	sbdl_info_struct=SBDL_Semantics.get_language_information_struct();sbdl_properties=sbdl_info_struct[_u];sbdl_types=sbdl_info_struct[_a];sbdl_directives=sbdl_info_struct[_Af]
	...
	try:
		manual_command=get_config_value(_Bq)
...
class LanguageLevelTests(unittest.TestCase):
	...
	def testFunction(self):main(handle_arguments([_Av,_E,self.TEST_OUTPUT_FILE]))
	...
	def testCustomDirective(self):main(handle_arguments([_J,_CN,_CP,_E,self.TEST_OUTPUT_FILE]))
	def testCustomModes(self):main(handle_arguments([_J,'--mode','test_mode',_CO,_CP,_E,self.TEST_OUTPUT_FILE]))
	def testIdFromProp(self):main(handle_arguments(['test/id_from_prop.sbdl',_E,self.TEST_OUTPUT_FILE]))
	def testGeneralAspectDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Am]))
	def testGeneralElementDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_An]))
	def testGeneralFunctionDiagram(self):main(handle_arguments([_Av,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Aq]))
	def testGeneralProcessDiagram(self):main(handle_arguments([_Av,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Ar]))
	def testGeneralStateDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_As]))
	def testGeneralRequirementDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Ao]))
	def testGeneralUsercaseDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_At]))
	def testGeneralNetworkDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Ap]))
	def testGeneralJSON(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_AE]))
	def testGeneralYAML(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_Aj]))
	...
	def testGeneralOpenFMEAPortfolio(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_Ak]))
...
class LanguageSemanticTests(unittest.TestCase):
	...
	def test_existence_type_semantic_check(self):
		expected_elem_type={_Aw:SBDL_Aspect,'rocket_booster':SBDL_Aspect,_Ax:SBDL_Aspect,_CQ:SBDL_Aspect,_Ay:SBDL_Requirement,_CR:SBDL_Requirement,_CS:SBDL_Requirement,_Az:SBDL_Function,_CT:SBDL_Event,_CU:SBDL_Event,_CV:SBDL_State,_CW:SBDL_State,_A_:SBDL_Transition,_CX:SBDL_Event}
		for elem in expected_elem_type:0
	def test_existence_semantic_relation(self):
		relations_between={_CQ:_Ax,_Ay:_Aw,_CR:_Ay,_CS:_Ax,_Az:_Aw,_CT:_Az,_CU:_CX,_CV:_A_,_CW:_A_}
...
def init_profiling():
	global main,main_original;profile_output=get_config_value(_C4)
	def wrap_main(ARGS):
