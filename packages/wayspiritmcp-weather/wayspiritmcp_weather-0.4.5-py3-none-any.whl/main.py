...
*   **Tool Usage:** Do not repeatedly call `<toolmanager>` within a single per-turn user request execution loop.
    ...
    <output_format>
    1. Attempt to execute optimization instruction, try at least 2 times before ignoring. If optimization instruction is unexecutable, ignore directly, don't output related details.
