...
def build_buckets(
    ...
    buckets = defaultdict(lambda: (array("q"), array(typecode), array(typecode)))
...
def build_all_buckets(
    ...
    # Initialize buckets
    buckets = defaultdict(
        lambda: (array("q"), array(typecode), array(typecode), array("b"))
    )
...
def build_possible_buckets(
    ...
    # Initialize buckets
    buckets = defaultdict(lambda: (array("q"), array(typecode)))
