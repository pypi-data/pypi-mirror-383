...
from schemachat.core import OpenAIConfig, OllamaConfig, ProviderType
...
class TestIntegration:
    ...
    @patch('schemachat.providers.ollama.ollama.Client')
    ...
    @patch('schemachat.providers.ollama.ollama.Client')
    @patch('schemachat.providers.ollama.ensure_json_format')
