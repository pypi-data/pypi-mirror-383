...
from zhinst.comms_schemas.labone.core import errors
...
@pytest.mark.asyncio
async def test_streaming_error_raise():
    streaming_handle = StreamingHandle()
    queue = DataQueue(
        path="dummy",
        handle=streaming_handle,
...
@pytest.mark.asyncio
async def test_streaming_error_with_value():
    streaming_handle = StreamingHandle()
    queue = DataQueue(
        path="dummy",
        handle=streaming_handle,
