...
DOCS_STARTER = VibeLlamaStarter(
    ...
    services=["llama-index-workflows", "LlamaIndex"],
    use_all_agents=True,  # Use internal agents too
)
...
async def load_context_files(
    ...
    Returns:
        Content of the documentation about LlamaIndex Workflows and LlamaIndex
    """
