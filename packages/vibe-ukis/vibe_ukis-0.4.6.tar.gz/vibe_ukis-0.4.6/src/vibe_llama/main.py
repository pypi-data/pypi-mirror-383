        ...
        if not args.mcp:
            ...
            if t:
                ...
                if start_docuflows.strip().lower() == "yes":
                    ...
                    console.print("\nOk, happy vibe-coding!👋", style="bold yellow")
        else:
