...
from vibe_llama.starter.data import LibraryName, all_agent_rules, services as service_to_url
...
class VibeLlamaStarter:
    """
    VibeLlamaStarter allows you to write instructions for coding agents related to LlamaIndex, llama-index-workflows and Chainlit.
    ...
    def __init__(
        ...
        Args:
            ...
            use_all_agents (bool): Whether to include internal agents. Defaults to False.
        """
        self.agent_files = [all_agent_rules[agent] for agent in agents]
    ...
    async def write_instructions(
        ...
        print_verbose(
            "All the files have been successfully written, happy vibe-coding!", verbose
        )
        return None
