...
class InputFile(BaseModel):
	'''
    CUSTOM CLASS TO UPLOAD LOCAL FILES WITH MULTIPART.
...
MaybeInaccessibleMessageAdapter = TypeAdapter[MaybeInaccessibleMessage](MaybeInaccessibleMessage) 
...
MessageOriginAdapter = TypeAdapter[MessageOrigin](MessageOrigin) 
...
PaidMediaAdapter = TypeAdapter[PaidMedia](PaidMedia) 
...
BackgroundFillAdapter = TypeAdapter[BackgroundFill](BackgroundFill) 
...
BackgroundTypeAdapter = TypeAdapter[BackgroundType](BackgroundType) 
...
ChatMemberAdapter = TypeAdapter[ChatMember](ChatMember) 
...
StoryAreaTypeAdapter = TypeAdapter[StoryAreaType](StoryAreaType) 
...
ReactionTypeAdapter = TypeAdapter[ReactionType](ReactionType) 

OwnedGift = Union[
	OwnedGiftRegular,
	OwnedGiftUnique,
]
OwnedGiftAdapter = TypeAdapter[OwnedGift](OwnedGift) 
...
BotCommandScopeAdapter = TypeAdapter[BotCommandScope](BotCommandScope) 
...
MenuButtonAdapter = TypeAdapter[MenuButton](MenuButton) 
...
ChatBoostSourceAdapter = TypeAdapter[ChatBoostSource](ChatBoostSource) 
...
InputMediaAdapter = TypeAdapter[InputMedia](InputMedia) 

InputPaidMedia = Union[
	InputPaidMediaPhoto,
	InputPaidMediaVideo,
]
InputPaidMediaAdapter = TypeAdapter[InputPaidMedia](InputPaidMedia) 

InputProfilePhoto = Union[
	InputProfilePhotoStatic,
	InputProfilePhotoAnimated,
]
InputProfilePhotoAdapter = TypeAdapter[InputProfilePhoto](InputProfilePhoto) 

InputStoryContent = Union[
	InputStoryContentPhoto,
	InputStoryContentVideo,
]
InputStoryContentAdapter = TypeAdapter[InputStoryContent](InputStoryContent) 
...
InlineQueryResultAdapter = TypeAdapter[InlineQueryResult](InlineQueryResult) 
...
InputMessageContentAdapter = TypeAdapter[InputMessageContent](InputMessageContent) 
...
RevenueWithdrawalStateAdapter = TypeAdapter[RevenueWithdrawalState](RevenueWithdrawalState) 
...
TransactionPartnerAdapter = TypeAdapter[TransactionPartner](TransactionPartner) 
...
PassportElementErrorAdapter = TypeAdapter[PassportElementError](PassportElementError) 
...
InaccessibleMessage.model_rebuild()
