...
if __name__ == "__main__":
    download_dir = "/home/test1/work/data7/Lb2_mode1_6912k"
    upload_dir = "/home/test1/work/upload7/ResLb2_mode1_6912k_demos/ResLb2_mode1_6912k/node2_60"
    nExc = 3456*1024
    nInh = 3456*1024
    nStep = 10
    nRow = 6
    ...
    # bpuset = lb2_SNN(net, inpS, inpI, mode=1,config={"nRow":nRow,"nCol":nCol,'Is_Y_First':Y_first})
    ...
    # deploy.run_from_host(step=nStep,sender_path=sender_path,device_id=35)
    # # deploy.run_from_driver(step=nStep,device_id=16,dmos=False)

    #Compare results or convert bin to npy
    check = lb2_checkRes(download_dir, upload_dir, nStep,dmos=True)
    check.bin2npy()
    check.npyVSnpy()  