...
if __name__ == "__main__":
    ...
    upload_dir = f"../upload7/ResLb2_b2s1_int8_{nTile}"
    nExc = 64*1024*nTile
    nInh = 64*1024*nTile
    fanout = 6
    nStep = 15
    ...
    inpI = 2.                                           
    bpuset = lb2_SNN(net,inpI=2.,config = {"Base":2,"Dtype":"int8"})
    net.dump(download_dir,nStep,inpI=inpI,save=True,jit=False)     
