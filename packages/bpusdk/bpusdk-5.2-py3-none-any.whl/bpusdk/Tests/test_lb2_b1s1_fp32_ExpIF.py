...
from bpusdk.Models.EImodel_ExpIF import EINet
...
if __name__ == "__main__":
    download_dir = "../data8/Lb2_ExpIF_64k"
    upload_dir = "../upload8/ResLb2_ExpIF_64k"
    nExc = 1*256
    nInh = 1*256
    nStep = 20
    ...
    # deploy.run_from_driver(nStep=nStep,device_id=8,dmos=False,save_ncu=1) #
