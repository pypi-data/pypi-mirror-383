...
if __name__ == "__main__":
    download_dir = "../data7/Lb2_mode1_192k"
    ...
    inpI = 100.                                       
    bpuset = lb2_SNN(net, inpI=inpI, mode=1,config={"nRow":nRow,"nCol":nCol,'Is_Y_First':Y_first})
    ...
    deploy.run_from_host(nStep=nStep,sender_path=sender_path,device_id=2,run=True)
