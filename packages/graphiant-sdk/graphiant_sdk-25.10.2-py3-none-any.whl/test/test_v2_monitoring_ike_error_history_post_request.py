...
class TestV2MonitoringIkeErrorHistoryPostRequest(unittest.TestCase):
    """V2MonitoringIkeErrorHistoryPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2MonitoringIkeErrorHistoryPostRequest:
        """Test V2MonitoringIkeErrorHistoryPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2MonitoringIkeErrorHistoryPostRequest`
        """
        model = V2MonitoringIkeErrorHistoryPostRequest()
        if include_optional:
            return V2MonitoringIkeErrorHistoryPostRequest(
    ...
    def testV2MonitoringIkeErrorHistoryPostRequest(self):
        """Test V2MonitoringIkeErrorHistoryPostRequest"""
