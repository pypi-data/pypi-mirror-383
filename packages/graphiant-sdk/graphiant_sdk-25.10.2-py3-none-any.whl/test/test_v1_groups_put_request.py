...
class TestV1GroupsPutRequest(unittest.TestCase):
    """V1GroupsPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsPutRequest:
        """Test V1GroupsPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsPutRequest`
        """
        model = V1GroupsPutRequest()
        if include_optional:
            return V1GroupsPutRequest(
                description = 'example string',
                group_id = 'example string',
                group_type = 'ENUM_VALUE',
                manages_enterprises = True,
                name = 'example string',
    ...
    def testV1GroupsPutRequest(self):
        """Test V1GroupsPutRequest"""
