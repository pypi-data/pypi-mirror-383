...
class TestV2AssistantGetConversationDetailsPostRequest(unittest.TestCase):
    """V2AssistantGetConversationDetailsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssistantGetConversationDetailsPostRequest:
        """Test V2AssistantGetConversationDetailsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssistantGetConversationDetailsPostRequest`
        """
        model = V2AssistantGetConversationDetailsPostRequest()
        if include_optional:
            return V2AssistantGetConversationDetailsPostRequest(
    ...
    def testV2AssistantGetConversationDetailsPostRequest(self):
        """Test V2AssistantGetConversationDetailsPostRequest"""
