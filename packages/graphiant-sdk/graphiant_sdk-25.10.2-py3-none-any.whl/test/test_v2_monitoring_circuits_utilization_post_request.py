...
class TestV2MonitoringCircuitsUtilizationPostRequest(unittest.TestCase):
    """V2MonitoringCircuitsUtilizationPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2MonitoringCircuitsUtilizationPostRequest:
        """Test V2MonitoringCircuitsUtilizationPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2MonitoringCircuitsUtilizationPostRequest`
        """
        model = V2MonitoringCircuitsUtilizationPostRequest()
        if include_optional:
            return V2MonitoringCircuitsUtilizationPostRequest(
    ...
    def testV2MonitoringCircuitsUtilizationPostRequest(self):
        """Test V2MonitoringCircuitsUtilizationPostRequest"""
