...
class TestV1GatewaysPutRequest(unittest.TestCase):
    """V1GatewaysPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GatewaysPutRequest:
        """Test V1GatewaysPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GatewaysPutRequest`
        """
        model = V1GatewaysPutRequest()
        if include_optional:
            return V1GatewaysPutRequest(
                details = graphiant_sdk.models._v1_gateways_put_request_details._v1_gateways_put_request_details(
    ...
    def testV1GatewaysPutRequest(self):
        """Test V1GatewaysPutRequest"""
