...
class TestV1AppsBandwidthPostRequest(unittest.TestCase):
    """V1AppsBandwidthPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1AppsBandwidthPostRequest:
        """Test V1AppsBandwidthPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1AppsBandwidthPostRequest`
        """
        model = V1AppsBandwidthPostRequest()
        if include_optional:
            return V1AppsBandwidthPostRequest(
                app_id = 123,
    ...
    def testV1AppsBandwidthPostRequest(self):
        """Test V1AppsBandwidthPostRequest"""
