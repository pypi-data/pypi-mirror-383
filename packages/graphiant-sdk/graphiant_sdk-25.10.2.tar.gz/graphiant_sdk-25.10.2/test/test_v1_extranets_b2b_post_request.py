...
class TestV1ExtranetsB2bPostRequest(unittest.TestCase):
    """V1ExtranetsB2bPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsB2bPostRequest:
        """Test V1ExtranetsB2bPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsB2bPostRequest`
        """
        model = V1ExtranetsB2bPostRequest()
        if include_optional:
            return V1ExtranetsB2bPostRequest(
    ...
    def testV1ExtranetsB2bPostRequest(self):
        """Test V1ExtranetsB2bPostRequest"""
