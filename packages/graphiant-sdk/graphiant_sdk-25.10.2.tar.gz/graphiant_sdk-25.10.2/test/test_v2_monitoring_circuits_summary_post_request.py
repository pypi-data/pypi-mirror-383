...
class TestV2MonitoringCircuitsSummaryPostRequest(unittest.TestCase):
    """V2MonitoringCircuitsSummaryPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2MonitoringCircuitsSummaryPostRequest:
        """Test V2MonitoringCircuitsSummaryPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2MonitoringCircuitsSummaryPostRequest`
        """
        model = V2MonitoringCircuitsSummaryPostRequest()
        if include_optional:
            return V2MonitoringCircuitsSummaryPostRequest(
    ...
    def testV2MonitoringCircuitsSummaryPostRequest(self):
        """Test V2MonitoringCircuitsSummaryPostRequest"""
