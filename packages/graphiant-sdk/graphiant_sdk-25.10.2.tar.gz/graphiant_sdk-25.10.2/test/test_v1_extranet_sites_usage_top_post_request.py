...
class TestV1ExtranetSitesUsageTopPostRequest(unittest.TestCase):
    """V1ExtranetSitesUsageTopPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetSitesUsageTopPostRequest:
        """Test V1ExtranetSitesUsageTopPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetSitesUsageTopPostRequest`
        """
    ...
    def testV1ExtranetSitesUsageTopPostRequest(self):
        """Test V1ExtranetSitesUsageTopPostRequest"""
