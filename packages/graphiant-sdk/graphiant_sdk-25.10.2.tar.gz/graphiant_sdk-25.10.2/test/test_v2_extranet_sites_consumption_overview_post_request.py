...
class TestV2ExtranetSitesConsumptionOverviewPostRequest(unittest.TestCase):
    """V2ExtranetSitesConsumptionOverviewPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ExtranetSitesConsumptionOverviewPostRequest:
        """Test V2ExtranetSitesConsumptionOverviewPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ExtranetSitesConsumptionOverviewPostRequest`
        """
        model = V2ExtranetSitesConsumptionOverviewPostRequest()
        if include_optional:
            return V2ExtranetSitesConsumptionOverviewPostRequest(
                id = 1234567891011,
                is_b2_b = True,
                is_provider = True,
    ...
    def testV2ExtranetSitesConsumptionOverviewPostRequest(self):
        """Test V2ExtranetSitesConsumptionOverviewPostRequest"""
