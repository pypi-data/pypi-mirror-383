    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdDraftPostRequest:
        ...
        if include_optional:
            return V1DevicesDeviceIdDraftPostRequest(
                ...
                draft = graphiant_sdk.models._v1_extranets_get_200_response_policies_inner_branches_excluded_devices_inner._v1_extranets_get_200_response_policies_inner_branches_excludedDevices_inner(
