...
class TestV2NotificationlistPostRequest(unittest.TestCase):
    """V2NotificationlistPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2NotificationlistPostRequest:
        """Test V2NotificationlistPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2NotificationlistPostRequest`
        """
        model = V2NotificationlistPostRequest()
        if include_optional:
            return V2NotificationlistPostRequest(
    ...
    def testV2NotificationlistPostRequest(self):
        """Test V2NotificationlistPostRequest"""
