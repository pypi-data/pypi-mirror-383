...
class TestV1GroupsIdPatchRequest(unittest.TestCase):
    """V1GroupsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsIdPatchRequest:
        """Test V1GroupsIdPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsIdPatchRequest`
        """
        model = V1GroupsIdPatchRequest()
        if include_optional:
            return V1GroupsIdPatchRequest(
    ...
    def testV1GroupsIdPatchRequest(self):
        """Test V1GroupsIdPatchRequest"""
