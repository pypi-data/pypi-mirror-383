...
class TestV1SitesSiteIdPostRequest(unittest.TestCase):
    """V1SitesSiteIdPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1SitesSiteIdPostRequest:
        """Test V1SitesSiteIdPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SitesSiteIdPostRequest`
        """
        model = V1SitesSiteIdPostRequest()
        if include_optional:
            return V1SitesSiteIdPostRequest(
    ...
    def testV1SitesSiteIdPostRequest(self):
        """Test V1SitesSiteIdPostRequest"""
