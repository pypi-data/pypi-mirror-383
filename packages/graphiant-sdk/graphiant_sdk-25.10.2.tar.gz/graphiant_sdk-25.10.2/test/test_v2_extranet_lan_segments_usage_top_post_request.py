...
class TestV2ExtranetLanSegmentsUsageTopPostRequest(unittest.TestCase):
    """V2ExtranetLanSegmentsUsageTopPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ExtranetLanSegmentsUsageTopPostRequest:
        """Test V2ExtranetLanSegmentsUsageTopPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ExtranetLanSegmentsUsageTopPostRequest`
        """
        model = V2ExtranetLanSegmentsUsageTopPostRequest()
        if include_optional:
            return V2ExtranetLanSegmentsUsageTopPostRequest(
                id = 1234567891011,
                is_b2_b = True,
                is_provider = True,
    ...
    def testV2ExtranetLanSegmentsUsageTopPostRequest(self):
        """Test V2ExtranetLanSegmentsUsageTopPostRequest"""
