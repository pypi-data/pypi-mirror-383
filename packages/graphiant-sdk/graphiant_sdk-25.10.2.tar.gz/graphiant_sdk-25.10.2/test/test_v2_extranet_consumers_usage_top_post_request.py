...
class TestV2ExtranetConsumersUsageTopPostRequest(unittest.TestCase):
    """V2ExtranetConsumersUsageTopPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2ExtranetConsumersUsageTopPostRequest:
        """Test V2ExtranetConsumersUsageTopPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2ExtranetConsumersUsageTopPostRequest`
        """
        model = V2ExtranetConsumersUsageTopPostRequest()
        if include_optional:
            return V2ExtranetConsumersUsageTopPostRequest(
                id = 1234567891011,
                is_b2_b = True,
    ...
    def testV2ExtranetConsumersUsageTopPostRequest(self):
        """Test V2ExtranetConsumersUsageTopPostRequest"""
