...
import pandas as pd
from .schemas.sick_classification import SickClassificationGet
    ...
    def get(self,
        ...
        Args:
            ...
            select_fields (Union[List[str], str], optional): Fields to select. If None, all available fields will be used.
                            Example (list): ["Id", "Name", "hr2d__Type__c"]
            related (Dict[str, List[str]], optional): Dictionary of related fields to select.
                            Example: {"Employer": ["Name"]} will include employer name.
