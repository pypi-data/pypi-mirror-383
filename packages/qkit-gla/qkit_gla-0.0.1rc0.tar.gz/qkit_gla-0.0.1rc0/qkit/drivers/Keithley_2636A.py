...
class Keithley_2636A(Instrument):
    ...
    def __init__(self, name, address, reset=False):
        ...
        self.add_parameter("statusA", flags=Instrument.FLAG_GETSET, type=bool)
        self.add_parameter("statusB", flags=Instrument.FLAG_GETSET, type=bool)
    ...
    def do_get_statusA(self):
        ...
        try:
            return int(
                float(self._visainstrument.ask("print(smua.source.output)").strip())
            )
        except:
