...
class RFPCB_V2(Instrument):
    ...
    def __init__(self, name, address, model="RFPCB"):
        ...
        self.add_parameter(
            ...
            type=float,
            tags=["Detail", "LO"],
            listen_to=[],  # Add frequency once implemented
            minval=9765625.0,
            maxval=15e9,
            units="Hz",
        )
        ...
        self.add_parameter(
            ...
            listen_to=[],  # Add frequency,iflo once implemented
            minval=3e8,
            maxval=6e9,
            units="Hz",
        )
    ...
    def do_set_frequency(self, frequency, offset=100e6, method="mixsweep"):
        ...
        self.v2_stub.Sweep(
            SuperV2.SweepInput(
                frequency=frequency, power=self._power, offset=offset, method=method
            )
        )
    ...
    def do_set_power(self, power=0):
        ...
        """
        self._power = power
        self.hfa_stub.SetAttenuation(
            HFA.Double(index=HFA.EndpointIndex(value=0), value=abs(power))
        )
    ...
    def do_get_iflo_frequency(self):
        return self.hfl_stub.GetFrequency(
            HFL.EndpointIndex(value=self.EPDict.index("IFLO"))
        ).value

    def do_set_iflo_frequency(self, value):
        self.hfl_stub.SetFrequency(
            HFL.WriteDouble(
                index=HFL.EndpointIndex(value=self.EPDict.index("IFLO")), value=value
            )
        )
    ...
    def do_get_rflo_frequency(self):
        return self.hfl_stub.GetFrequency(
            HFL.EndpointIndex(value=self.EPDict.index("RFLO"))
        ).value

    def do_set_rflo_frequency(self, value):
        self.hfl_stub.SetFrequency(
            HFL.WriteDouble(
                index=HFL.EndpointIndex(value=self.EPDict.index("RFLO")), value=value
            )
        )
    ...
    def do_get_txpl_frequency(self):
        return self.hfl_stub.GetFrequency(
            HFL.EndpointIndex(value=self.EPDict.index("TXPL"))
        ).value

    def do_set_txpl_frequency(self, value):
        self.hfl_stub.SetFrequency(
            HFL.WriteDouble(
                index=HFL.EndpointIndex(value=self.EPDict.index("TXPL")), value=value
            )
        )
    ...
    def do_get_rxpl_frequency(self):
        return self.hfl_stub.GetFrequency(
            HFL.EndpointIndex(value=self.EPDict.index("RXPL"))
        ).value

    def do_set_rxpl_frequency(self, value):
        self.hfl_stub.SetFrequency(
            HFL.WriteDouble(
                index=HFL.EndpointIndex(value=self.EPDict.index("RXPL")), value=value
            )
        )
    ...
    def do_set_demod_lo_match(self, value):
        self.hfd_stub.SetLoMatchMHz(
            HFD.WriteNum(index=HFD.EndpointIndex(value=0), value=value)
        )
    ...
    def do_set_demod_gain_error(self, value):
        self.hfd_stub.SetGainErrorCdB(
            HFD.WriteDouble(index=HFD.EndpointIndex(value=0), value=value)
        )
        self.hfd_stub.UpdateWrite(HFD.EndpointIndex(value=0))
    ...
    def do_set_demod_phase_error(self, value):
        self.hfd_stub.SetPhaseErrorDeg(
            HFD.WriteDouble(index=HFD.EndpointIndex(value=0), value=value)
        )
        self.hfd_stub.UpdateWrite(HFD.EndpointIndex(value=0))
    ...
    def on(self):
        ...
        self.v2_stub.Startup(
            SuperV2.StartInfo(
                lmx_list=[  # SuperV2.LMXStart(name="RXPL", power_a=0, power_b=0),
        ...
        self.v2_stub.UpdateWrite(
            SuperV2.EndpointList(devices=["TXPL", "RXPL", "IFLO", "RFLO"])
        )
    ...
    def set_rflo_enable_a(self, boolean):
        if boolean:
            self.hfl_stub.EnableOutputA(
                HFL.EndpointIndex(value=self.EPDict.index("RFLO"))
            )
        else:
            self.hfl_stub.DisableOutputA(
                HFL.EndpointIndex(value=self.EPDict.index("RFLO"))
            )
        self.hfl_stub.UpdateWrite(HFL.EndpointIndex(value=self.EPDict.index("RFLO")))
    ...
    def set_rflo_enable_b(self, boolean):
        if boolean:
            self.hfl_stub.EnableOutputB(
                HFL.EndpointIndex(value=self.EPDict.index("RFLO"))
            )
        else:
            self.hfl_stub.DisableOutputB(
                HFL.EndpointIndex(value=self.EPDict.index("RFLO"))
            )
        self.hfl_stub.UpdateWrite(HFL.EndpointIndex(value=self.EPDict.index("RFLO")))
    ...
    def reinitialise(self):
        self.v2_stub.Reset(
            SuperV2.EndpointList(devices=["TXPL", "RXPL", "IFLO", "RFLO", "Demod"])
        )
