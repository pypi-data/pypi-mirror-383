...
class Spectrum_M4i2211(Instrument):
    ...
    def _load_dll(self):
        ...
        if pf_64Bit:
            ...
            self._spcm_win32 = windll.LoadLibrary(
                "C:\\WINDOWS\\System32\\spcm_win64.dll"
            )
            ...
            self._spcm_win32.DefTransfer64m = self._spcm_win32[
                "spcm_dwDefTransfer_i64m"
            ]
            ...
            self._spcm_win32.DefTransfer64m = self._spcm_win32[
                "_spcm_dwDefTransfer_i64m@36"
            ]
            self._spcm_win32.DefTransfer64 = self._spcm_win32[
                "_spcm_dwDefTransfer_i64@36"
            ]
            self._spcm_win32.InValidateBuf = self._spcm_win32["_spcm_dwInvalidateBuf@8"]
            self._spcm_win32.GetErrorInfo = self._spcm_win32[
                "_spcm_dwGetErrorInfo_i32@16"
            ]
        ...
        self._spcm_win32.DefTransfer64.argtype = [
            drv_handle,
            c_uint32,
            c_uint32,
            c_uint32,
        ...
        self._spcm_win32.GetErrorInfo.argtype = [
            drv_handle,
            POINTER(c_uint32),
            POINTER(c_int32),
            c_char_p,
    ...
    def _open(self):
        ...
        if not self._card_is_open:
            self._spcm_win32.handel = self._spcm_win32.open(
                create_string_buffer(b"spcm0")
            )
    ...
    def _set_param(self, regnum, regval):
        ...
        if err == 0:
            ...
            logging.error(
                __name__
                + f" : Error {err} while setting reg {regnum} to {regval}"
            )
            self._get_error()
    ...
    def invalidate_buffer(self, buffertype=_spcm_regs.SPCM_BUF_DATA):
        ...
        err = self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_M2CMD, _spcm_regs.M2CMD_DATA_STOPDMA
        )
        if err != 0:
            logging.error(
                __name__
    ...
    def _get_error(self):
        ...
        self._spcm_win32.GetErrorInfo(
            self._spcm_win32.handel, p_er1, p_er2, p_errortekst
        )
    ...
    def init_channel0_single_mode(
        self, memsize=2048, posttrigger=1024, amp=500, offs=0
    ):
        """
        ...
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
            _spcm_regs.SPC_TRIG_EXT0_MODE,
            _spcm_regs.SPC_TM_POS,
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_EXT0_PULSEWIDTH, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_OUTPUT, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_TERM, 1
        )

        # Set channel information
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_CHENABLE, _spcm_regs.CHANNEL0
        )
        # self._spcm_win32.SetParam32(self._spcm_win32.handel, _spcm_regs.SPC_CARDMODE, _spcm_regs.SPC_REC_STD_SINGLE)
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
            _spcm_regs.SPC_CARDMODE,
            _spcm_regs.SPC_REC_FIFO_SINGLE,
        )
        # self._spcm_win32.SetParam32(self._spcm_win32.handel, _spcm_regs.SPC_LOOPS, 1)
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_MEMSIZE, memsize
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_POSTTRIGGER, posttrigger
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32_handel, _spcm_regs.SPC_PATH0, 0
        )  # zofo
        ...
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
            _spcm_regs.SPC_TRIG_ORMASK,
            _spcm_regs.SPC_TMASK_EXT0,
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_ANDMASK, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_CH_ORMASK0, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_CH_ORMASK1, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_CH_ANDMASK0, 0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_TRIG_CH_ANDMASK1, 0
        )
    ...
    def init_channel0_multiple_recording(
        self, nums=1024, segsize=128, posttrigger=1024, amp=500, offs=0
    ):
        """
        ...
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
            _spcm_regs.SPC_CARDMODE,
            _spcm_regs.SPC_REC_FIFO_MULTI,
        )
        # self._spcm_win32.SetParam32(self._spcm_win32.handel, _spcm_regs.SPC_LOOPS, 1)
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_SEGMENTSIZE, segsize
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_MEMSIZE, memsize
        )
    ...
    def init_channel01_multiple_recording(
        self,
        rate=100e6,
        nums=1024,
        segsize=128,
        ...
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
            _spcm_regs.SPC_CHENABLE,
            _spcm_regs.CHANNEL0 | _spcm_regs.CHANNEL1,
        )
        # self._spcm_win32.SetParam32(self._spcm_win32.handel, _spcm_regs.SPC_CARDMODE, _spcm_regs.SPC_REC_STD_MULTI)
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel,
        ...
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_OFFS0, offs0
        )
        self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_OFFS1, offs1
        )
    ...
    def start_with_trigger(self):
        ...
        self._buffer_setup()
        self._set_param(
            _spcm_regs.SPC_M2CMD,
            _spcm_regs.M2CMD_CARD_START
            | _spcm_regs.M2CMD_CARD_ENABLETRIGGER
    ...
    def start_with_trigger_and_waitready(self):
        ...
        self._set_param(
            ...
            _spcm_regs.M2CMD_CARD_START
            | _spcm_regs.M2CMD_CARD_ENABLETRIGGER
            | _spcm_regs.M2CMD_CARD_WAITREADY
            | _spcm_regs.M2CMD_DATA_WAITDMA,
        )
    ...
    def waitready(self):
        ...
        err = self._set_param(
            _spcm_regs.SPC_M2CMD,
            _spcm_regs.M2CMD_CARD_WAITREADY | _spcm_regs.M2CMD_DATA_WAITDMA,
        )
        return err
    ...
    def select_channel01(self):
        ...
        self._set_param(
            _spcm_regs.SPC_CHENABLE, _spcm_regs.CHANNEL0 | _spcm_regs.CHANNEL1
        )
        self._numchannels = 2
    ...
    def set_trigger_ext0_AND_ext1(self):
        ...
        self._set_param(
            _spcm_regs.SPC_TRIG_ANDMASK,
            _spcm_regs.SPC_TMASK_EXT0 | _spcm_regs.SPC_TMASK_EXT1,
        )
        self._set_param(
            _spcm_regs.SPC_TRIG_ORMASK,
            _spcm_regs.SPC_TMASK_EXT0 | _spcm_regs.SPC_TMASK_EXT1,
    ...
    def _buffer_setup(self):
        ...
        err = self._spcm_win32.DefTransfer64(
            self._spcm_win32.handel,
            _spcm_regs.SPCM_BUF_DATA,
            1,
            0,
            p_data,
            c_int64(0),
        ...
        if err != 0:
            logging.error(
                __name__ + " : Error starting DMA transfer, error nr: %i" % err
            )
            self._get_error()
            raise ValueError("Error communicating with device")
    ...
    def readout_raw_buffer(self, nr_of_channels=1):
        ...
        err = self._spcm_win32.SetParam32(
            self._spcm_win32.handel, _spcm_regs.SPC_M2CMD, _spcm_regs.M2CMD_DATA_WAITDMA
        )  # | _spcm_regs.M2CMD_CARD_WAITREADY)
        if err != 0:
    ...
    def do_set_post_trigger(self, posttrigger):
        ...
        if posttrigger < 32:
            logging.warning(
                __name__ + " : post trigger has to be at least 32. I fix this."
            )
            posttrigger = 32
