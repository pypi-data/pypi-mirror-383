...
class Ui_Form:
    ...
    def setupVector(self, Form):
        ...
        sizePolicy.setHeightForWidth(
            self.PlotTypeSelector.sizePolicy().hasHeightForWidth()
        )
        ...
        spacerItem = QtGui.QSpacerItem(
            40, 1, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum
        )
    ...
    def setupView(self, Form):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        self._addTraceSelectorIndicator(
            Form,
            sizePolicy,
            TraceSelector="VTraceXSelector",
            TraceIndicator="VTraceXValue",
            prefix=self.selector_labels[3] + ": ",
        )
        self._addTraceSelectorIndicator(
            Form,
            sizePolicy,
            TraceSelector="VTraceYSelector",
            TraceIndicator="VTraceYValue",
            prefix=self.selector_labels[4] + ": ",
        )
    ...
    def setupMatrix(self, Form):
        ...
        self._addTraceSelectorIndicator(
            Form,
            sizePolicy,
            TraceSelector="TraceXSelector",
            TraceIndicator="TraceXValue",
            prefix=self.selector_labels[0] + ": ",
        )
        self._addTraceSelectorIndicator(
            Form,
            sizePolicy,
            TraceSelector="TraceYSelector",
            TraceIndicator="TraceYValue",
            prefix=self.selector_labels[1] + ": ",
        )
        ...
        self.horizontalLayout.addItem(spacerItem)
        self._addIndicatorLabels(
            Form, sizePolicy, indicators=["PointX", "PointY", "PointZ"]
        )
    ...
    def setupBox(self, Form):
        ...
        self._addTraceSelectorIndicator(
            Form,
            sizePolicy,
            TraceSelector="TraceZSelector",
            TraceIndicator="TraceZValue",
            prefix=self.selector_labels[2] + ": ",
        )
    ...
    def _addTraceSelectorIndicator(
        self, Form, sizePolicy, TraceSelector="", TraceIndicator="", prefix="Trace: "
    ):
