...
class Data:
    ...
    def __repr__(self):
        ret = f"HDF5Data '{self._name}', filename '{self._filename}'"
        return ret
    ...
    def add_value_vector(
        self, name, x=None, unit="", comment="", folder="data", **meta
    ):
        ds = hdf_dataset(
            self.hf,
            name,
    ...
    def add_value_matrix(
        self, name, x=None, y=None, unit="", comment="", folder="data", **meta
    ):
        ds = hdf_dataset(
            self.hf,
            name,
    ...
    def add_value_box(
        self, name, x=None, y=None, z=None, unit="", comment="", folder="data", **meta
    ):
        ds = hdf_dataset(
            self.hf,
            name,
