...
class HP_3245A(Instrument):
    ...
    def __init__(self, name, address, reset=False):
        ...
        self.add_parameter(
            "current", type=float, units="A", flags=Instrument.FLAG_GETSET
        )
        self.add_parameter(
            "voltage", type=float, units="V", flags=Instrument.FLAG_GETSET
        )
    ...
    def reset(self, ch="CHANA"):
        ...
        if ch in ["CHANA"]:
            ...
            logging.error(
                "Unclear which channel to clear! Use CHANA for channel A, and CHANB for channel B."
            )
    ...
    def set_channel(self, ch):
        ...
        if ch in ["CHANA", "CHANB", "0", "100"]:
            ...
            logging.error(
                "Unclear which channel to set! Use CHANA for channel A, and CHANB for channel B."
            )
    ...
    def set_impedance(self, impedance):
        ...
        if self._output_type == "DCV":
            ...
            print(
                "The output mode is not DCV. The output impedance is 0 Ohm and can not be changed!"
            )
