...
from intuned_browser.helpers.click_untill_exhausted import click_button_and_wait
from intuned_browser.helpers.click_untill_exhausted import click_untill_exhausted
...
@pytest.mark.asyncio
async def test_click_untill_exhausted_default_params():
    ...
    async with launch_chromium(headless=False) as (_, page):
        ...
        button_locator = page.locator("#load-more")
        await click_untill_exhausted(page, button_locator)
...
@pytest.mark.asyncio
async def test_click_untill_exhausted_with_max_clicks():
    ...
    async with launch_chromium(headless=False) as (_, page):
        ...
        button_locator = page.locator("#load-more")
        await click_untill_exhausted(page, button_locator, max_clicks=3, click_delay=0.05)
...
@pytest.mark.asyncio
async def test_click_untill_exhausted_with_heartbeat():
    ...
    async with launch_chromium(headless=False) as (_, page):
        ...
        button_locator = page.locator("#load-more")
        await click_untill_exhausted(page, button_locator, heartbeat=on_heartbeat, max_clicks=5, click_delay=0.05)
