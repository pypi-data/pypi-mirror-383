// Generated from /home/hashfastr/git/hash-query-language/HqlCompiler/grammar/HqlTokens.g4 by ANTLR 4.13.1
...
public class HqlTokens extends Lexer {
	...
	public static final int
		...
		FLAGS=93, FORK=94, FROM=95, GETSCHEMA=96, GLOBAL=97, GRANNYASC=98, GRANNYDESC=99, 
		GRAPHMARKCOMPONENTS=100, GRAPHMATCH=101, GRAPHMERGE=102, GRAPHSHORTESTPATHS=103, 
		GRAPHTOTABLE=104, HAS=105, HAS_ALL=106, HAS_ANY=107, HAS_CS=108, HASPREFIX=109, 
		HASPREFIX_CS=110, HASSUFFIX=111, HASSUFFIX_CS=112, HIDDEN_=113, HINT_CONCURRENCY=114, 
		HINT_DISTRIBUTION=115, HINT_MATERIALIZED=116, HINT_NUM_PARTITIONS=117, 
		HINT_PASS_FILTERS=118, HINT_PASS_FILTERS_COLUMN=119, HINT_PROGRESSIVE_TOP=120, 
		HINT_REMOTE=121, HINT_SUFFLEKEY=122, HINT_SPREAD=123, HINT_STRATEGY=124, 
		HOT=125, HOTCACHE=126, HOTDATA=127, HOTINDEX=128, ID=129, ID__=130, IN=131, 
		IN_CI=132, INTO=133, INVOKE=134, ISFUZZY=135, ISFUZZY__=136, JOIN=137, 
		KIND=138, LADDERCHART=139, LAST=140, LEGEND=141, LET=142, LIKE=143, LIKECS=144, 
		LIMIT=145, LINEAR=146, LINECHART=147, LIST=148, LOOKUP=149, LOG=150, MACROEXPAND=151, 
		MAKEGRAPH=152, MAKESERIES=153, MAP=154, MATCHES_REGEX=155, MATERIALIZE=156, 
		MATERIALIZED_VIEW_COMBINE=157, MV_APPLY=158, MV_EXPAND=159, MVAPPLY=160, 
		MVEXPAND=161, NODES=162, NONE=163, NOOPTIMIZATION=164, NOT_BETWEEN=165, 
		NOT_CONTAINS=166, NOT_CONTAINS_CS=167, NOT_ENDSWITH_CS=168, NOT_ENDSWITH=169, 
		NOT_HAS=170, NOT_HAS_CS=171, NOT_HASPREFIX=172, NOT_HASPREFIX_CS=173, 
		NOT_HASSUFFIX=174, NOT_HASSUFFIX_CS=175, NOT_IN=176, NOT_IN_CI=177, NOT_STARTSWITH=178, 
		NOT_STARTSWITH_CS=179, NOTCONTAINS=180, NOTCONTAINSCS=181, NOTLIKE=182, 
		NOTLIKECS=183, NULL=184, NULLS=185, OF=186, ON=187, OPTIONAL=188, OR=189, 
		ORDER=190, OTHERS=191, OUTPUT=192, PACK=193, PANELS=194, PARSE=195, PARSEKV=196, 
		PARSEWHERE=197, PARTITION=198, PARTITIONBY=199, PARTITIONEDBY=200, PATTERN=201, 
		PACKEDCOLUMN__=202, PIECHART=203, PIVOTCHART=204, PLUGIN=205, PRINT=206, 
		PROJECT=207, PROJECTAWAY=208, PROJECTAWAY_=209, PROJECTKEEP=210, PROJECTRENAME=211, 
		PROJECTREORDER=212, PROJECTSMART=213, QUERYPARAMETERS=214, RANGE=215, 
		REDUCE=216, REGEX=217, RELAXED=218, RENDER=219, REPLACE=220, RESTRICT=221, 
		SAMPLE=222, SAMPLE_DISTINCT=223, SCAN=224, SCATTERCHART=225, SEARCH=226, 
		SERIALIZE=227, SERIES=228, SET=229, SIMPLE=230, SORT=231, SOURCECOLUMNINDEX__=232, 
		STACKED=233, STACKED100=234, STACKEDAREACHART=235, STARTSWITH=236, STARTSWITH_CS=237, 
		STEP=238, SUMMARIZE=239, TABLE=240, TAKE=241, THRESHOLD=242, TIMECHART=243, 
		TIMELINE=244, TIMEPIVOT=245, TITLE=246, TO=247, TOP=248, TOP_HITTERS=249, 
		TOP_NESTED=250, TOSCALAR=251, TOTABLE=252, TREEMAP=253, TYPEOF=254, UNION=255, 
		UNNEST=256, UNSTACKED=257, UUID=258, VIEW=259, VISIBLE=260, WHERE=261, 
		WITH=262, WITHNOSOURCE__=263, WITHSOURCE=264, WITH_ITEM_INDEX=265, WITH_MATCH_ID=266, 
		WITH_NODE_ID=267, WITH_SOURCE=268, WITH_STEP_NAME=269, XAXIS=270, XCOLUMN=271, 
		XMAX=272, XMIN=273, XTITLE=274, YAXIS=275, YCOLUMNS=276, YMAX=277, YMIN=278, 
		YSPLIT=279, YTITLE=280, BOOL=281, BOOLEAN=282, DATE=283, DATETIME=284, 
		DECIMAL=285, DOUBLE=286, DYNAMIC=287, FLOAT=288, GUID=289, INT=290, INT8=291, 
		INT16=292, INT32=293, INT64=294, LONG=295, STRING=296, REAL=297, TIME=298, 
		TIMESPAN=299, UINT=300, UINT8=301, UINT16=302, UINT32=303, UINT64=304, 
		ULONG=305, UNIQUEID=306, IP4=307, IP6=308, LONGLITERAL=309, INTLITERAL=310, 
		REALLITERAL=311, DECIMALLITERAL=312, STRINGLITERAL=313, BOOLEANLITERAL=314, 
		DATETIMELITERAL=315, TIMESPANLITERAL=316, TYPELITERAL=317, RAWGUIDLITERAL=318, 
		GUIDLITERAL=319, IDENTIFIER=320, WHITESPACE=321, COMMENT=322;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TREEMAP", "TYPEOF", "UNION", "UNNEST", "UNSTACKED", "UUID", "VIEW", 
			"VISIBLE", "WHERE", "WITH", "WITHNOSOURCE__", "WITHSOURCE", "WITH_ITEM_INDEX", 
			"WITH_MATCH_ID", "WITH_NODE_ID", "WITH_SOURCE", "WITH_STEP_NAME", "XAXIS", 
			"XCOLUMN", "XMAX", "XMIN", "XTITLE", "YAXIS", "YCOLUMNS", "YMAX", "YMIN", 
			"YSPLIT", "YTITLE", "BOOL", "BOOLEAN", "DATE", "DATETIME", "DECIMAL", 
			"DOUBLE", "DYNAMIC", "FLOAT", "GUID", "INT", "INT8", "INT16", "INT32", 
			"INT64", "LONG", "STRING", "REAL", "TIME", "TIMESPAN", "UINT", "UINT8", 
			"UINT16", "UINT32", "UINT64", "ULONG", "UNIQUEID", "IP4", "IP6", "LparenGooRparen", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'global'", "'granny-asc'", "'granny-desc'", "'graph-mark-components'", 
			"'graph-match'", "'graph-merge'", "'graph-shortest-paths'", "'graph-to-table'", 
			"'has'", "'has_all'", "'has_any'", "'has_cs'", "'hasprefix'", "'hasprefix_cs'", 
			...
			"'ytitle'", "'bool'", "'boolean'", "'date'", "'datetime'", "'decimal'", 
			"'double'", "'dynamic'", "'float'", "'guid'", "'int'", "'int8'", "'int16'", 
			"'int32'", "'int64'", "'long'", "'string'", "'real'", "'time'", "'timespan'", 
			"'uint'", "'uint8'", "'uint16'", "'uint32'", "'uint64'", "'ulong'", "'uniqueid'", 
			"'ip4'", "'ip6'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DOUBLE", "DYNAMIC", "FLOAT", "GUID", "INT", "INT8", "INT16", "INT32", 
			"INT64", "LONG", "STRING", "REAL", "TIME", "TIMESPAN", "UINT", "UINT8", 
			"UINT16", "UINT32", "UINT64", "ULONG", "UNIQUEID", "IP4", "IP6", "LONGLITERAL", 
			"INTLITERAL", "REALLITERAL", "DECIMALLITERAL", "STRINGLITERAL", "BOOLEANLITERAL", 
