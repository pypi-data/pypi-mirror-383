...
class AudioTrackVisualizer:
    def __init__(self, tracks: Iterable[AudioTrack]):
        ...
        self.fig_width_per_note = 256.
        self.fig_height_per_note = 4.

    def plot(self, save_as: Optional[Path] = None) -> None:
        n_tracks = len(self.tracks)
        figsize = (self.fig_width_per_note,
                   self.fig_height_per_note * n_tracks)
    ...
    def _plot_track(self, subplot: Subplot, track: AudioTrack):
        ...
        subplot.set_ylabel(track.name, fontsize=64, rotation=0, ha='right')
        subplot.set_xticks(xticks, xlabels, fontsize=32)
