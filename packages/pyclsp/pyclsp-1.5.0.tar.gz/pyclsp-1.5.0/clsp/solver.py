...
def CLSPSolveInstance(
    ...
    rcond : float or bool, default=False
        ...
        pseudoinverse, providing numerically stable inversion and ensuring
        ...
        the relative cutoff below which small singular values are treated as
        zero (passed to ``la.pinv``).
    ...
    *args, **kwargs : optional
    ...
    for n_iter in range(1, 1 +
        ...
        self.zhat      = (la.pinv(self.Z @ (self.A.T @ self.A) @ self.Z,
                          rcond=(None      if rcond == False else
