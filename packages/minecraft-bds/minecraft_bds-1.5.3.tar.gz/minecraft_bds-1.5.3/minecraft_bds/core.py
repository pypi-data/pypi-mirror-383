...
class MinecraftBDS:
    ...
    def __init__(self, base_path: Path | None = None):
        ...
        self.bds_path = self.server_path / ("bedrock_server.exe" if sys.platform.startswith("win") else "bedrock_server")
    ...
    async def _watch_logs(self):
        ...
        while True:
            try:
                line = await asyncio.wait_for(self.bds_process.stdout.readline(), timeout=0.1)
