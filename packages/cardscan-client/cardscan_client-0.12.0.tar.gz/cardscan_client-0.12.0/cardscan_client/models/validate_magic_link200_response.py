...
class ValidateMagicLink200Response(BaseModel):
    ...
    """
    token: StrictStr = Field(description="The token associated with the magic link", alias="Token")
    identity_id: StrictStr = Field(description="The identity ID.", alias="IdentityId")
    __properties: ClassVar[List[str]] = ["Token", "IdentityId"]
