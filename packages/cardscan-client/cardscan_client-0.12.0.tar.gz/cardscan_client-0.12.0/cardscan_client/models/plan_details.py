...
class PlanDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["plan_number", "group_name", "group_number", "plan_start_date", "plan_end_date", "plan_eligibility_start_date", "plan_eligibility_end_date", "plan_name", "plan_active"]
