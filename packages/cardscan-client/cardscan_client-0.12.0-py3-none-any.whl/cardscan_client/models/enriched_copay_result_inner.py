...
class EnrichedCopayResultInner(BaseModel):
    ...
    value: Union[StrictFloat, StrictInt] = Field(description="The copay/deductible amount as a number")
    score: StrictStr = Field(description="Confidence score for the extraction (0-1 as string)")
    __properties: ClassVar[List[str]] = ["service", "category", "value", "score"]
