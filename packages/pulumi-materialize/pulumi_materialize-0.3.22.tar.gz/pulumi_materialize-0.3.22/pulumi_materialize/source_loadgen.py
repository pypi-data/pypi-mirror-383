...
class SourceLoadgenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] load_generator_type: The load generator types: [AUCTION MARKETING COUNTER TPCH KEY VALUE].
...
class SourceLoadgen(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cluster_name: Optional[pulumi.Input[_builtins.str]] = None,
                 comment: Optional[pulumi.Input[_builtins.str]] = None,
                 counter_options: Optional[pulumi.Input[Union['SourceLoadgenCounterOptionsArgs', 'SourceLoadgenCounterOptionsArgsDict']]] = None,
                 database_name: Optional[pulumi.Input[_builtins.str]] = None,
                 expose_progress: Optional[pulumi.Input[Union['SourceLoadgenExposeProgressArgs', 'SourceLoadgenExposeProgressArgsDict']]] = None,
                 key_value_options: Optional[pulumi.Input[Union['SourceLoadgenKeyValueOptionsArgs', 'SourceLoadgenKeyValueOptionsArgsDict']]] = None,
                 load_generator_type: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] cluster_name: The cluster to maintain this source.
        :param pulumi.Input[_builtins.str] comment: Comment on an object in the database.
        :param pulumi.Input[Union['SourceLoadgenCounterOptionsArgs', 'SourceLoadgenCounterOptionsArgsDict']] counter_options: Counter Options.
        :param pulumi.Input[_builtins.str] database_name: The identifier for the source database in Materialize. Defaults to `MZ_DATABASE` environment variable if set or `materialize` if environment variable is not set.
        ...
        :param pulumi.Input[Union['SourceLoadgenKeyValueOptionsArgs', 'SourceLoadgenKeyValueOptionsArgsDict']] key_value_options: KEY VALUE Load Generator Options.
        :param pulumi.Input[_builtins.str] load_generator_type: The load generator types: [AUCTION MARKETING COUNTER TPCH KEY VALUE].
