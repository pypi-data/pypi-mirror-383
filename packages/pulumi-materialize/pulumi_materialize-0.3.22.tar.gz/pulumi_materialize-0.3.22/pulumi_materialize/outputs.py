...
class SourceLoadgenCounterOptions(dict):
    ...
    def __init__(__self__, *,
                 max_cardinality: Optional[_builtins.int] = None,
                 scale_factor: Optional[_builtins.float] = None,
                 tick_interval: Optional[_builtins.str] = None):
        """
        :param _builtins.int max_cardinality: Causes the generator to delete old values to keep the collection at most a given size. Defaults to unlimited.
        :param _builtins.float scale_factor: (Deprecated) The scale factor for the generator. Defaults to 0.01 (~ 10MB).
        :param _builtins.str tick_interval: The interval at which the next datum should be emitted. Defaults to one second.
        """
    ...
    def max_cardinality(self) -> Optional[_builtins.int]:
        """
...
class SourceLoadgenKeyValueOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 snapshot_rounds: Optional[_builtins.int] = None,
                 tick_interval: Optional[_builtins.str] = None,
                 transactional_snapshot: Optional[_builtins.bool] = None,
                 value_size: Optional[_builtins.int] = None):
        """
        :param _builtins.int keys: The number of keys in the source. This must be divisible by the product of 'partitions' and 'batch_size'.
        :param _builtins.int batch_size: The number of keys per partition to produce in each update.
        :param _builtins.int partitions: The number of partitions to spread the keys across.
        :param _builtins.int seed: A per-source seed for seeding the random data.
        :param _builtins.int snapshot_rounds: The number of rounds of data to produce as the source starts up.
        :param _builtins.str tick_interval: The interval at which the next datum should be emitted. Defaults to one second.
        :param _builtins.bool transactional_snapshot: Whether to emit the snapshot as a singular transaction.
        :param _builtins.int value_size: The number of bytes in each value.
        """
    ...
    def snapshot_rounds(self) -> Optional[_builtins.int]:
        """
    ...
    def transactional_snapshot(self) -> Optional[_builtins.bool]:
        """
    ...
    def value_size(self) -> Optional[_builtins.int]:
        """
