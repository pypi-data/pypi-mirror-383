...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SJTU Netdisk Command Line Tool - 上海交通大学网络云盘命令行工具",
...
QR Code Authentication Process:
  1. Generates QR code in terminal with server-provided cryptographic signature
  2. Scan with SJTU mobile app OR visit the URL in browser
  3. Login with your SJTU JAccount
  4. Authentication completes automatically
  5. QR code auto-refreshes every 50 seconds to prevent expiration

Note: QR codes use secure server-provided signatures and WebSocket communication
for reliable authentication. No manual cookie extraction required.
        """,
    )
