...
* add missing comma for continue-on-error alias in BashCommandInput ([6eef6d4](https://github.com/qtsone/mcp-workflows/commit/6eef6d4a29bc7e0896103f59b3a9df730b8b0f7d))
