...
async def test_command_with_exit_code():
    ...
    block2 = BashCommand(id="ignore_exit", inputs={"command": "exit 1", "continue-on-error": True})
...
async def test_timeout_handling():
    ...
    block = BashCommand(id="timeout_test", inputs={"command": "sleep 5", "timeout": 1})
...
async def test_shell_vs_direct_execution():
    ...
    block_direct = BashCommand(id="direct_test", inputs={"command": "echo hello", "shell": False})
