...
class LambdaClient:
    def __init__(self, region_name, timeout=3600, max_attempts=0):
        endpoint_url = os.environ.get("AWS_DEFAULT_ENDPOINT")
        config = botocore.config.Config(connect_timeout=30, read_timeout=timeout, retries={"max_attempts": max_attempts})
