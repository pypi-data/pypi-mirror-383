...
class ShareItApp(App[None]):
    ...
    # We remove the CSS_PATH variable here.
    # Textual will automatically look for a CSS file with the same name as the app.
    ...
    def update_peers(self) -> None:
        ...
        if peers_table.is_valid_row_index(current_selection):
            peers_table.cursor_row = current_selection
