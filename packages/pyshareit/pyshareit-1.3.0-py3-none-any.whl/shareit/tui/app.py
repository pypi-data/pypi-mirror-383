...
from textual.events import Drop
...
class ShareItApp(App[None]):
    ...
    # Textual will automatically look for a CSS file named `app.tcss`
    # in the same directory, so CSS_PATH is not needed here.
    ...
    def on_mount(self) -> None:
        ...
        # Periodically refresh the list of discovered peers
    ...
    def update_peers(self) -> None:
        ...
        if peers_table.is_valid_row_index(current_selection):
            # Use the move_cursor method to set the row
