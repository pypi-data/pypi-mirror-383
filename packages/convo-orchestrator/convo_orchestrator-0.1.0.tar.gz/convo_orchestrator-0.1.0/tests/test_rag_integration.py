...
def test_rag_pipeline_options_when_ambiguous():
    ...
    host = os.getenv("PGHOST", "localhost"); port = os.getenv("PGPORT", "55432")
    user = os.getenv("PGUSER", "postgres"); pwd = os.getenv("PGPASSWORD", "postgres"); db = os.getenv("PGDATABASE", "postgres")
