...
class CustomEvent(InputElement):
    ...
    :param on_click: Callback function to execute to generate modal/popover on user interaction
    ...
    **EXAMPLE:**
    ...
    '''
    @validate_types
    def __init__(self, title: str, confirmation_text: str = None, label: str = None, show_confirmation: bool = True, icon: str = '', open_new_tab: bool = False, on_click: drilldown_callback_type | None = None, vertical_position: ElementVerticalPosition = ..., horizontal_position: ElementHorizontalPosition = ..., **kwargs) -> None: ...
    @validate_types
