...
class Form:
    ...
    def show(self) -> None:
        """Muestra la ventana y comienza el bucle principal."""
        self._window.show()

    def show_async(self) -> None:
        """
        Muestra la ventana en un hilo separado para no bloquear el hilo principal.

        Esto permite ejecutar código en el hilo principal mientras la interfaz
        gráfica sigue siendo responsiva.
        """
        self._window.show_async()
