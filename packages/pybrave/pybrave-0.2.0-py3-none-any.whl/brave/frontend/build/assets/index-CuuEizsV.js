import{r as m,j as e,B as n,F as _,S as d,a as g}from"./main-gLMaKCvr.js";import{A as h}from"./index-DUqcjVqJ.js";import{f}from"./utils-D2B0dIuM.js";import{T as c}from"./index-ZwmWfN3I.js";import"./index-Ci9o3BMm.js";import"./Table-CWRWFg95.js";import"./addEventListener-BwXlid1p.js";import"./Dropdown-CSp8FTqG.js";import"./index-B-_sZvQI.js";import"./index-Jdu54dr5.js";import"./index-DEhiFitC.js";import"./index-CjYZg4K2.js";import"./index-B__zS0KG.js";import"./index-BrNLqRge.js";import"./index-ByQpjXWK.js";import"./UpOutlined-CEatmWIN.js";import"./index-DDpcHwmR.js";import"./study-page-BLC-2qgz.js";import"./usePagination-DK-N3QaW.js";import"./index-Das8pPKs.js";import"./index-CWqFacgc.js";import"./callSuper-DlyBkZi7.js";import"./index-BpTPZbHm.js";import"./index-D1xRfB3g.js";import"./index-D2XNTdXQ.js";import"./DeleteOutlined-CBRh7405.js";import"./index-B6vjdRJB.js";import"./rgb-BwIoVOhg.js";import"./index-4ifBGcWk.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:o,resultTableList:l,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:o,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(_.Item,{name:"list_files",label:"选择样本",children:e.jsx(d,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:l.breseq?l.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},W=()=>{const[t,a]=m.useState([]),[u,o]=m.useState(!1),l=async()=>{o(!0);const r=await g.get("/api/mutation");console.log(r),o(!1),a(r.data)};m.useEffect(()=>{l()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(h,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{W as default};
