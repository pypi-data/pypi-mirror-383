...
_UniffiLib.uniffi_rusaint_fn_clone_lecturecategorybuilder.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_rusaint_fn_constructor_lecturecategorybuilder_new.restype = ctypes.c_uint64
...
class _UniffiFfiConverterTypeSemesterType(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class _UniffiFfiConverterTypeChapelAbsenceRequest(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return ChapelAbsenceRequest(
            year=_UniffiFfiConverterUInt32.read(buf),
            semester=_UniffiFfiConverterTypeSemesterType.read(buf),
            absence_detail=_UniffiFfiConverterString.read(buf),
            absence_start=_UniffiFfiConverterString.read(buf),
            absence_end=_UniffiFfiConverterString.read(buf),
            absence_reason_kr=_UniffiFfiConverterString.read(buf),
            absence_reason_en=_UniffiFfiConverterString.read(buf),
            application_date=_UniffiFfiConverterString.read(buf),
            approval_date=_UniffiFfiConverterString.read(buf),
            denial_reason=_UniffiFfiConverterString.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiFfiConverterTypeSemesterType.check_lower(value.semester)
        _UniffiFfiConverterString.check_lower(value.absence_detail)
        _UniffiFfiConverterString.check_lower(value.absence_start)
        _UniffiFfiConverterString.check_lower(value.absence_end)
        _UniffiFfiConverterString.check_lower(value.absence_reason_kr)
        _UniffiFfiConverterString.check_lower(value.absence_reason_en)
        _UniffiFfiConverterString.check_lower(value.application_date)
        _UniffiFfiConverterString.check_lower(value.approval_date)
        _UniffiFfiConverterString.check_lower(value.denial_reason)
        _UniffiFfiConverterString.check_lower(value.status)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.year, buf)
        _UniffiFfiConverterTypeSemesterType.write(value.semester, buf)
        _UniffiFfiConverterString.write(value.absence_detail, buf)
        _UniffiFfiConverterString.write(value.absence_start, buf)
        _UniffiFfiConverterString.write(value.absence_end, buf)
        _UniffiFfiConverterString.write(value.absence_reason_kr, buf)
        _UniffiFfiConverterString.write(value.absence_reason_en, buf)
        _UniffiFfiConverterString.write(value.application_date, buf)
        _UniffiFfiConverterString.write(value.approval_date, buf)
        _UniffiFfiConverterString.write(value.denial_reason, buf)
...
class _UniffiFfiConverterTypeChapelAttendance(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return ChapelAttendance(
            division=_UniffiFfiConverterUInt32.read(buf),
            class_date=_UniffiFfiConverterString.read(buf),
            category=_UniffiFfiConverterString.read(buf),
            instructor=_UniffiFfiConverterString.read(buf),
            instructor_department=_UniffiFfiConverterString.read(buf),
            title=_UniffiFfiConverterString.read(buf),
            attendance=_UniffiFfiConverterString.read(buf),
            result=_UniffiFfiConverterString.read(buf),
            note=_UniffiFfiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.division)
        _UniffiFfiConverterString.check_lower(value.class_date)
        _UniffiFfiConverterString.check_lower(value.category)
        _UniffiFfiConverterString.check_lower(value.instructor)
        _UniffiFfiConverterString.check_lower(value.instructor_department)
        _UniffiFfiConverterString.check_lower(value.title)
        _UniffiFfiConverterString.check_lower(value.attendance)
        _UniffiFfiConverterString.check_lower(value.result)
        _UniffiFfiConverterString.check_lower(value.note)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.division, buf)
        _UniffiFfiConverterString.write(value.class_date, buf)
        _UniffiFfiConverterString.write(value.category, buf)
        _UniffiFfiConverterString.write(value.instructor, buf)
        _UniffiFfiConverterString.write(value.instructor_department, buf)
        _UniffiFfiConverterString.write(value.title, buf)
        _UniffiFfiConverterString.write(value.attendance, buf)
        _UniffiFfiConverterString.write(value.result, buf)
        _UniffiFfiConverterString.write(value.note, buf)
...
class _UniffiFfiConverterTypeGeneralChapelInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return GeneralChapelInformation(
            division=_UniffiFfiConverterUInt32.read(buf),
            chapel_time=_UniffiFfiConverterString.read(buf),
            chapel_room=_UniffiFfiConverterString.read(buf),
            floor_level=_UniffiFfiConverterUInt32.read(buf),
            seat_number=_UniffiFfiConverterString.read(buf),
            absence_time=_UniffiFfiConverterUInt32.read(buf),
            result=_UniffiFfiConverterString.read(buf),
            note=_UniffiFfiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.division)
        _UniffiFfiConverterString.check_lower(value.chapel_time)
        _UniffiFfiConverterString.check_lower(value.chapel_room)
        _UniffiFfiConverterUInt32.check_lower(value.floor_level)
        _UniffiFfiConverterString.check_lower(value.seat_number)
        _UniffiFfiConverterUInt32.check_lower(value.absence_time)
        _UniffiFfiConverterString.check_lower(value.result)
        _UniffiFfiConverterString.check_lower(value.note)
    ...
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.division, buf)
        _UniffiFfiConverterString.write(value.chapel_time, buf)
        _UniffiFfiConverterString.write(value.chapel_room, buf)
        _UniffiFfiConverterUInt32.write(value.floor_level, buf)
        _UniffiFfiConverterString.write(value.seat_number, buf)
        _UniffiFfiConverterUInt32.write(value.absence_time, buf)
        _UniffiFfiConverterString.write(value.result, buf)
        _UniffiFfiConverterString.write(value.note, buf)

class _UniffiFfiConverterSequenceTypeChapelAttendance(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeChapelAttendance.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeChapelAttendance.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeChapelAttendance.read(buf) for i in range(count)
        ]

class _UniffiFfiConverterSequenceTypeChapelAbsenceRequest(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeChapelAbsenceRequest.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeChapelAbsenceRequest.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeChapelAbsenceRequest.read(buf) for i in range(count)
        ]
...
class _UniffiFfiConverterTypeChapelInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return ChapelInformation(
            year=_UniffiFfiConverterUInt32.read(buf),
            semester=_UniffiFfiConverterTypeSemesterType.read(buf),
            general_information=_UniffiFfiConverterTypeGeneralChapelInformation.read(buf),
            attendances=_UniffiFfiConverterSequenceTypeChapelAttendance.read(buf),
            absence_requests=_UniffiFfiConverterSequenceTypeChapelAbsenceRequest.read(buf),
        )
    ...
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.year)
        _UniffiFfiConverterTypeSemesterType.check_lower(value.semester)
        _UniffiFfiConverterTypeGeneralChapelInformation.check_lower(value.general_information)
        _UniffiFfiConverterSequenceTypeChapelAttendance.check_lower(value.attendances)
        _UniffiFfiConverterSequenceTypeChapelAbsenceRequest.check_lower(value.absence_requests)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.year, buf)
        _UniffiFfiConverterTypeSemesterType.write(value.semester, buf)
        _UniffiFfiConverterTypeGeneralChapelInformation.write(value.general_information, buf)
        _UniffiFfiConverterSequenceTypeChapelAttendance.write(value.attendances, buf)
        _UniffiFfiConverterSequenceTypeChapelAbsenceRequest.write(value.absence_requests, buf)
...
class _UniffiFfiConverterTypeClassScore(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
    ...
    def check_lower(value):
        ...
        if value.is_FAILED():
            return
        if value.is_SCORE():
            _UniffiFfiConverterUInt32.check_lower(value._values[0])
            return
        if value.is_EMPTY():
            return
        raise ValueError(value)
    ...
    def write(value, buf):
        ...
        if value.is_SCORE():
            buf.write_i32(3)
            _UniffiFfiConverterUInt32.write(value._values[0], buf)
        if value.is_EMPTY():
            buf.write_i32(4)
...
class _UniffiFfiConverterOptionalMapStringFloat32(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiFfiConverterMapStringFloat32.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiFfiConverterMapStringFloat32.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiFfiConverterMapStringFloat32.read(buf)
        else:
...
class _UniffiFfiConverterTypeClassGrade(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return ClassGrade(
            year=_UniffiFfiConverterUInt32.read(buf),
            ...
            grade_points=_UniffiFfiConverterFloat32.read(buf),
            score=_UniffiFfiConverterTypeClassScore.read(buf),
            rank=_UniffiFfiConverterString.read(buf),
            professor=_UniffiFfiConverterString.read(buf),
            detail=_UniffiFfiConverterOptionalMapStringFloat32.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiFfiConverterFloat32.check_lower(value.grade_points)
        _UniffiFfiConverterTypeClassScore.check_lower(value.score)
        _UniffiFfiConverterString.check_lower(value.rank)
        _UniffiFfiConverterString.check_lower(value.professor)
        _UniffiFfiConverterOptionalMapStringFloat32.check_lower(value.detail)
    ...
    def write(value, buf):
        ...
        _UniffiFfiConverterFloat32.write(value.grade_points, buf)
        _UniffiFfiConverterTypeClassScore.write(value.score, buf)
        _UniffiFfiConverterString.write(value.rank, buf)
        _UniffiFfiConverterString.write(value.professor, buf)
        _UniffiFfiConverterOptionalMapStringFloat32.write(value.detail, buf)
...
class _UniffiFfiConverterTypeCourseScheduleInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return CourseScheduleInformation(
            name=_UniffiFfiConverterString.read(buf),
            professor=_UniffiFfiConverterString.read(buf),
            time=_UniffiFfiConverterString.read(buf),
            classroom=_UniffiFfiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiFfiConverterString.check_lower(value.professor)
        _UniffiFfiConverterString.check_lower(value.time)
        _UniffiFfiConverterString.check_lower(value.classroom)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterString.write(value.professor, buf)
        _UniffiFfiConverterString.write(value.time, buf)
        _UniffiFfiConverterString.write(value.classroom, buf)
...
class _UniffiFfiConverterTypeGradeSummary(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return GradeSummary(
            attempted_credits=_UniffiFfiConverterFloat32.read(buf),
            earned_credits=_UniffiFfiConverterFloat32.read(buf),
            grade_points_sum=_UniffiFfiConverterFloat32.read(buf),
            grade_points_average=_UniffiFfiConverterFloat32.read(buf),
            arithmetic_mean=_UniffiFfiConverterFloat32.read(buf),
            pf_earned_credits=_UniffiFfiConverterFloat32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterFloat32.check_lower(value.attempted_credits)
        _UniffiFfiConverterFloat32.check_lower(value.earned_credits)
        _UniffiFfiConverterFloat32.check_lower(value.grade_points_sum)
        _UniffiFfiConverterFloat32.check_lower(value.grade_points_average)
        _UniffiFfiConverterFloat32.check_lower(value.arithmetic_mean)
        _UniffiFfiConverterFloat32.check_lower(value.pf_earned_credits)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterFloat32.write(value.attempted_credits, buf)
        _UniffiFfiConverterFloat32.write(value.earned_credits, buf)
        _UniffiFfiConverterFloat32.write(value.grade_points_sum, buf)
        _UniffiFfiConverterFloat32.write(value.grade_points_average, buf)
        _UniffiFfiConverterFloat32.write(value.arithmetic_mean, buf)
        _UniffiFfiConverterFloat32.write(value.pf_earned_credits, buf)
...
class _UniffiFfiConverterTypeGraduationRequirement(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return GraduationRequirement(
            name=_UniffiFfiConverterString.read(buf),
            requirement=_UniffiFfiConverterOptionalUInt32.read(buf),
            calculation=_UniffiFfiConverterOptionalFloat32.read(buf),
            difference=_UniffiFfiConverterOptionalFloat32.read(buf),
            result=_UniffiFfiConverterBoolean.read(buf),
            category=_UniffiFfiConverterString.read(buf),
            lectures=_UniffiFfiConverterSequenceString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterString.check_lower(value.name)
        _UniffiFfiConverterOptionalUInt32.check_lower(value.requirement)
        _UniffiFfiConverterOptionalFloat32.check_lower(value.calculation)
        _UniffiFfiConverterOptionalFloat32.check_lower(value.difference)
        _UniffiFfiConverterBoolean.check_lower(value.result)
        _UniffiFfiConverterString.check_lower(value.category)
        _UniffiFfiConverterSequenceString.check_lower(value.lectures)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterOptionalUInt32.write(value.requirement, buf)
        _UniffiFfiConverterOptionalFloat32.write(value.calculation, buf)
        _UniffiFfiConverterOptionalFloat32.write(value.difference, buf)
        _UniffiFfiConverterBoolean.write(value.result, buf)
        _UniffiFfiConverterString.write(value.category, buf)
        _UniffiFfiConverterSequenceString.write(value.lectures, buf)

class _UniffiFfiConverterMapStringTypeGraduationRequirement(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, items):
        for (key, value) in items.items():
            _UniffiFfiConverterString.check_lower(key)
            _UniffiFfiConverterTypeGraduationRequirement.check_lower(value)
    ...
    def write(cls, items, buf):
        ...
        for (key, value) in items.items():
            _UniffiFfiConverterString.write(key, buf)
            _UniffiFfiConverterTypeGraduationRequirement.write(value, buf)
    ...
    def read(cls, buf):
        ...
        for i in range(count):
            key = _UniffiFfiConverterString.read(buf)
            val = _UniffiFfiConverterTypeGraduationRequirement.read(buf)
            d[key] = val
        return d
...
class _UniffiFfiConverterTypeGraduationRequirements(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return GraduationRequirements(
            is_graduatable=_UniffiFfiConverterBoolean.read(buf),
            requirements=_UniffiFfiConverterMapStringTypeGraduationRequirement.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterBoolean.check_lower(value.is_graduatable)
        _UniffiFfiConverterMapStringTypeGraduationRequirement.check_lower(value.requirements)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterBoolean.write(value.is_graduatable, buf)
        _UniffiFfiConverterMapStringTypeGraduationRequirement.write(value.requirements, buf)
...
class _UniffiFfiConverterTypeGraduationStudent(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return GraduationStudent(
            number=_UniffiFfiConverterUInt32.read(buf),
            name=_UniffiFfiConverterString.read(buf),
            grade=_UniffiFfiConverterUInt32.read(buf),
            semester=_UniffiFfiConverterUInt32.read(buf),
            status=_UniffiFfiConverterString.read(buf),
            apply_year=_UniffiFfiConverterUInt32.read(buf),
            apply_type=_UniffiFfiConverterString.read(buf),
            department=_UniffiFfiConverterString.read(buf),
            majors=_UniffiFfiConverterSequenceString.read(buf),
            audit_date=_UniffiFfiConverterString.read(buf),
            graduation_points=_UniffiFfiConverterFloat32.read(buf),
            completed_points=_UniffiFfiConverterFloat32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.number)
        _UniffiFfiConverterString.check_lower(value.name)
        _UniffiFfiConverterUInt32.check_lower(value.grade)
        _UniffiFfiConverterUInt32.check_lower(value.semester)
        _UniffiFfiConverterString.check_lower(value.status)
        _UniffiFfiConverterUInt32.check_lower(value.apply_year)
        _UniffiFfiConverterString.check_lower(value.apply_type)
        _UniffiFfiConverterString.check_lower(value.department)
        _UniffiFfiConverterSequenceString.check_lower(value.majors)
        _UniffiFfiConverterString.check_lower(value.audit_date)
        _UniffiFfiConverterFloat32.check_lower(value.graduation_points)
        _UniffiFfiConverterFloat32.check_lower(value.completed_points)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.number, buf)
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterUInt32.write(value.grade, buf)
        _UniffiFfiConverterUInt32.write(value.semester, buf)
        _UniffiFfiConverterString.write(value.status, buf)
        _UniffiFfiConverterUInt32.write(value.apply_year, buf)
        _UniffiFfiConverterString.write(value.apply_type, buf)
        _UniffiFfiConverterString.write(value.department, buf)
        _UniffiFfiConverterSequenceString.write(value.majors, buf)
        _UniffiFfiConverterString.write(value.audit_date, buf)
        _UniffiFfiConverterFloat32.write(value.graduation_points, buf)
        _UniffiFfiConverterFloat32.write(value.completed_points, buf)
...
class _UniffiFfiConverterTypeLecture(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return Lecture(
            syllabus=_UniffiFfiConverterOptionalString.read(buf),
            category=_UniffiFfiConverterString.read(buf),
            sub_category=_UniffiFfiConverterOptionalString.read(buf),
            abeek_info=_UniffiFfiConverterOptionalString.read(buf),
            field=_UniffiFfiConverterOptionalString.read(buf),
            code=_UniffiFfiConverterString.read(buf),
            name=_UniffiFfiConverterString.read(buf),
            division=_UniffiFfiConverterOptionalString.read(buf),
            professor=_UniffiFfiConverterString.read(buf),
            department=_UniffiFfiConverterString.read(buf),
            time_points=_UniffiFfiConverterString.read(buf),
            personeel=_UniffiFfiConverterString.read(buf),
            remaining_seats=_UniffiFfiConverterString.read(buf),
            schedule_room=_UniffiFfiConverterString.read(buf),
            target=_UniffiFfiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.syllabus)
        _UniffiFfiConverterString.check_lower(value.category)
        _UniffiFfiConverterOptionalString.check_lower(value.sub_category)
        _UniffiFfiConverterOptionalString.check_lower(value.abeek_info)
        _UniffiFfiConverterOptionalString.check_lower(value.field)
        _UniffiFfiConverterString.check_lower(value.code)
        _UniffiFfiConverterString.check_lower(value.name)
        _UniffiFfiConverterOptionalString.check_lower(value.division)
        _UniffiFfiConverterString.check_lower(value.professor)
        _UniffiFfiConverterString.check_lower(value.department)
        _UniffiFfiConverterString.check_lower(value.time_points)
        _UniffiFfiConverterString.check_lower(value.personeel)
        _UniffiFfiConverterString.check_lower(value.remaining_seats)
        _UniffiFfiConverterString.check_lower(value.schedule_room)
        _UniffiFfiConverterString.check_lower(value.target)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.syllabus, buf)
        _UniffiFfiConverterString.write(value.category, buf)
        _UniffiFfiConverterOptionalString.write(value.sub_category, buf)
        _UniffiFfiConverterOptionalString.write(value.abeek_info, buf)
        _UniffiFfiConverterOptionalString.write(value.field, buf)
        _UniffiFfiConverterString.write(value.code, buf)
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterOptionalString.write(value.division, buf)
        _UniffiFfiConverterString.write(value.professor, buf)
        _UniffiFfiConverterString.write(value.department, buf)
        _UniffiFfiConverterString.write(value.time_points, buf)
        _UniffiFfiConverterString.write(value.personeel, buf)
        _UniffiFfiConverterString.write(value.remaining_seats, buf)
        _UniffiFfiConverterString.write(value.schedule_room, buf)
...
class _UniffiFfiConverterTypeLectureAssessmentResult(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return LectureAssessmentResult(
            year=_UniffiFfiConverterString.read(buf),
            semester=_UniffiFfiConverterTypeSemesterType.read(buf),
            lecture_code=_UniffiFfiConverterUInt32.read(buf),
            lecture_name=_UniffiFfiConverterString.read(buf),
            points=_UniffiFfiConverterFloat32.read(buf),
            professor=_UniffiFfiConverterString.read(buf),
            collage=_UniffiFfiConverterString.read(buf),
            department=_UniffiFfiConverterString.read(buf),
            position=_UniffiFfiConverterString.read(buf),
            score=_UniffiFfiConverterFloat32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterString.check_lower(value.year)
        _UniffiFfiConverterTypeSemesterType.check_lower(value.semester)
        _UniffiFfiConverterUInt32.check_lower(value.lecture_code)
        _UniffiFfiConverterString.check_lower(value.lecture_name)
        _UniffiFfiConverterFloat32.check_lower(value.points)
        _UniffiFfiConverterString.check_lower(value.professor)
        _UniffiFfiConverterString.check_lower(value.collage)
        _UniffiFfiConverterString.check_lower(value.department)
        _UniffiFfiConverterString.check_lower(value.position)
        _UniffiFfiConverterFloat32.check_lower(value.score)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterString.write(value.year, buf)
        _UniffiFfiConverterTypeSemesterType.write(value.semester, buf)
        _UniffiFfiConverterUInt32.write(value.lecture_code, buf)
        _UniffiFfiConverterString.write(value.lecture_name, buf)
        _UniffiFfiConverterFloat32.write(value.points, buf)
        _UniffiFfiConverterString.write(value.professor, buf)
        _UniffiFfiConverterString.write(value.collage, buf)
        _UniffiFfiConverterString.write(value.department, buf)
        _UniffiFfiConverterString.write(value.position, buf)
...
class _UniffiFfiConverterTypeWeekday(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
...
class _UniffiFfiConverterSequenceTypeCourseScheduleInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeCourseScheduleInformation.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeCourseScheduleInformation.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeCourseScheduleInformation.read(buf) for i in range(count)
        ]

class _UniffiFfiConverterMapTypeWeekdaySequenceTypeCourseScheduleInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, items):
        for (key, value) in items.items():
            _UniffiFfiConverterTypeWeekday.check_lower(key)
            _UniffiFfiConverterSequenceTypeCourseScheduleInformation.check_lower(value)

    @classmethod
    def write(cls, items, buf):
        buf.write_i32(len(items))
        for (key, value) in items.items():
            _UniffiFfiConverterTypeWeekday.write(key, buf)
            _UniffiFfiConverterSequenceTypeCourseScheduleInformation.write(value, buf)
    ...
    def read(cls, buf):
        ...
        d = {}
        for i in range(count):
            key = _UniffiFfiConverterTypeWeekday.read(buf)
            val = _UniffiFfiConverterSequenceTypeCourseScheduleInformation.read(buf)
            d[key] = val
        return d
...
class _UniffiFfiConverterTypePersonalCourseSchedule(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return PersonalCourseSchedule(
            schedule=_UniffiFfiConverterMapTypeWeekdaySequenceTypeCourseScheduleInformation.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterMapTypeWeekdaySequenceTypeCourseScheduleInformation.check_lower(value.schedule)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterMapTypeWeekdaySequenceTypeCourseScheduleInformation.write(value.schedule, buf)
...
class _UniffiFfiConverterTypeScholarship(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return Scholarship(
            year=_UniffiFfiConverterUInt32.read(buf),
            semester=_UniffiFfiConverterTypeSemesterType.read(buf),
            name=_UniffiFfiConverterString.read(buf),
            received_amount=_UniffiFfiConverterUInt64.read(buf),
            receive_type=_UniffiFfiConverterString.read(buf),
            status=_UniffiFfiConverterString.read(buf),
            processed_at=_UniffiFfiConverterString.read(buf),
            selected_amount=_UniffiFfiConverterUInt64.read(buf),
            refunded_amount=_UniffiFfiConverterUInt64.read(buf),
            replaced_amount=_UniffiFfiConverterUInt64.read(buf),
            replaced_by=_UniffiFfiConverterString.read(buf),
            drop_reason=_UniffiFfiConverterString.read(buf),
            note=_UniffiFfiConverterString.read(buf),
            worked_at=_UniffiFfiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiFfiConverterTypeSemesterType.check_lower(value.semester)
        _UniffiFfiConverterString.check_lower(value.name)
        _UniffiFfiConverterUInt64.check_lower(value.received_amount)
        _UniffiFfiConverterString.check_lower(value.receive_type)
        _UniffiFfiConverterString.check_lower(value.status)
        _UniffiFfiConverterString.check_lower(value.processed_at)
        _UniffiFfiConverterUInt64.check_lower(value.selected_amount)
        _UniffiFfiConverterUInt64.check_lower(value.refunded_amount)
        _UniffiFfiConverterUInt64.check_lower(value.replaced_amount)
        _UniffiFfiConverterString.check_lower(value.replaced_by)
        _UniffiFfiConverterString.check_lower(value.drop_reason)
        _UniffiFfiConverterString.check_lower(value.note)
        _UniffiFfiConverterString.check_lower(value.worked_at)
    ...
    def write(value, buf):
        ...
        _UniffiFfiConverterTypeSemesterType.write(value.semester, buf)
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterUInt64.write(value.received_amount, buf)
        _UniffiFfiConverterString.write(value.receive_type, buf)
        _UniffiFfiConverterString.write(value.status, buf)
        _UniffiFfiConverterString.write(value.processed_at, buf)
        _UniffiFfiConverterUInt64.write(value.selected_amount, buf)
        _UniffiFfiConverterUInt64.write(value.refunded_amount, buf)
        _UniffiFfiConverterUInt64.write(value.replaced_amount, buf)
        _UniffiFfiConverterString.write(value.replaced_by, buf)
        _UniffiFfiConverterString.write(value.drop_reason, buf)
        _UniffiFfiConverterString.write(value.note, buf)
        _UniffiFfiConverterString.write(value.worked_at, buf)
...
class _UniffiFfiConverterTypeUnsignedIntPair(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return UnsignedIntPair(
            first=_UniffiFfiConverterUInt32.read(buf),
            second=_UniffiFfiConverterUInt32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.first)
        _UniffiFfiConverterUInt32.check_lower(value.second)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.first, buf)
        _UniffiFfiConverterUInt32.write(value.second, buf)


class _UniffiFfiConverterTypeU32Pair:
    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterTypeUnsignedIntPair.write(value, buf)

    @staticmethod
    def read(buf):
        return _UniffiFfiConverterTypeUnsignedIntPair.read(buf)

    @staticmethod
    def lift(value):
        return _UniffiFfiConverterTypeUnsignedIntPair.lift(value)

    @staticmethod
    def check_lower(value):
        return _UniffiFfiConverterTypeUnsignedIntPair.check_lower(value)

    @staticmethod
    def lower(value):
        return _UniffiFfiConverterTypeUnsignedIntPair.lower(value)
...
class _UniffiFfiConverterTypeSemesterGrade(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return SemesterGrade(
            ...
            grade_points_sum=_UniffiFfiConverterFloat32.read(buf),
            arithmetic_mean=_UniffiFfiConverterFloat32.read(buf),
            semester_rank=_UniffiFfiConverterTypeU32Pair.read(buf),
            general_rank=_UniffiFfiConverterTypeU32Pair.read(buf),
            academic_probation=_UniffiFfiConverterBoolean.read(buf),
            consult=_UniffiFfiConverterBoolean.read(buf),
            flunked=_UniffiFfiConverterBoolean.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiFfiConverterFloat32.check_lower(value.grade_points_sum)
        _UniffiFfiConverterFloat32.check_lower(value.arithmetic_mean)
        _UniffiFfiConverterTypeU32Pair.check_lower(value.semester_rank)
        _UniffiFfiConverterTypeU32Pair.check_lower(value.general_rank)
        _UniffiFfiConverterBoolean.check_lower(value.academic_probation)
        _UniffiFfiConverterBoolean.check_lower(value.consult)
        _UniffiFfiConverterBoolean.check_lower(value.flunked)
    ...
    def write(value, buf):
        ...
        _UniffiFfiConverterFloat32.write(value.grade_points_sum, buf)
        _UniffiFfiConverterFloat32.write(value.arithmetic_mean, buf)
        _UniffiFfiConverterTypeU32Pair.write(value.semester_rank, buf)
        _UniffiFfiConverterTypeU32Pair.write(value.general_rank, buf)
        _UniffiFfiConverterBoolean.write(value.academic_probation, buf)
        _UniffiFfiConverterBoolean.write(value.consult, buf)
        _UniffiFfiConverterBoolean.write(value.flunked, buf)
...
class _UniffiFfiConverterTypeStudentAcademicRecord(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentAcademicRecord(
            start_date=_UniffiFfiConverterString.read(buf),
            end_date=_UniffiFfiConverterString.read(buf),
            year=_UniffiFfiConverterString.read(buf),
            term=_UniffiFfiConverterString.read(buf),
            category=_UniffiFfiConverterString.read(buf),
            reason=_UniffiFfiConverterString.read(buf),
            process_date=_UniffiFfiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterString.check_lower(value.start_date)
        _UniffiFfiConverterString.check_lower(value.end_date)
        _UniffiFfiConverterString.check_lower(value.year)
        _UniffiFfiConverterString.check_lower(value.term)
        _UniffiFfiConverterString.check_lower(value.category)
        _UniffiFfiConverterString.check_lower(value.reason)
        _UniffiFfiConverterString.check_lower(value.process_date)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterString.write(value.start_date, buf)
        _UniffiFfiConverterString.write(value.end_date, buf)
        _UniffiFfiConverterString.write(value.year, buf)
        _UniffiFfiConverterString.write(value.term, buf)
        _UniffiFfiConverterString.write(value.category, buf)
        _UniffiFfiConverterString.write(value.reason, buf)
        _UniffiFfiConverterString.write(value.process_date, buf)

class _UniffiFfiConverterSequenceTypeStudentAcademicRecord(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeStudentAcademicRecord.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeStudentAcademicRecord.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeStudentAcademicRecord.read(buf) for i in range(count)
        ]
...
class _UniffiFfiConverterTypeStudentAcademicRecords(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentAcademicRecords(
            records=_UniffiFfiConverterSequenceTypeStudentAcademicRecord.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterSequenceTypeStudentAcademicRecord.check_lower(value.records)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterSequenceTypeStudentAcademicRecord.write(value.records, buf)
...
class _UniffiFfiConverterTypeStudentBankAccount(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentBankAccount(
            bank=_UniffiFfiConverterOptionalString.read(buf),
            account_number=_UniffiFfiConverterOptionalString.read(buf),
            holder=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.bank)
        _UniffiFfiConverterOptionalString.check_lower(value.account_number)
        _UniffiFfiConverterOptionalString.check_lower(value.holder)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.bank, buf)
        _UniffiFfiConverterOptionalString.write(value.account_number, buf)
        _UniffiFfiConverterOptionalString.write(value.holder, buf)
...
class _UniffiFfiConverterTypeStudentFamilyMember(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentFamilyMember(
            relation_type=_UniffiFfiConverterOptionalString.read(buf),
            tel_number=_UniffiFfiConverterOptionalString.read(buf),
            name=_UniffiFfiConverterOptionalString.read(buf),
            mobile_number=_UniffiFfiConverterOptionalString.read(buf),
            office=_UniffiFfiConverterOptionalString.read(buf),
            job=_UniffiFfiConverterOptionalString.read(buf),
            position=_UniffiFfiConverterOptionalString.read(buf),
            is_guardian=_UniffiFfiConverterBoolean.read(buf),
            is_cohabit=_UniffiFfiConverterBoolean.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.relation_type)
        _UniffiFfiConverterOptionalString.check_lower(value.tel_number)
        _UniffiFfiConverterOptionalString.check_lower(value.name)
        _UniffiFfiConverterOptionalString.check_lower(value.mobile_number)
        _UniffiFfiConverterOptionalString.check_lower(value.office)
        _UniffiFfiConverterOptionalString.check_lower(value.job)
        _UniffiFfiConverterOptionalString.check_lower(value.position)
        _UniffiFfiConverterBoolean.check_lower(value.is_guardian)
        _UniffiFfiConverterBoolean.check_lower(value.is_cohabit)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.relation_type, buf)
        _UniffiFfiConverterOptionalString.write(value.tel_number, buf)
        _UniffiFfiConverterOptionalString.write(value.name, buf)
        _UniffiFfiConverterOptionalString.write(value.mobile_number, buf)
        _UniffiFfiConverterOptionalString.write(value.office, buf)
        _UniffiFfiConverterOptionalString.write(value.job, buf)
        _UniffiFfiConverterOptionalString.write(value.position, buf)
        _UniffiFfiConverterBoolean.write(value.is_guardian, buf)
        _UniffiFfiConverterBoolean.write(value.is_cohabit, buf)

class _UniffiFfiConverterSequenceTypeStudentFamilyMember(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeStudentFamilyMember.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeStudentFamilyMember.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeStudentFamilyMember.read(buf) for i in range(count)
        ]
...
class _UniffiFfiConverterTypeStudentFamily(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentFamily(
            members=_UniffiFfiConverterSequenceTypeStudentFamilyMember.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterSequenceTypeStudentFamilyMember.check_lower(value.members)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterSequenceTypeStudentFamilyMember.write(value.members, buf)
...
class _UniffiFfiConverterTypeStudentForignStudyInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentForignStudyInformation(
            approval_date=_UniffiFfiConverterOptionalString.read(buf),
            authentication_number=_UniffiFfiConverterOptionalString.read(buf),
            issue_date=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.approval_date)
        _UniffiFfiConverterOptionalString.check_lower(value.authentication_number)
        _UniffiFfiConverterOptionalString.check_lower(value.issue_date)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.approval_date, buf)
        _UniffiFfiConverterOptionalString.write(value.authentication_number, buf)
        _UniffiFfiConverterOptionalString.write(value.issue_date, buf)
...
class _UniffiFfiConverterTypeStudentGraduation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentGraduation(
            graduation_cardinal=_UniffiFfiConverterUInt32.read(buf),
            graduation_certification_number=_UniffiFfiConverterUInt32.read(buf),
            graduation_year=_UniffiFfiConverterUInt32.read(buf),
            graduation_terms=_UniffiFfiConverterUInt32.read(buf),
            graduation_date=_UniffiFfiConverterString.read(buf),
            academic_degree_number=_UniffiFfiConverterUInt32.read(buf),
            academic_degree_name=_UniffiFfiConverterString.read(buf),
            early_graduation=_UniffiFfiConverterBoolean.read(buf),
            graduation_rank=_UniffiFfiConverterUInt32.read(buf),
            graduation_personnel_number=_UniffiFfiConverterUInt32.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.graduation_cardinal)
        _UniffiFfiConverterUInt32.check_lower(value.graduation_certification_number)
        _UniffiFfiConverterUInt32.check_lower(value.graduation_year)
        _UniffiFfiConverterUInt32.check_lower(value.graduation_terms)
        _UniffiFfiConverterString.check_lower(value.graduation_date)
        _UniffiFfiConverterUInt32.check_lower(value.academic_degree_number)
        _UniffiFfiConverterString.check_lower(value.academic_degree_name)
        _UniffiFfiConverterBoolean.check_lower(value.early_graduation)
        _UniffiFfiConverterUInt32.check_lower(value.graduation_rank)
        _UniffiFfiConverterUInt32.check_lower(value.graduation_personnel_number)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.graduation_cardinal, buf)
        _UniffiFfiConverterUInt32.write(value.graduation_certification_number, buf)
        _UniffiFfiConverterUInt32.write(value.graduation_year, buf)
        _UniffiFfiConverterUInt32.write(value.graduation_terms, buf)
        _UniffiFfiConverterString.write(value.graduation_date, buf)
        _UniffiFfiConverterUInt32.write(value.academic_degree_number, buf)
        _UniffiFfiConverterString.write(value.academic_degree_name, buf)
        _UniffiFfiConverterBoolean.write(value.early_graduation, buf)
        _UniffiFfiConverterUInt32.write(value.graduation_rank, buf)
        _UniffiFfiConverterUInt32.write(value.graduation_personnel_number, buf)
...
class _UniffiFfiConverterTypeStudentInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentInformation(
            apply_year=_UniffiFfiConverterUInt32.read(buf),
            student_number=_UniffiFfiConverterUInt32.read(buf),
            name=_UniffiFfiConverterString.read(buf),
            rrn=_UniffiFfiConverterUInt32.read(buf),
            collage=_UniffiFfiConverterString.read(buf),
            department=_UniffiFfiConverterString.read(buf),
            major=_UniffiFfiConverterOptionalString.read(buf),
            division=_UniffiFfiConverterOptionalString.read(buf),
            grade=_UniffiFfiConverterUInt32.read(buf),
            term=_UniffiFfiConverterUInt32.read(buf),
            image=_UniffiFfiConverterBytes.read(buf),
            alias=_UniffiFfiConverterOptionalString.read(buf),
            kanji_name=_UniffiFfiConverterOptionalString.read(buf),
            email=_UniffiFfiConverterOptionalString.read(buf),
            tel_number=_UniffiFfiConverterOptionalString.read(buf),
            mobile_number=_UniffiFfiConverterOptionalString.read(buf),
            post_code=_UniffiFfiConverterOptionalString.read(buf),
            address=_UniffiFfiConverterOptionalString.read(buf),
            specific_address=_UniffiFfiConverterOptionalString.read(buf),
            is_transfer_student=_UniffiFfiConverterBoolean.read(buf),
            apply_date=_UniffiFfiConverterString.read(buf),
            applied_collage=_UniffiFfiConverterString.read(buf),
            applied_department=_UniffiFfiConverterString.read(buf),
            plural_major=_UniffiFfiConverterOptionalString.read(buf),
            sub_major=_UniffiFfiConverterOptionalString.read(buf),
            connected_major=_UniffiFfiConverterOptionalString.read(buf),
            abeek=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterUInt32.check_lower(value.apply_year)
        _UniffiFfiConverterUInt32.check_lower(value.student_number)
        _UniffiFfiConverterString.check_lower(value.name)
        _UniffiFfiConverterUInt32.check_lower(value.rrn)
        _UniffiFfiConverterString.check_lower(value.collage)
        _UniffiFfiConverterString.check_lower(value.department)
        _UniffiFfiConverterOptionalString.check_lower(value.major)
        _UniffiFfiConverterOptionalString.check_lower(value.division)
        _UniffiFfiConverterUInt32.check_lower(value.grade)
        _UniffiFfiConverterUInt32.check_lower(value.term)
        _UniffiFfiConverterBytes.check_lower(value.image)
        _UniffiFfiConverterOptionalString.check_lower(value.alias)
        _UniffiFfiConverterOptionalString.check_lower(value.kanji_name)
        _UniffiFfiConverterOptionalString.check_lower(value.email)
        _UniffiFfiConverterOptionalString.check_lower(value.tel_number)
        _UniffiFfiConverterOptionalString.check_lower(value.mobile_number)
        _UniffiFfiConverterOptionalString.check_lower(value.post_code)
        _UniffiFfiConverterOptionalString.check_lower(value.address)
        _UniffiFfiConverterOptionalString.check_lower(value.specific_address)
        _UniffiFfiConverterBoolean.check_lower(value.is_transfer_student)
        _UniffiFfiConverterString.check_lower(value.apply_date)
        _UniffiFfiConverterString.check_lower(value.applied_collage)
        _UniffiFfiConverterString.check_lower(value.applied_department)
        _UniffiFfiConverterOptionalString.check_lower(value.plural_major)
        _UniffiFfiConverterOptionalString.check_lower(value.sub_major)
        _UniffiFfiConverterOptionalString.check_lower(value.connected_major)
        _UniffiFfiConverterOptionalString.check_lower(value.abeek)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterUInt32.write(value.apply_year, buf)
        _UniffiFfiConverterUInt32.write(value.student_number, buf)
        _UniffiFfiConverterString.write(value.name, buf)
        _UniffiFfiConverterUInt32.write(value.rrn, buf)
        _UniffiFfiConverterString.write(value.collage, buf)
        _UniffiFfiConverterString.write(value.department, buf)
        _UniffiFfiConverterOptionalString.write(value.major, buf)
        _UniffiFfiConverterOptionalString.write(value.division, buf)
        _UniffiFfiConverterUInt32.write(value.grade, buf)
        _UniffiFfiConverterUInt32.write(value.term, buf)
        _UniffiFfiConverterBytes.write(value.image, buf)
        _UniffiFfiConverterOptionalString.write(value.alias, buf)
        _UniffiFfiConverterOptionalString.write(value.kanji_name, buf)
        _UniffiFfiConverterOptionalString.write(value.email, buf)
        _UniffiFfiConverterOptionalString.write(value.tel_number, buf)
        _UniffiFfiConverterOptionalString.write(value.mobile_number, buf)
        _UniffiFfiConverterOptionalString.write(value.post_code, buf)
        _UniffiFfiConverterOptionalString.write(value.address, buf)
        _UniffiFfiConverterOptionalString.write(value.specific_address, buf)
        _UniffiFfiConverterBoolean.write(value.is_transfer_student, buf)
        _UniffiFfiConverterString.write(value.apply_date, buf)
        _UniffiFfiConverterString.write(value.applied_collage, buf)
        _UniffiFfiConverterString.write(value.applied_department, buf)
        _UniffiFfiConverterOptionalString.write(value.plural_major, buf)
        _UniffiFfiConverterOptionalString.write(value.sub_major, buf)
        _UniffiFfiConverterOptionalString.write(value.connected_major, buf)
        _UniffiFfiConverterOptionalString.write(value.abeek, buf)
...
class _UniffiFfiConverterTypeStudentLifelongInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentLifelongInformation(
            apply_date=_UniffiFfiConverterOptionalString.read(buf),
            lifelong_type=_UniffiFfiConverterOptionalString.read(buf),
            qualification_number=_UniffiFfiConverterOptionalString.read(buf),
            qualification_date=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.apply_date)
        _UniffiFfiConverterOptionalString.check_lower(value.lifelong_type)
        _UniffiFfiConverterOptionalString.check_lower(value.qualification_number)
        _UniffiFfiConverterOptionalString.check_lower(value.qualification_date)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.apply_date, buf)
        _UniffiFfiConverterOptionalString.write(value.lifelong_type, buf)
        _UniffiFfiConverterOptionalString.write(value.qualification_number, buf)
        _UniffiFfiConverterOptionalString.write(value.qualification_date, buf)
...
class _UniffiFfiConverterTypeStudentTeachingMajorInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentTeachingMajorInformation(
            major_name=_UniffiFfiConverterOptionalString.read(buf),
            qualification_number=_UniffiFfiConverterOptionalString.read(buf),
            initiation_date=_UniffiFfiConverterOptionalString.read(buf),
            qualification_date=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.major_name)
        _UniffiFfiConverterOptionalString.check_lower(value.qualification_number)
        _UniffiFfiConverterOptionalString.check_lower(value.initiation_date)
        _UniffiFfiConverterOptionalString.check_lower(value.qualification_date)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.major_name, buf)
        _UniffiFfiConverterOptionalString.write(value.qualification_number, buf)
        _UniffiFfiConverterOptionalString.write(value.initiation_date, buf)
        _UniffiFfiConverterOptionalString.write(value.qualification_date, buf)

class _UniffiFfiConverterOptionalTypeStudentTeachingMajorInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiFfiConverterTypeStudentTeachingMajorInformation.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiFfiConverterTypeStudentTeachingMajorInformation.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiFfiConverterTypeStudentTeachingMajorInformation.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
...
class _UniffiFfiConverterTypeStudentTeachingPluralMajorInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class _UniffiFfiConverterOptionalTypeStudentTeachingPluralMajorInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiFfiConverterTypeStudentTeachingPluralMajorInformation.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiFfiConverterTypeStudentTeachingPluralMajorInformation.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiFfiConverterTypeStudentTeachingPluralMajorInformation.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")

class _UniffiFfiConverterOptionalTypeStudentLifelongInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiFfiConverterTypeStudentLifelongInformation.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiFfiConverterTypeStudentLifelongInformation.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiFfiConverterTypeStudentLifelongInformation.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")

class _UniffiFfiConverterOptionalTypeStudentForignStudyInformation(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiFfiConverterTypeStudentForignStudyInformation.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiFfiConverterTypeStudentForignStudyInformation.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiFfiConverterTypeStudentForignStudyInformation.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
...
class _UniffiFfiConverterTypeStudentQualification(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentQualification(
            teaching_major=_UniffiFfiConverterOptionalTypeStudentTeachingMajorInformation.read(buf),
            teaching_plural_major=_UniffiFfiConverterOptionalTypeStudentTeachingPluralMajorInformation.read(buf),
            lifelong=_UniffiFfiConverterOptionalTypeStudentLifelongInformation.read(buf),
            forign_study=_UniffiFfiConverterOptionalTypeStudentForignStudyInformation.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalTypeStudentTeachingMajorInformation.check_lower(value.teaching_major)
        _UniffiFfiConverterOptionalTypeStudentTeachingPluralMajorInformation.check_lower(value.teaching_plural_major)
        _UniffiFfiConverterOptionalTypeStudentLifelongInformation.check_lower(value.lifelong)
        _UniffiFfiConverterOptionalTypeStudentForignStudyInformation.check_lower(value.forign_study)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalTypeStudentTeachingMajorInformation.write(value.teaching_major, buf)
        _UniffiFfiConverterOptionalTypeStudentTeachingPluralMajorInformation.write(value.teaching_plural_major, buf)
        _UniffiFfiConverterOptionalTypeStudentLifelongInformation.write(value.lifelong, buf)
        _UniffiFfiConverterOptionalTypeStudentForignStudyInformation.write(value.forign_study, buf)
...
class _UniffiFfiConverterTypeStudentReligion(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentReligion(
            religion_type=_UniffiFfiConverterOptionalString.read(buf),
            start_date=_UniffiFfiConverterOptionalString.read(buf),
            church=_UniffiFfiConverterOptionalString.read(buf),
            church_man=_UniffiFfiConverterOptionalString.read(buf),
            baptism_level=_UniffiFfiConverterOptionalString.read(buf),
            baptism_grp=_UniffiFfiConverterOptionalString.read(buf),
            service_department=_UniffiFfiConverterOptionalString.read(buf),
            service_department_title=_UniffiFfiConverterOptionalString.read(buf),
            church_address=_UniffiFfiConverterOptionalString.read(buf),
            singeub=_UniffiFfiConverterOptionalString.read(buf),
            baptism_date=_UniffiFfiConverterOptionalString.read(buf),
            baptism_church=_UniffiFfiConverterOptionalString.read(buf),
            baptism_man=_UniffiFfiConverterOptionalString.read(buf),
            church_grp=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.religion_type)
        _UniffiFfiConverterOptionalString.check_lower(value.start_date)
        _UniffiFfiConverterOptionalString.check_lower(value.church)
        _UniffiFfiConverterOptionalString.check_lower(value.church_man)
        _UniffiFfiConverterOptionalString.check_lower(value.baptism_level)
        _UniffiFfiConverterOptionalString.check_lower(value.baptism_grp)
        _UniffiFfiConverterOptionalString.check_lower(value.service_department)
        _UniffiFfiConverterOptionalString.check_lower(value.service_department_title)
        _UniffiFfiConverterOptionalString.check_lower(value.church_address)
        _UniffiFfiConverterOptionalString.check_lower(value.singeub)
        _UniffiFfiConverterOptionalString.check_lower(value.baptism_date)
        _UniffiFfiConverterOptionalString.check_lower(value.baptism_church)
        _UniffiFfiConverterOptionalString.check_lower(value.baptism_man)
        _UniffiFfiConverterOptionalString.check_lower(value.church_grp)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.religion_type, buf)
        _UniffiFfiConverterOptionalString.write(value.start_date, buf)
        _UniffiFfiConverterOptionalString.write(value.church, buf)
        _UniffiFfiConverterOptionalString.write(value.church_man, buf)
        _UniffiFfiConverterOptionalString.write(value.baptism_level, buf)
        _UniffiFfiConverterOptionalString.write(value.baptism_grp, buf)
        _UniffiFfiConverterOptionalString.write(value.service_department, buf)
        _UniffiFfiConverterOptionalString.write(value.service_department_title, buf)
        _UniffiFfiConverterOptionalString.write(value.church_address, buf)
        _UniffiFfiConverterOptionalString.write(value.singeub, buf)
        _UniffiFfiConverterOptionalString.write(value.baptism_date, buf)
        _UniffiFfiConverterOptionalString.write(value.baptism_church, buf)
        _UniffiFfiConverterOptionalString.write(value.baptism_man, buf)
        _UniffiFfiConverterOptionalString.write(value.church_grp, buf)
...
class _UniffiFfiConverterTypeStudentResearchBankAccount(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class _UniffiFfiConverterTypeStudentTransferRecord(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentTransferRecord(
            is_transfer=_UniffiFfiConverterString.read(buf),
            admission_date=_UniffiFfiConverterString.read(buf),
            admission_grade=_UniffiFfiConverterString.read(buf),
            admission_term=_UniffiFfiConverterString.read(buf),
            accepted_credit=_UniffiFfiConverterString.read(buf),
            accepted_terms=_UniffiFfiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterString.check_lower(value.is_transfer)
        _UniffiFfiConverterString.check_lower(value.admission_date)
        _UniffiFfiConverterString.check_lower(value.admission_grade)
        _UniffiFfiConverterString.check_lower(value.admission_term)
        _UniffiFfiConverterString.check_lower(value.accepted_credit)
        _UniffiFfiConverterString.check_lower(value.accepted_terms)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterString.write(value.is_transfer, buf)
        _UniffiFfiConverterString.write(value.admission_date, buf)
        _UniffiFfiConverterString.write(value.admission_grade, buf)
        _UniffiFfiConverterString.write(value.admission_term, buf)
        _UniffiFfiConverterString.write(value.accepted_credit, buf)
        _UniffiFfiConverterString.write(value.accepted_terms, buf)

class _UniffiFfiConverterSequenceTypeStudentTransferRecord(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiFfiConverterTypeStudentTransferRecord.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiFfiConverterTypeStudentTransferRecord.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiFfiConverterTypeStudentTransferRecord.read(buf) for i in range(count)
        ]
...
class _UniffiFfiConverterTypeStudentTransferRecords(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentTransferRecords(
            records=_UniffiFfiConverterSequenceTypeStudentTransferRecord.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterSequenceTypeStudentTransferRecord.check_lower(value.records)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterSequenceTypeStudentTransferRecord.write(value.records, buf)
...
class _UniffiFfiConverterTypeStudentWorkInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return StudentWorkInformation(
            job=_UniffiFfiConverterOptionalString.read(buf),
            public_official=_UniffiFfiConverterOptionalString.read(buf),
            company_name=_UniffiFfiConverterOptionalString.read(buf),
            department_name=_UniffiFfiConverterOptionalString.read(buf),
            title=_UniffiFfiConverterOptionalString.read(buf),
            zip_code=_UniffiFfiConverterOptionalString.read(buf),
            address=_UniffiFfiConverterOptionalString.read(buf),
            specific_address=_UniffiFfiConverterOptionalString.read(buf),
            tel_number=_UniffiFfiConverterOptionalString.read(buf),
            fax_number=_UniffiFfiConverterOptionalString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiFfiConverterOptionalString.check_lower(value.job)
        _UniffiFfiConverterOptionalString.check_lower(value.public_official)
        _UniffiFfiConverterOptionalString.check_lower(value.company_name)
        _UniffiFfiConverterOptionalString.check_lower(value.department_name)
        _UniffiFfiConverterOptionalString.check_lower(value.title)
        _UniffiFfiConverterOptionalString.check_lower(value.zip_code)
        _UniffiFfiConverterOptionalString.check_lower(value.address)
        _UniffiFfiConverterOptionalString.check_lower(value.specific_address)
        _UniffiFfiConverterOptionalString.check_lower(value.tel_number)
        _UniffiFfiConverterOptionalString.check_lower(value.fax_number)

    @staticmethod
    def write(value, buf):
        _UniffiFfiConverterOptionalString.write(value.job, buf)
        _UniffiFfiConverterOptionalString.write(value.public_official, buf)
        _UniffiFfiConverterOptionalString.write(value.company_name, buf)
        _UniffiFfiConverterOptionalString.write(value.department_name, buf)
        _UniffiFfiConverterOptionalString.write(value.title, buf)
        _UniffiFfiConverterOptionalString.write(value.zip_code, buf)
        _UniffiFfiConverterOptionalString.write(value.address, buf)
        _UniffiFfiConverterOptionalString.write(value.specific_address, buf)
        _UniffiFfiConverterOptionalString.write(value.tel_number, buf)
        _UniffiFfiConverterOptionalString.write(value.fax_number, buf)
...
class _UniffiFfiConverterTypeCourseType(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
...
class _UniffiFfiConverterTypeLectureCategory(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
    ...
    def check_lower(value):
        ...
        if value.is_CONNECTED_MAJOR():
            _UniffiFfiConverterString.check_lower(value.major)
            return
    ...
    def write(value, buf):
        ...
        if value.is_CONNECTED_MAJOR():
            buf.write_i32(7)
            _UniffiFfiConverterString.write(value.major, buf)
        if value.is_UNITED_MAJOR():
            buf.write_i32(8)
            _UniffiFfiConverterString.write(value.major, buf)
        if value.is_FIND_BY_PROFESSOR():
...
class LectureCategoryBuilder(LectureCategoryBuilderProtocol):
    """
    새로운 `LectureCategory`를 만드는 빌더입니다.
"""
...
"""
        ...
        _uniffi_lift_return = _UniffiFfiConverterTypeLectureCategoryBuilder.lift
        _uniffi_error_converter = None
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_constructor_lecturecategorybuilder_new,
            *_uniffi_lowered_args,
        )
    ...
    def __del__(self):
        ...
        if handle is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_rusaint_fn_free_lecturecategorybuilder, handle)

    def _uniffi_clone_handle(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_rusaint_fn_clone_lecturecategorybuilder, self._handle)
...
"""
        ...
        _UniffiFfiConverterString.check_lower(lecture_name)
        _uniffi_lowered_args = (
            self._uniffi_clone_handle(),
            _UniffiFfiConverterString.lower(lecture_name),
        )
        _uniffi_lift_return = _UniffiFfiConverterTypeLectureCategory.lift
        _uniffi_error_converter = None
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_chapel,
            *_uniffi_lowered_args,
        )
...
"""
        ...
        _UniffiFfiConverterString.check_lower(major)
        _uniffi_lowered_args = (
            self._uniffi_clone_handle(),
            _UniffiFfiConverterString.lower(major),
        )
        _uniffi_lift_return = _UniffiFfiConverterTypeLectureCategory.lift
        _uniffi_error_converter = None
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_connected_major,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def cyber(self, ) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_cyber,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def education(self, ) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_education,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def find_by_lecture(self, keyword: str) -> LectureCategory:
...
"""
        ...
        _UniffiFfiConverterString.check_lower(keyword)
        _uniffi_lowered_args = (
            self._uniffi_clone_handle(),
            _UniffiFfiConverterString.lower(keyword),
        )
        _uniffi_lift_return = _UniffiFfiConverterTypeLectureCategory.lift
        _uniffi_error_converter = None
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_find_by_lecture,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def find_by_professor(self, keyword: str) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_find_by_professor,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def graduated(self, collage: str,department: str) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_graduated,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def major(self, collage: str,department: str,major: typing.Optional[str]) -> LectureCategory:
...
"""
        ...
        _UniffiFfiConverterOptionalString.check_lower(major)
        _uniffi_lowered_args = (
            self._uniffi_clone_handle(),
            _UniffiFfiConverterString.lower(collage),
            _UniffiFfiConverterString.lower(department),
            _UniffiFfiConverterOptionalString.lower(major),
        )
        _uniffi_lift_return = _UniffiFfiConverterTypeLectureCategory.lift
        _uniffi_error_converter = None
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_major,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def optional_elective(self, category: str) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_optional_elective,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def recognized_other_major(self, collage: str,department: str,major: typing.Optional[str]) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_recognized_other_major,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def required_elective(self, lecture_name: str) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_required_elective,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
    def united_major(self, major: str) -> LectureCategory:
...
"""
        ...
        _uniffi_ffi_result = _uniffi_rust_call_with_error(
            _uniffi_error_converter,
            _UniffiLib.uniffi_rusaint_fn_method_lecturecategorybuilder_united_major,
            *_uniffi_lowered_args,
        )
        return _uniffi_lift_return(_uniffi_ffi_result)
...
class _UniffiFfiConverterTypeLectureCategoryBuilder:
    @staticmethod
    def lift(value: int) -> LectureCategoryBuilder:
        return LectureCategoryBuilder._uniffi_make_instance(value)
    ...
    @staticmethod
    def lower(value: LectureCategoryBuilder) -> ctypes.c_uint64:
        return value._uniffi_clone_handle()

    @classmethod
    def read(cls, buf: _UniffiRustBuffer) -> LectureCategoryBuilder:
        ptr = buf.read_u64()
        if ptr == 0:
    ...
    @classmethod
    def write(cls, value: LectureCategoryBuilder, buf: _UniffiRustBuffer):
