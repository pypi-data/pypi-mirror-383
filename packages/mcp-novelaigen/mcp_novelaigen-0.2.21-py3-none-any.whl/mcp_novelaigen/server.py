...
async def call_tool(
    ...
    image_bytes, debug_logs = await generate_image_from_novelai(request.arguments, api_key)
    ...
    if image_bytes:
        ...
        return [TextContent(type="text", text=f"![](data:image/png;base64,{base64_image})")]
    else:
