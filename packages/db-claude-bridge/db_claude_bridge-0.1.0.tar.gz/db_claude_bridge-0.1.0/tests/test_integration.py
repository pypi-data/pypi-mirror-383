...
class TestIntegration:
    ...
    def test_package_importable(self):
        ...
        from db_claude_bridge.cli import cli
        from db_claude_bridge.exceptions import DatabricksClaudeError

    def test_cli_help(self):
        """Test that CLI help works."""
        result = subprocess.run([
            'python', '-m', 'db_claude_bridge.cli', '--help'
    ...
    def test_cli_version(self):
        ...
        result = subprocess.run([
            'python', '-m', 'db_claude_bridge.cli', '--version'
        ], capture_output=True, text=True)
    ...
    def test_status_command_real_databricks_cli(self):
        ...
        result = subprocess.run([
            'python', '-m', 'db_claude_bridge.cli', 'status'
        ], capture_output=True, text=True)
