...
class TestCLI:
    ...
    def test_version_flag(self):
        ...
        assert "db-claude-bridge 0.1.0" in result.output
    ...
    def test_login_command_already_authenticated(self, mock_subprocess):
        ...
        token_result.stdout = '{"access_token": "fake_test_token"}'
    ...
    def test_status_command_authenticated(self, mock_subprocess, temp_home):
        ...
        config_data = {
            "env": {
                ...
                "ANTHROPIC_BASE_URL": (
                    "https://example-workspace.databricks.com"
    ...
    def test_debug_flag(self):
        ...
        with patch('db_claude_bridge.core.DatabricksClaudeCore') as mock_core_class:
            mock_core = Mock()
