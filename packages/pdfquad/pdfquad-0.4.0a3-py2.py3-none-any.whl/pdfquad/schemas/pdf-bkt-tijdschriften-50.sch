<?xml version="1.0"?>
<!-- Schematron rules for BKT PDFs Tijdschriften-->

<s:schema xmlns:s="http://purl.oclc.org/dsdl/schematron">

<s:pattern>
    <s:title>BKT Tijdschriften profile checks</s:title>
    ...
    <s:rule context="//properties/meta">
        ...
        <s:assert test="(Keywords = 'Gedigitaliseerd door de Koninklijke Bibliotheek; Nederlandse geschiedenis; tijdschriften, historische tijdschriften, oude tijdschriften, archief tijdschriften, tijdschrift online, cultuur, letterkunde, religie, wetenschap, politiek, sport, economie')">Unexpected value of Keywords metadata field</s:assert>
        <!-- Check on encryption -->
