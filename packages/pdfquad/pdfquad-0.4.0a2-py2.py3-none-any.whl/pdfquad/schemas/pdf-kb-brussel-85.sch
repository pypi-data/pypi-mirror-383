...
<s:pattern>
    ...
    <s:rule context="//properties/pages/page/image">
        ...
        <!-- DISABLED because KB Brussel PDFs don't contain embedded ICC profiles -->
    ...
    <!-- DISABLED because PyMuDF only returns first Filter value, which for KB Brussel PDFs is ASCII85Decode -->
