...
def concatenate_clips(ws_config: actionstreamer.Config.WebServiceConfig, device_id: int, device_name: str, start_epoch: int, end_epoch: int, upload_url: str, postback_url: str, use_vrs: bool = False) -> WebServiceResult:
