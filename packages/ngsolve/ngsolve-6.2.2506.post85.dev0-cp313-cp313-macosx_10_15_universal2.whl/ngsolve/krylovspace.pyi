...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('clear_output', 'pre', 'sol', 'iterations', 'ax', 'callback', 'plt', '_final_residual', 'atol', 'printrates', 'its', 'residuals', 'display', 'callback_sol', 'ress', 'maxiter', 'mat', 'plotrates', 'fig', 'tol')
