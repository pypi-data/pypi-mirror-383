...
class WhosePIIGuardian:
    ...
    def __init__(
        ...
        # RunPod credentials for AnotiAI service (from environment variables)
        self.runpod_api_key = os.getenv("RUNPOD_API_KEY", "rpa_YDFRCFG9R883HO8IKLBIWGRZKV3P4D8B5301WFAM17ivxs")
        self.endpoint_id = os.getenv("RUNPOD_ENDPOINT_ID", "r2ol4vgslj001p")
