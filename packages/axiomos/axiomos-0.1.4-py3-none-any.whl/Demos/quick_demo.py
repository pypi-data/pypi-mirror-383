# -*- coding: utf-8 -*-
"""
demos.quick_demo : mini démo utilisable en 1 commande.
...
def _run_case(axir_name: str, buffer: str, a: str, b: str) -> bool:
    ...
    try:
        # droite (b) puis gauche (a) pour afficher le backend “intéressant”
        ...
        # Tolérant aux shapes : flatten si même nombre d’éléments
