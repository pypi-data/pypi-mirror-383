...
class CostStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_aks_data = channel.unary_stream(
...
def add_CostServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_aks_data': grpc.unary_stream_rpc_method_handler(
...
class Cost(object):
    ...
    def get_aks_data(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/spaceone.api.cost_analysis.plugin.Cost/get_aks_data',
