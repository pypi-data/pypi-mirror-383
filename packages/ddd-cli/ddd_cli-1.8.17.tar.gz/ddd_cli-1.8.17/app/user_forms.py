...
class UserBaseForm(forms.Form):
    """
    Formulario base para la entidad user.
    """
...
class UserCreateForm(UserBaseForm):
    """
    Formulario para crear una nueva instancia de user. Sin modificaciones adicionales.
    """
...
class UserEditGetForm(UserBaseForm):
    """
    Formulario para editar mediante GET una instancia de user. 
    """
...
class UserEditPostForm(UserBaseForm):
    """
    Formulario para editar mediante POST una instancia de user. 
    """
...
class UserViewForm(UserBaseForm):
    """
    Formulario de solo lectura para Visualizar una instancia de user
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
