...
class DatasetUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "autoAddImportTimestamp", "autoAddImportJobId", "schema", "timePartitioning", "rangePartitioning", "clustering", "writeDisposition", "importable"]
