...
class DatasetImportFromGCSCreate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "maxBadRecords", "sourceFormat", "csvOptions", "withSnapshot", "sourceUri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasetImportFromGCSCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasetImportFromGCSCreate from a dict"""
        if obj is None:
            return None
