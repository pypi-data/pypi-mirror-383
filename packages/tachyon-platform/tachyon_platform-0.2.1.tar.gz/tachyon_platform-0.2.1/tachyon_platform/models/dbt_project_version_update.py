...
class DbtProjectVersionUpdate(BaseModel):
    """
    DbtProjectVersionUpdate
    """ # noqa: E501
    default_run_parameter: Optional[DbtProjectRunParameter] = Field(default=None, alias="defaultRunParameter")
    __properties: ClassVar[List[str]] = ["defaultRunParameter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbtProjectVersionUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbtProjectVersionUpdate from a dict"""
        if obj is None:
            return None
