...
class DbtProjectRunCreate(BaseModel):
    """
    DbtProjectRunCreate
    """ # noqa: E501
    ...
    parameter: Optional[DbtProjectRunParameter] = None
    __properties: ClassVar[List[str]] = ["versionId", "parameter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbtProjectRunCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbtProjectRunCreate from a dict"""
        if obj is None:
            return None
