...
class DatasetCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "createdBy", "autoAddImportTimestamp", "autoAddImportJobId", "schema", "timePartitioning", "rangePartitioning", "clustering", "writeDisposition", "importable"]
