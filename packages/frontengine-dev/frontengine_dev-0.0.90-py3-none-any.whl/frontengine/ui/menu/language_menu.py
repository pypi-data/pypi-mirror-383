...
def build_language_menu(ui_we_want_to_set: FrontEngineMainUI) -> None:
    front_engine_logger.info(f"language_menu.py build_language_menu ui_we_want_to_set: {ui_we_want_to_set}")
...
def set_language(language: str, ui_we_want_to_set: FrontEngineMainUI) -> None:
    front_engine_logger.info("language_menu.py set_language "
