...
from bear_dereth.datastore import BearBase, ValueType
...
class SettingsModel(BaseModel):
    ...
    def as_record(self, key: str, value: Any, cls_type: object) -> Record:
...
class BearSettings[T: BearBase]:
    ...
    def set(self, key: str, value: Any) -> None:
        """Set a setting value."""
        record: Record = self._default_table.as_record(key, value, type(value))
    ...
    def get_as_type[V: ValueType](self, key: str, to_type: Callable[[ValueType], V], default: Any = None) -> V:
