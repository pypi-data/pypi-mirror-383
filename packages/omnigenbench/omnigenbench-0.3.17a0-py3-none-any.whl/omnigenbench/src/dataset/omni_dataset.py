...
class OmniDatasetForTokenClassification(OmniDataset):
    ...
    def __init__(self, dataset_name, tokenizer, max_length=None, **kwargs):
        ...
        Args:
            dataset_name (str or list): Path(s) to the dataset file(s). Formats supported
        ...
        super(OmniDatasetForTokenClassification, self).__init__(
            dataset_name, tokenizer, max_length, **kwargs
        )
...
class OmniDatasetForSequenceClassification(OmniDataset):
    ...
    def __init__(self, dataset_name, tokenizer, max_length=None, **kwargs):
        ...
        Args:
            dataset_name: Path to the data file or a list of paths.
...
class OmniDatasetForMultiLabelClassification(OmniDataset):
    ...
    def __init__(
        self, dataset_name, tokenizer, max_length=None, label_indices=None, **kwargs
    ):
        """
