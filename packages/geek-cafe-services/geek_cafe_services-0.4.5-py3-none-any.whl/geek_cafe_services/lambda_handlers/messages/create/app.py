...
def create_message(
    ...
    # The service now handles the entire payload, decoupling the handler
    # from the specific model fields.
    result = service.create(
        tenant_id=tenant_id,
        user_id=user_id,      # The creator's ID
        payload=payload       # The full request body
    )
