...
class AlgebraicRecon(Recon):
    ...
    def plot_MSE(self, isSaving=True, log_scale_x=False, log_scale_y=False):
        ...
        if isSaving and self.saveDir is not None:
            ...
            if log_scale_x and log_scale_y:
                ...
                scale_str = "_logy"
            SavingFolder = os.path.join(self.saveDir, f'{self.SMatrix.shape[3]}_SCANS_MSE_plot_{self.optimizer.name}{scale_str}{date_str}.png')
    ...
    def checkExistingFile(self, date):
        """
