...
from . import Analytics, empty_dataframe_from_type, migrate_table_schema
...
class Database:
    def __init__(
        ...
        self._default_columns = ["created_at", "created_by", "modified_at",
                                 "modified_by"]  # TODO: Add default column support in schema class declaration
        self._unique_keys = {}
        self._schemas = {}

        # initialize schema for each table
        for item in self.__annotations__.items():
            ...
            df.insert(0, 'created_at', pd.Series(dtype='str'))  # TODO: integrate this into empty_dataframe_from_type
    ...
    def read(self, table_name: str, **conditions) -> pd.DataFrame:
        ...
        Returns all records if no conditions are specified, otherwise filters by exact matches
