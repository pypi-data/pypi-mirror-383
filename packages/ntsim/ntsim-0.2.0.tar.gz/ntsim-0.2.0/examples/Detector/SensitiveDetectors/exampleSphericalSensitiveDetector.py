...
def displaySphereandSegments(opts):
    ...
    detector = SphericalSensitiveDetector(uid=0, position=np.array(opts.center), radius=opts.radius, parent=None)
    ...
    def add_segments_to_view(window, detector, center, radius, num_segments, should_intersect, color_if_correct, color_if_incorrect):
        ...
        for i in range(num_segments):
            ...
            if intersection[0] == should_intersect:  # If the intersection result is as expected
