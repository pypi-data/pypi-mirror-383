...
htmlhelp_basename = 'esxi-utilsdoc'
...
latex_documents = [
    (master_doc, 'esxi-utils.tex', 'esxi-utils Documentation',
...
man_pages = [
    (master_doc, 'esxi-utils', 'esxi-utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'esxi-utils', 'esxi-utils Documentation',
     author, 'esxi-utils', 'One line description of project.',
     'Miscellaneous'),
]
