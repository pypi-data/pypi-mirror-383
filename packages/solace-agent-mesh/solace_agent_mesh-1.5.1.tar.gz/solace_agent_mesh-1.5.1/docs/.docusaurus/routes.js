...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', '682'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', '83f'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', '040'),
            routes: [
              {
