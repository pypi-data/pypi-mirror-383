...
class TestDDCAL(unittest.TestCase):
    ...
    # frequencies = np.load("./data/edge_case_one_data_element.npy")  # parameters don't matter (1 element with value 10)
    # frequencies = np.load("./data/edge_case_constant_data.npy")  # parameters don't matter (1000 elements with value 10)
