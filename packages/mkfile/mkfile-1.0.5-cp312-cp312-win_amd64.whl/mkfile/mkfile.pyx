...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  mkfile file.txt                       # Create single file
  mkfile file1.txt file2.py file3       # Create multiple files
  mkfile dir/subdir/file.txt            # Create with directories
  mkfile dir/{a,b,c}.txt                # Brace expansion (creates dir/a.txt, dir/b.txt, dir/c.txt)
  mkfile dotenv/{__init__.py,core.py}   # Create package structure
...
Note: Use forward slashes (/) for directories, even on Windows.
    ...
    parser.add_argument(
        '--version',
        action='version',
        version=f'mkfile v{__version__} by Hadi Cahyadi (cumulus13@gmail.com)'
    )
