...
Refer to the Terraform Registry for docs: [`data_aws_route53_records`](https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/route53_records).
'''
...
class DataAwsRoute53Records(
    ...
    def __init__(
        ...
        *,
        ...
        :param zone_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/route53_records#zone_id DataAwsRoute53Records#zone_id}.
        :param name_regex: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/route53_records#name_regex DataAwsRoute53Records#name_regex}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataAwsRoute53Records that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/route53_records#import import section} in the documentation of this resource for the id to use
