...
class EIS(ACIR):
    ...
    def run_with_switching(
        ...
        Raises:
            ...
            ValueError: If configuration parameters are present that would
                cause measurement errors across the frequency range.
            AttributeError: If frequency sweep characteristics are missing or improperly
                formatted in the test parameters.
            nidcpower.errors.InvalidPropertyValueError: If device configuration fails for
                any frequency point due to incompatible parameter combinations.
