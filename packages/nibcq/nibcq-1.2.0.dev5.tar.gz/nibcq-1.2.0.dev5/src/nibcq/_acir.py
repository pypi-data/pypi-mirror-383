...
class ACIR(Measurement):
    ...
    def run(self, compensation: Compensation) -> SMUResult:
        ...
        Configures the device, performs the measurement, applies compensation if specified,
    ...
    def run_with_switching(self, compensation: Compensation) -> list[tuple[SMUCellData, SMUResult]]:
        ...
        Raises:
            ...
            ValueError: If test_frequency is out of bounds or test_parameters contain
                invalid values that would cause measurement errors.
            nidcpower.errors.InvalidPropertyValueError: If device configuration fails
                due to incompatible parameter combinations.
    ...
    def write_compensation_file(
        ...
        compensation = Compensation(
            ...
            target_temperature=self.temperature_measurement,
