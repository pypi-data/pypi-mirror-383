...
class FanController:
    ...
    #    fan_type: FanType = FanType.FAN_80MM,
    # ) -> IndexedModule:
    #    """
    #    If a single float is provided for a layer, it will be expanded to all fans in that layer.
    #    """
    #    if fan_type == FanType.FAN_80MM:
    #        self.__create_80mm_module_to_set(
    #            flat_index=flat_index,
    #            pwms_downstream_layer=pwms_downstream_layer,
    #            pwms_upstream_layer=pwms_upstream_layer,
    #        )
    #    elif fan_type == FanType.FAN_240MM:
    #        self.__create_240mm_module_to_set(
    #            flat_index=flat_index,
    #            pwm=pwms_downstream_layer,  # type: ignore[arg-type]
    #        )

    #    # Scale every values from 0-100 float to 0-1000 int
