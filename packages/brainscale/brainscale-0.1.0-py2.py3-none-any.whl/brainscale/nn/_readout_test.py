...
class TestLeakyRateReadout:
    ...
    def test_leaky_rate_readout_basic_creation(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=256, out_size=10)
    ...
    def test_leaky_rate_readout_default_tau(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=128, out_size=10)
    ...
    def test_leaky_rate_readout_custom_tau(self):
        ...
        tau_value = 10.0 * u.ms
        readout = brainscale.nn.LeakyRateReadout(in_size=128, out_size=10, tau=tau_value)
        assert readout.tau is not None
    ...
    def test_leaky_rate_readout_state_accumulation(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=64, out_size=8, tau=10.0 * u.ms)
    ...
    def test_leaky_rate_readout_custom_w_init(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(
            in_size=128,
            out_size=10,
    ...
    def test_leaky_rate_readout_large_dimensions(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=2048, out_size=512)
    ...
    def test_leaky_rate_readout_small_dimensions(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=4, out_size=2)
    ...
    def test_leaky_rate_readout_deterministic_with_seed(self):
        ...
        readout1 = brainscale.nn.LeakyRateReadout(in_size=128, out_size=10)
        readout1.init_state(batch_size=16)

        brainstate.random.seed(42)
        readout2 = brainscale.nn.LeakyRateReadout(in_size=128, out_size=10)
...
class TestLeakySpikeReadout:
    ...
    def test_leaky_spike_readout_basic_creation(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=512, out_size=10)
        assert hasattr(readout, 'in_size')
        assert hasattr(readout, 'out_size')
        assert hasattr(readout, 'tau')
    ...
    def test_leaky_spike_readout_default_params(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=256, out_size=10)
        assert readout.tau is not None
    ...
    def test_leaky_spike_readout_custom_tau(self):
        ...
        tau_value = 10.0 * u.ms
        readout = brainscale.nn.LeakySpikeReadout(
            in_size=256,
            out_size=10,
            tau=tau_value
        )
    ...
    def test_leaky_spike_readout_get_spike_property(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=128, out_size=10)
        readout.init_state(batch_size=16)
        print(readout.V)
    ...
    def test_leaky_spike_readout_large_dimensions(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=2048, out_size=512)
        readout.init_state(batch_size=8)
    ...
    def test_leaky_spike_readout_small_dimensions(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=8, out_size=4)
        readout.init_state(batch_size=2)
    ...
    def test_leaky_spike_readout_deterministic_with_seed(self):
        ...
        brainstate.random.seed(42)
        readout1 = brainscale.nn.LeakySpikeReadout(in_size=256, out_size=10)
        readout1.init_state(batch_size=32)

        brainstate.random.seed(42)
        readout2 = brainscale.nn.LeakySpikeReadout(in_size=256, out_size=10)
...
class TestReadoutIntegration:
    ...
    def test_rate_and_spike_readout_together(self):
        ...
        # Rate readout
        rate_readout = brainscale.nn.LeakyRateReadout(in_size=256, out_size=128)
        rate_readout.init_state(batch_size=16)

        # Spike readout
        spike_readout = brainscale.nn.LeakySpikeReadout(in_size=128, out_size=10)
    ...
    def test_multiple_rate_readouts_stacked(self):
        ...
        readout1 = brainscale.nn.LeakyRateReadout(in_size=256, out_size=128)
        readout2 = brainscale.nn.LeakyRateReadout(in_size=128, out_size=64)
        readout3 = brainscale.nn.LeakyRateReadout(in_size=64, out_size=10)
    ...
    def test_multiple_spike_readouts_stacked(self):
        ...
        readout1 = brainscale.nn.LeakySpikeReadout(in_size=256, out_size=128)
        readout2 = brainscale.nn.LeakySpikeReadout(in_size=128, out_size=64)
        readout3 = brainscale.nn.LeakySpikeReadout(in_size=64, out_size=10)
    ...
    def test_rate_readout_gradient_flow(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=64, out_size=10)
        readout.init_state(batch_size=8)
    ...
    def test_spike_readout_gradient_flow(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=64, out_size=10)
        readout.init_state(batch_size=8)
    ...
    def test_rate_readout_state_persistence(self):
        ...
        readout = brainscale.nn.LeakyRateReadout(in_size=32, out_size=8)
        readout.init_state(batch_size=4)
    ...
    def test_spike_readout_state_persistence(self):
        ...
        readout = brainscale.nn.LeakySpikeReadout(in_size=32, out_size=8)
        readout.init_state(batch_size=4)
    ...
    def test_readout_batch_consistency(self):
        ...
        rate_readout = brainscale.nn.LeakyRateReadout(in_size=64, out_size=10)
        spike_readout = brainscale.nn.LeakySpikeReadout(in_size=64, out_size=10)
