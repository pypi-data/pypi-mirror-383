...
class TestValinaRNNCell:
    ...
    def test_valina_rnn_basic_creation(self):
        ...
        cell = brainscale.nn.ValinaRNNCell(in_size=32, out_size=64)
    ...
    def test_valina_rnn_custom_activation(self):
        ...
        cell = brainscale.nn.ValinaRNNCell(in_size=32, out_size=64, activation='tanh')
        cell.init_state(batch_size=8)
        x = brainstate.random.randn(8, 32)
        h = cell(x)
        assert h.shape == (8, 64)
    ...
    def test_valina_rnn_callable_activation(self):
        ...
        cell = brainscale.nn.ValinaRNNCell(
            in_size=32,
            out_size=64,
    ...
    def test_valina_rnn_with_name(self):
        ...
        cell = brainscale.nn.ValinaRNNCell(in_size=32, out_size=64, name="test_rnn")
...
class TestGRUCell:
    ...
    def test_gru_basic_creation(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=128, out_size=256)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
    ...
    def test_gru_sequential_updates(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=64, out_size=128)
        cell.init_state(batch_size=8)
    ...
    def test_gru_custom_activation(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=64, out_size=128, activation='relu')
        cell.init_state(batch_size=8)
        x = brainstate.random.randn(8, 64)
        h = cell(x)
    ...
    def test_gru_with_name(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=64, out_size=128, name="test_gru")
...
class TestMGUCell:
    ...
    def test_mgu_basic_creation(self):
        ...
        cell = brainscale.nn.MGUCell(in_size=96, out_size=192)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
    ...
    def test_mgu_sequential_updates(self):
        ...
        cell = brainscale.nn.MGUCell(in_size=48, out_size=96)
...
class TestLSTMCell:
    ...
    def test_lstm_basic_creation(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=256, out_size=512)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
    ...
    def test_lstm_sequential_updates(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=128, out_size=256)
    ...
    def test_lstm_custom_activation(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=64, out_size=128, activation='relu')
        cell.init_state(batch_size=8)
        x = brainstate.random.randn(8, 64)
        h = cell(x)
        assert h.shape == (8, 128)
    ...
    def test_lstm_with_name(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=64, out_size=128, name="test_lstm")
...
class TestMinimalRNNCell:
    ...
    def test_minimal_rnn_basic_creation(self):
        ...
        cell = brainscale.nn.MinimalRNNCell(in_size=100, out_size=200)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
    ...
    def test_minimal_rnn_sequential_updates(self):
        ...
        cell = brainscale.nn.MinimalRNNCell(in_size=50, out_size=100)
        cell.init_state(batch_size=12)
...
class TestMiniGRU:
    ...
    def test_minigru_basic_creation(self):
        ...
        cell = brainscale.nn.MiniGRU(in_size=80, out_size=160)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
    ...
    def test_minigru_sequential_updates(self):
        ...
        cell = brainscale.nn.MiniGRU(in_size=40, out_size=80)
        cell.init_state(batch_size=16)
...
class TestMiniLSTM:
    ...
    def test_minilstm_basic_creation(self):
        ...
        cell = brainscale.nn.MiniLSTM(in_size=150, out_size=300)
        assert hasattr(cell, 'in_size')
        assert hasattr(cell, 'out_size')
        assert hasattr(cell, 'W_x')
    ...
    def test_minilstm_sequential_updates(self):
        ...
        cell = brainscale.nn.MiniLSTM(in_size=75, out_size=150)
        cell.init_state(batch_size=20)
...
class TestLRUCell:
    ...
    def test_lru_basic_creation(self):
        ...
        cell = brainscale.nn.LRUCell(d_model=64, d_hidden=128)
    ...
    def test_lru_sequential_updates(self):
        ...
        cell = brainscale.nn.LRUCell(d_model=32, d_hidden=64)
        cell.init_state(batch_size=8)
...
class TestRNNCellIntegration:
    ...
    def test_different_batch_sizes(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=32, out_size=64)
    ...
    def test_sequence_processing(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=64, out_size=128)
        cell.init_state(batch_size=8)
    ...
    def test_deterministic_with_seed(self):
        ...
        cell1 = brainscale.nn.GRUCell(in_size=32, out_size=64)
        cell1.init_state(batch_size=8)

        brainstate.random.seed(42)
        cell2 = brainscale.nn.GRUCell(in_size=32, out_size=64)
    ...
    def test_mixed_cell_types(self):
        ...
        gru_cell = brainscale.nn.GRUCell(in_size=64, out_size=128)
        lstm_cell = brainscale.nn.LSTMCell(in_size=128, out_size=256)
    ...
    def test_large_dimensions(self):
        ...
        cell = brainscale.nn.LSTMCell(in_size=1024, out_size=2048)
        cell.init_state(batch_size=4)
    ...
    def test_small_dimensions(self):
        ...
        cell = brainscale.nn.GRUCell(in_size=4, out_size=8)
    ...
    def test_batch_size_consistency(self):
        ...
        cells = [
            brainscale.nn.ValinaRNNCell(in_size=32, out_size=64),
            brainscale.nn.GRUCell(in_size=32, out_size=64),
            brainscale.nn.MGUCell(in_size=32, out_size=64),
            brainscale.nn.LSTMCell(in_size=32, out_size=64),
        ]
