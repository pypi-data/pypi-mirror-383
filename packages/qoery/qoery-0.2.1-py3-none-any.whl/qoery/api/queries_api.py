...
class QueriesApi:
    ...
    def query_nl_post(
        self,
        query_nl_post_request: Annotated[QueryNlPostRequest, Field(description="Provide JSON body.")],
        ...
        :param query_nl_post_request: Provide JSON body. (required)
    ...
    def query_sql_post(
        self,
        query_sql_post_request: Annotated[QuerySqlPostRequest, Field(description="Provide JSON body with 'query' field.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param query_sql_post_request: Provide JSON body with 'query' field. (required)
