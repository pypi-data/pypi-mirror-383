...
class UsageGet200ResponseEndpoints(BaseModel):
    ...
    sql: UsageGet200ResponseEndpointsNl
    scrape: UsageGet200ResponseEndpointsNl
    __properties: ClassVar[List[str]] = ["nl", "sql", "scrape"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sql": UsageGet200ResponseEndpointsNl.from_dict(obj["sql"]) if obj.get("sql") is not None else None,
