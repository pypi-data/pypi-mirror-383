...
class QueryNlPost200Response(BaseModel):
    """
    Response from query endpoints (both natural language and SQL)
    """ # noqa: E501
    sql_query: StrictStr = Field(description="The SQL query that was executed or generated")
    ...
    __properties: ClassVar[List[str]] = ["sql_query", "series", "meta", "description"]
