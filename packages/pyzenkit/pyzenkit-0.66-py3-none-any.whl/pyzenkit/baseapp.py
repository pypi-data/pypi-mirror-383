...
Application actions
    ...
    validating configuration without executing the application itself and so on.
    There is a number of built-in actions and more can be implemented very easily.
...
class BaseApp:  # pylint: disable=locally-disabled,too-many-public-methods, too-many-instance-attributes
    ...
    def error(self, error, retc = None, trcb = None):
        ...
        and generating the traceback when required.
