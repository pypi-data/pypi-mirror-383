...
class ConfigurationMapper:
    ...
    def _map_instance_defaults(self, data: Dict[str, Any]) -> InstanceDefaults:
        ...
        return InstanceDefaults(
            ...
            domain=self._map_domain(data.get("domain")) if "domain" in data else None,
    ...
    def _map_instance(self, data: Dict[str, Any]) -> Instance:
        ...
        if "domain" not in data:
            raise ValueError("domain is required for instance")
        ...
        return Instance(
            ...
            domain=self._map_domain(data["domain"]),
