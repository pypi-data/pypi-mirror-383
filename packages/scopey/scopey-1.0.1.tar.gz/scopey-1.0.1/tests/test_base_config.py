...
class TestGetParamValue:
    ...
    def test_get_param_value_global_in_local_raises_error(self):
        ...
        data = {"global": {}, "database": {"username": "admin"}}
    ...
    def test_get_param_value_local_in_global_raises_error(self):
        ...
        data = {"global": {"host": "localhost"}, "database": {}}
...
class TestToDict:
    ...
    def test_to_dict_include_global_section_false(self, database_config):
        """Test to_dict excludes global section when include_global_section=False"""
        result = database_config.to_dict(include_global_section=False)
