...
class ImportRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: TestExport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[int]:
        """
    ...
    async def put(self,body: TestExport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[int]:
        """
    ...
    def to_put_request_information(self,body: TestExport, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Update an existing Test using its exported version
        param body: Represents a Test with all associated data used for export/import operations.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
