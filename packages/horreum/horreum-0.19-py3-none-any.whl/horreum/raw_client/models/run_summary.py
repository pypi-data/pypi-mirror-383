...
if TYPE_CHECKING:
    from .run_summary_access import RunSummary_access
...
class RunSummary(AdditionalDataHolder, Parsable):
    ...
    access: Optional[RunSummary_access] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "access": lambda n : setattr(self, 'access', n.get_enum_value(RunSummary_access)),
