...
@dataclass
class PostgresDatastoreConfig_authentication(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PostgresDatastoreConfig_authentication:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PostgresDatastoreConfig_authentication
        """
        ...
        try:
            ...
            mapping_value = None
        result = PostgresDatastoreConfig_authentication()
