...
if TYPE_CHECKING:
    from .elasticsearch_datastore_config_authentication import ElasticsearchDatastoreConfig_authentication
...
class ElasticsearchDatastoreConfig(AdditionalDataHolder, Parsable):
    ...
    authentication: Optional[ElasticsearchDatastoreConfig_authentication] = None
    # Built In
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "authentication": lambda n : setattr(self, 'authentication', n.get_object_value(ElasticsearchDatastoreConfig_authentication)),
