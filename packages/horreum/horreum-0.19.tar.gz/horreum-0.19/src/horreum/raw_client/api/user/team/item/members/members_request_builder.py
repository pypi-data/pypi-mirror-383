...
if TYPE_CHECKING:
    ...
    from .members_post_request_body import MembersPostRequestBody

class MembersRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/user/team/{team}/members
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/user/team/{team}/members", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MembersGetResponse]:
        ...
        return await self.request_adapter.send_async(request_info, MembersGetResponse, None)
    
    async def post(self,body: MembersPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        """
    ...
    def to_post_request_information(self,body: MembersPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Set the membership of a given team.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
