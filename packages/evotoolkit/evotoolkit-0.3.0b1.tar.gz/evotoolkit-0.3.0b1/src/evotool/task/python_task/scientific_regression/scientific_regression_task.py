...
from evotool.core import Solution, EvaluationResult
from evotool.task.python_task.python_task import PythonTask
from evotool.registry import register_task
...
class ScientificRegressionTask(PythonTask):
    ...
    def _load_dataset(self, dataset_name: str, data_dir: str | Path | None):
        ...
        """
        from evotool.data import get_dataset_path, DownloadError
        ...
        if not dataset_path.exists():
            raise FileNotFoundError(
                ...
                f"https://github.com/pgg3/evotool/issues"
            )
