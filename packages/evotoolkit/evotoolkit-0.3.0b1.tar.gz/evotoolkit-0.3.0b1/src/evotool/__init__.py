...
from evotool.registry import (
    get_algorithm_info,
    infer_algorithm_from_interface,
    list_tasks,
    list_algorithms
)
from evotool.core import BaseMethodInterface

# Import tasks and algorithms to trigger registration decorators
from evotool.evo_method.eoh import EoH
from evotool.evo_method.evoengineer import EvoEngineer
from evotool.evo_method.funsearch import FunSearch
