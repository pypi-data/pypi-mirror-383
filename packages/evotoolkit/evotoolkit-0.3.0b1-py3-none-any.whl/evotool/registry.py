...
from evotool.core import BaseTask, BaseMethodInterface
...
def get_interface_class(algorithm_name: str, task: BaseTask) -> Type[BaseMethodInterface]:
    ...
    """
    from evotool.task.python_task import PythonTask
    ...
    if isinstance(task, PythonTask):
        ...
        try:
            from evotool.task.cuda_engineering import CudaTaskConfig
