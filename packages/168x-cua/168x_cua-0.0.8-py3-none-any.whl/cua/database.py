...
#     Resolution order:
#       1) Environment variable ``CUA_DB_PATH`` if set
#       2) ``~/.cua/cua.sqlite3`` (directory will be created if missing)
#     """
#     env_path = os.getenv("CUA_DB_PATH")
#     if env_path:
#         path = Path(env_path).expanduser()
#     else:
#         path = Path.home() / ".cua" / "cua.sqlite3"
...
#     logger.debug("SQLite database initialized at %s", get_db_path())
