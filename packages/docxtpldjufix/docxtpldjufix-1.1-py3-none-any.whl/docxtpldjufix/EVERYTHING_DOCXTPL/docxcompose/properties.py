...
class CustomProperties(object):
    ...
    def _part_template(self):
        ref = importlib.resources.files('docxcompose').joinpath('templates/custom.xml') #return pkg_resources.resource_string(
        return ref.read_bytes()    #'docxcompose', 'templates/custom.xml')
