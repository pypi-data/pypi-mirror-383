...
def list_ai_agents() -> List[Dict[str, Any]]:
    return aiagents.list_ai_agents()
...
def create_ai_agent(
    ...
    return aiagents.create_ai_agent(name, model, instructions)


@mcp.tool()
def delete_ai_agent(agent_id: str) -> Dict[str, Any]:
    return aiagents.delete_ai_agent(agent_id)
...
def invoke_ai_agent(
    ...
    return aiagents.invoke_ai_agent(agent_id, user_message, thread_id)
