...
BEFORE_ALL_PLACE_HOLDER        = generate_random_sequence(64)
AFTER_ALL_PLACE_HOLDER         = generate_random_sequence(64)
BEFORE_CONTENT_PLACE_HOLDER    = generate_random_sequence(64)
AFTER_CONTENT_PLACE_HOLDER     = generate_random_sequence(64)
...
<html>
<!--
    BEFORE_ALL_PLACE_HOLDER: {BEFORE_ALL_PLACE_HOLDER}
    AFTER_ALL_PLACE_HOLDER: {AFTER_ALL_PLACE_HOLDER}
    BEFORE_CONTENT_PLACE_HOLDER: {BEFORE_CONTENT_PLACE_HOLDER}
    AFTER_CONTENT_PLACE_HOLDER: {AFTER_CONTENT_PLACE_HOLDER}
-->
<head>
<meta charset="utf-8">
{STYLE}
...
<!--{BEFORE_ALL_PLACE_HOLDER}-->
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0">
<!--{BEFORE_CONTENT_PLACE_HOLDER}-->
        
{html_content}

<!--{AFTER_CONTENT_PLACE_HOLDER}-->
</div>
{CDN}
<script>
    // init all code block
