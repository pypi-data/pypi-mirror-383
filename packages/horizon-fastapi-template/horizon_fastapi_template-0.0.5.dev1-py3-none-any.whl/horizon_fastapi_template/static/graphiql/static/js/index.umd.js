(function(z, W) {
    typeof exports == "object" && typeof module < "u" ? W(exports, require("@graphiql/react"), require("react"), require("graphql")) : typeof define == "function" && define.amd ? define(["exports", "@graphiql/react", "react", "graphql"], W) : (z = typeof globalThis < "u" ? globalThis : z || self,
    W(z.GraphiQLPluginExplorer = {}, z.GraphiQL.React, z.React, z.GraphiQL.GraphQL))
}
    ...
    var je = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(i) {
        return typeof i
    }
    : function(i) {
      ...
      , ye = function() {
        function i(t, s) {
            var n = []
              ...
              , c = void 0;
            try {
                for (var f = t[Symbol.iterator](), u; !(e = (u = f.next()).done) && (n.push(u.value),
                !(s && n.length === s)); e = !0)
                    ;
            } catch (r) {
                l = !0,
    ...
    function I(i) {
        if (Array.isArray(i)) {
            for (var t = 0, s = Array(i.length); t < i.length; t++)
                s[t] = i[t];
            return s
        } else
            return Array.from(i)
    ...
    function ae(i) {
        return i.checked ? i.styleConfig.checkboxChecked : i.styleConfig.checkboxUnchecked
    }
    function be(i) {
        var t = i.getFields();
        if (t.id) {
            var s = ["id"];
            return t.email ? s.push("email") : t.name && s.push("name"),
            s
        }
        if (t.edges)
            return ["edges"];
        ...
        return Object.keys(t).forEach(function(e) {
            (0,
            v.isLeafType)(t[e].type) && n.push(e)
        }),
        n.length ? n.slice(0, 2) : ["__typename"]
    }
    function Se(i) {
        return (0,
        v.isNonNullType)(i.type) && i.defaultValue === void 0
    }
    function ze(i) {
        for (var t = i; (0,
        v.isWrappingType)(t); )
    ...
    function ke(i, t) {
        ...
        v.isScalarType)(i))
            try {
                ...
                return console.error("error coercing arg value", e, t),
                {
                    kind: "StringValue",
                    value: t
                }
    ...
    var Ge = function(i) {
        ...
        function t() {
            ...
            for (var c = arguments.length, f = Array(c), u = 0; u < c; u++)
                f[u] = arguments[u];
            return l = (n = (e = w(this, (s = t.__proto__ || Object.getPrototypeOf(t)).call.apply(s, [this].concat(f))),
            e),
            ...
            e._removeArg = function() {
                ...
                e.props.modifyFields(r.fields.filter(function(p) {
                    return p !== o
                }), !0)
            }
            ,
            e._addArg = function() {
                var r = e.props
                  ...
                  , d = Q(p.type)
                  , b = null;
                if (e._previousArgSelection)
                    b = e._previousArgSelection;
                else if ((0,
                v.isInputObjectType)(d)) {
                    var g = d.getFields();
                    b = {
                        kind: "ObjectField",
                        name: {
                        ...
                        value: {
                            kind: "ObjectValue",
                            fields: oe(m, F, h, Object.keys(g).map(function(C) {
                                return g[C]
                            }))
                        }
                    }
                ...
                if (!b)
                    console.error("Unable to add arg for argType", d);
                else
                    return e.props.modifyFields([].concat(I(o.fields || []), [b]), !0)
            }
            ,
            e._setArgValue = function(r, o) {
                var p = !1
                  ...
                  , h = !1;
                try {
                    r.kind === "VariableDefinition" ? m = !0 : r === null || typeof r > "u" ? p = !0 : typeof r.kind == "string" && (h = !0)
                } catch {}
                ...
                var b = Q(e.props.arg.type)
                  , g = (0,
                v.isLeafType)(b) || m || p || h;
                if (!g) {
                    console.warn("Unable to handle non leaf types in InputArgView.setArgValue", r);
                    return
                }
                var C = void 0
                  , _ = void 0;
                r === null || typeof r > "u" ? _ = null : !r.target && r.kind && r.kind === "VariableDefinition" ? (C = r,
                _ = C.variable) : typeof r.kind == "string" ? _ = r : r.target && typeof r.target.value == "string" && (C = r.target.value,
                _ = ke(b, C));
                var A = e.props.modifyFields((F.fields || []).map(function(D) {
                    var B = D === d
                      , j = B ? k({}, D, {
                        value: _
                    }) : D;
            ...
            e._modifyChildFields = function(r) {
                return e.props.modifyFields(e.props.selection.fields.map(function(o) {
                    return o.name.value === e.props.arg.name ? k({}, o, {
                        value: {
                            kind: "ObjectValue",
                            fields: r
                        }
    ...
    var We = function(i) {
        ...
        function t() {
            ...
            e._removeArg = function(r) {
                ...
                return e._previousArgSelection = p,
                e.props.modifyArguments((o.arguments || []).filter(function(m) {
                    return m !== p
                }), r)
            }
            ,
            e._addArg = function(r) {
                var o = e.props
                  ...
                  , g = null;
                if (e._previousArgSelection)
                    g = e._previousArgSelection;
                else if ((0,
                v.isInputObjectType)(b)) {
                    var C = b.getFields();
                    g = {
                        kind: "Argument",
                        name: {
                        ...
                        value: {
                            kind: "ObjectValue",
                            fields: oe(m, h, F, Object.keys(C).map(function(_) {
                                return C[_]
                            }))
                        }
                    }
                ...
                return g ? e.props.modifyArguments([].concat(I(p.arguments || []), [g]), r) : (console.error("Unable to add arg for argType", b),
                null)
            }
            ,
            e._setArgValue = function(r, o) {
                ...
                var C = void 0
                  , _ = void 0;
                return r === null || typeof r > "u" ? _ = null : r.target && typeof r.target.value == "string" ? (C = r.target.value,
                _ = ke(b, C)) : !r.target && r.kind === "VariableDefinition" ? (C = r,
                _ = C.variable) : typeof r.kind == "string" && (_ = r),
                e.props.modifyArguments((F.arguments || []).map(function(A) {
                    return A === d ? k({}, A, {
                        value: _
                    }) : A
                }), o)
            ...
            e._setArgFields = function(r, o) {
                ...
                return e.props.modifyArguments((p.arguments || []).map(function(h) {
                    return h === m ? k({}, h, {
                        value: {
                            kind: "ObjectValue",
                            fields: r
    ...
    var Ke = function(i) {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                n && e && !(e instanceof HTMLTextAreaElement) && (n.focus(),
            ...
            value: function() {
                var n = this
                  ...
                  , o = this.props.argValue.kind === "StringValue" ? f.colors.string : f.colors.number;
                return a.createElement("span", {
                    style: {
                        color: o
                    }
                }, u.name === "String" ? '"' : "", a.createElement("input", {
                    style: {
                        border: "none",
      ...
      , Ee = function(i) {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                if (l) {
                    if (l.kind === "Variable")
                        r = a.createElement("span", {
                            style: {
                                color: f.colors.variable
                            }
                        }, "$", l.name.value);
                    else if ((0,
                    v.isScalarType)(u))
                        u.name === "Boolean" ? r = a.createElement("select", {
                            style: {
                                color: f.colors.builtin
                            },
                            ...
                            key: "true",
                            value: "true"
                        }, "true"), a.createElement("option", {
                            key: "false",
                            value: "false"
                        }, "false")) : r = a.createElement(Ke, {
                    ...
                    v.isEnumType)(u))
                        l.kind === "EnumValue" ? r = a.createElement("select", {
                            style: {
                        ...
                        })) : console.error("arg mismatch between arg and selection", u, l);
                    else if ((0,
                    v.isInputObjectType)(u))
                        if (l.kind === "ObjectValue") {
                            ...
                            r = a.createElement("div", {
                            ...
                            }, Object.keys(o).sort().map(function(d) {
                                return a.createElement(Ge, {
                                    ...
                                    getDefaultScalarArgValue: n.props.getDefaultScalarArgValue,
                ...
                var p = function() {
                    var b = c.name
                      , g = (n.props.definition.variableDefinitions || []).filter(function(E) {
                    ...
                    v.parseType)(_)
                      ...
                      , B = function(x) {
                        return (n.props.definition.variableDefinitions || []).find(function(T) {
                    ...
                    if (typeof l < "u" && l !== null) {
                        ...
                        j = D;
                    var $ = Object.entries(G).filter(function(E) {
                        var x = ye(E, 2);
                        x[0];
                        var T = x[1];
                        return T < 2
                    ...
                    if (j) {
                        ...
                        if (X) {
                            var ee = X.definitions.find(function(E) {
                                return E.operation && E.name && E.name.value && n.props.definition.name && n.props.definition.name.value ? E.name.value === n.props.definition.name.value : !1
                            })
                              , y = [].concat(I(ee.variableDefinitions || []), [j]).filter(function(E) {
                  ...
                  , m = function() {
                    if (!(!l || !l.name || !l.name.value)) {
                        var b = l.name.value
                          , g = (n.props.definition.variableDefinitions || []).find(function(M) {
                            return M.variable.name.value === b
                        });
                        if (g) {
                            var C = g.defaultValue
                              , _ = n.props.setArgValue(C, {
                                commit: !1
                            });
                            if (_) {
                                ...
                                D < 2 && (B = B.filter(function(M) {
                                    return M.variable.name.value !== b
                                }));
                                var j = k({}, A, {
                                    variableDefinitions: B
                                })
                                  , G = _.definitions
                                  , U = G.map(function(M) {
                                    return A === M ? j : M
                  ...
                  , h = l && l.kind === "Variable"
                  , F = this.state.displayArgActions ? a.createElement("button", {
                    type: "submit",
                    className: "toolbar-button",
                    title: h ? "Remove the variable" : "Extract the current value into a GraphQL variable",
                    onClick: function(b) {
                        b.preventDefault(),
                        b.stopPropagation(),
                        h ? m() : p()
                ...
                v.isInputObjectType)(u) ? a.createElement("span", null, l ? this.props.styleConfig.arrowOpen : this.props.styleConfig.arrowClosed) : a.createElement(ae, {
                    checked: !!l,
                    styleConfig: this.props.styleConfig
                }), a.createElement("span", {
                    style: {
                        color: f.colors.attribute
                    },
                    title: c.description,
                    onMouseEnter: function() {
                        l !== null && typeof l < "u" && n.setState({
                            displayArgActions: !0
                        })
                    },
                ...
                }, c.name, Se(c) ? "*" : "", ": ", F, " "), " "), r || a.createElement("span", null), " ")
            }
        }]),
        t
    }(a.PureComponent)
      , Je = function(i) {
        ...
        function t() {
            ...
            e._addFragment = function() {
                e.props.modifySelections([].concat(I(e.props.selections), [e._previousSelection || {
                    kind: "InlineFragment",
                    typeCondition: {
                        kind: "NamedType",
                        name: {
                    ...
                    selectionSet: {
                        kind: "SelectionSet",
                        selections: e.props.getDefaultFieldNames(e.props.implementingType).map(function(r) {
                            return {
                                kind: "Field",
                                name: {
                                    kind: "Name",
            ...
            e._removeFragment = function() {
                ...
                e.props.modifySelections(e.props.selections.filter(function(o) {
                    return o !== r
                }))
            }
            ,
            e._getSelection = function() {
                var r = e.props.selections.find(function(o) {
                    return o.kind === "InlineFragment" && o.typeCondition && e.props.implementingType.name === o.typeCondition.name.value
                });
                if (!r)
                    return null;
            ...
            e._modifyChildSelections = function(r, o) {
                ...
                return e.props.modifySelections(e.props.selections.map(function(m) {
                    return m === p ? {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                }, this.props.implementingType.name)), r ? a.createElement("div", {
                    style: {
                        marginLeft: 16
                    }
                }, Object.keys(o).sort().map(function(m) {
      ...
      , Ye = function(i) {
        ...
        function t() {
            ...
            e._removeFragment = function() {
                ...
                e._previousSelection = r,
                e.props.modifySelections(e.props.selections.filter(function(o) {
                    var p = o.kind === "FragmentSpread" && o.name.value === e.props.fragment.name.value;
                    return !p
                }))
            }
            ,
            e._getSelection = function() {
                var r = e.props.selections.find(function(o) {
                    return o.kind === "FragmentSpread" && o.name.value === e.props.fragment.name.value
                });
                return r
            }
            ,
    ...
    function oe(i, t, s, n) {
        var e = []
          ...
          , f = void 0;
        try {
            for (var u = n[Symbol.iterator](), r; !(l = (r = u.next()).done); l = !0) {
                var o = r.value;
                if ((0,
                v.isRequiredInputField)(o) || t && t(s, o)) {
                    var p = Q(o.type);
                    (0,
                    v.isInputObjectType)(p) ? function() {
                        var m = p.getFields();
                        e.push({
                            kind: "ObjectField",
                            name: {
                            ...
                            value: {
                                kind: "ObjectValue",
                                fields: oe(i, t, s, Object.keys(m).map(function(h) {
                                    return m[h]
                                }))
                            }
                        })
                    }() : (0,
                    v.isLeafType)(p) && e.push({
                        kind: "ObjectField",
                        name: {
                            kind: "Name",
                            value: o.name
    ...
    function _e(i, t, s) {
        var n = []
          ...
          , c = void 0;
        try {
            for (var f = s.args[Symbol.iterator](), u; !(e = (u = f.next()).done); e = !0) {
                var r = u.value;
                if (Se(r) || t && t(s, r)) {
                    var o = Q(r.type);
                    (0,
                    v.isInputObjectType)(o) ? function() {
                        var p = o.getFields();
                        n.push({
                            kind: "Argument",
                            name: {
                            ...
                            value: {
                                kind: "ObjectValue",
                                fields: oe(i, t, s, Object.keys(p).map(function(m) {
                                    return p[m]
                                }))
                            }
                        })
                    }() : (0,
                    v.isLeafType)(o) && n.push({
                        kind: "Argument",
                        name: {
                            kind: "Name",
                            value: r.name
    ...
    var Ae = function(i) {
        ...
        function t() {
            ...
            e),
            e.state = {
                displayFieldActions: !1
            },
            e._addAllFieldsToSelections = function(r) {
                var o = r ? Object.keys(r).map(function(h) {
                    return {
                        kind: "Field",
                        name: {
                            kind: "Name",
                  ...
                  , m = [].concat(I(e.props.selections.filter(function(h) {
                    return h.kind === "InlineFragment" ? !0 : h.name.value !== e.props.field.name
                })), [{
                    kind: "Field",
                    name: {
                        kind: "Name",
                        value: e.props.field.name
                    },
                    arguments: _e(e.props.getDefaultScalarArgValue, e.props.makeDefaultArg, e.props.field),
                    selectionSet: p
                }]);
            ...
            e._addFieldToSelections = function(r) {
                var o = [].concat(I(e.props.selections), [e._previousSelection || {
                    kind: "Field",
                    name: {
                        kind: "Name",
                        value: e.props.field.name
            ...
            e._handleUpdateSelections = function(r) {
                ...
                if (o && !r.altKey)
                    e._removeFieldFromSelections();
                else {
                    var p = (0,
                    v.getNamedType)(e.props.field.type)
                      , m = (0,
                    v.isObjectType)(p) && p.getFields()
                      , h = !!m && r.altKey;
            ...
            ,
            e._modifyChildSelections = function(r, o) {
                return e.props.modifySelections(e.props.selections.map(function(p) {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                var h = (0,
                v.isObjectType)(o) || (0,
                v.isInterfaceType)(o) || (0,
                v.isUnionType)(o) ? this.props.availableFragments && this.props.availableFragments[o.name] : null
                  , F = a.createElement("div", {
                    ...
                    onMouseEnter: function() {
                        var C = (0,
                        v.isObjectType)(o) && r && r.selectionSet && r.selectionSet.selections.filter(function(_) {
                            return _.kind !== "FragmentSpread"
                        }).length > 0;
                        C && n.setState({
                            displayFieldActions: !0
                        })
                    },
                    onMouseLeave: function() {
                        return n.setState({
                ...
                v.isObjectType)(o) ? a.createElement("span", null, r ? this.props.styleConfig.arrowOpen : this.props.styleConfig.arrowClosed) : null, (0,
                v.isObjectType)(o) ? null : a.createElement(ae, {
                    checked: !!r,
                    styleConfig: this.props.styleConfig
                }), a.createElement("span", {
                    style: {
                        color: u.colors.property
                    },
                    className: "graphiql-explorer-field-view"
                }, l.name), this.state.displayFieldActions ? a.createElement("button", {
                    type: "submit",
                    className: "toolbar-button",
                    ...
                    onClick: function(C) {
                        ...
                        D > 0 && (A = "" + A + D);
                        var B = r ? r.selectionSet ? r.selectionSet.selections : [] : []
                          , j = [{
                            kind: "FragmentSpread",
                            name: {
                                kind: "Name",
                ...
                }, a.createElement("span", null, "…")) : null), r && p.length ? a.createElement("div", {
                    style: {
                        marginLeft: 16
                    },
                ...
                v.isUnionType)(o))) {
                    ...
                    }) : null, Object.keys(d).sort().map(function(g) {
                    ...
                    v.isInterfaceType)(o) || (0,
                    v.isUnionType)(o) ? c.getPossibleTypes(o).map(function(g) {
    ...
    function et(i) {
        if (Y && Y[0] === i)
            return Y[1];
        var t = Xe(i);
        return t ? t instanceof Error ? Y ? Y[1] : le : (Y = [i, t],
        t) : le
    }
    var Oe = {
        buttonStyle: {
      ...
      , tt = function(i) {
        ...
        function t() {
            ...
            e.state = {
                ...
                displayTitleActions: !1
            },
            e._modifySelections = function(r, o) {
                var p = e.props.definition;
                p.selectionSet.selections.length === 0 && e._previousOperationDef && (p = e._previousOperationDef);
                var m = void 0;
                if (p.kind === "FragmentDefinition")
                    m = k({}, p, {
                        selectionSet: k({}, p.selectionSet, {
                            selections: r
                        })
                    });
            ...
            e._handlePotentialRun = function(r) {
                Qe(r) && Ze(e.props.definition.kind) && e.props.onRunOperation(e.props.name)
            }
            ,
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                return a.createElement("div", {
                    ...
                    style: {
                        color: r.colors.keyword,
                        paddingBottom: 4
                    },
                    className: "graphiql-operation-title-bar",
                    onMouseEnter: function() {
                        return n.setState({
                            displayTitleActions: !0
                        })
                    },
                    onMouseLeave: function() {
                        return n.setState({
                ...
                })), this.props.onTypeName ? a.createElement("span", null, a.createElement("br", null), "on " + this.props.onTypeName) : "", this.state.displayTitleActions ? a.createElement(a.Fragment, null, a.createElement("button", {
                    type: "submit",
                    className: "toolbar-button",
                    onClick: function() {
                ...
                }, a.createElement("span", null, "✕")), a.createElement("button", {
                    type: "submit",
                    className: "toolbar-button",
                    onClick: function() {
                    ...
                    style: k({}, r.styles.actionButtonStyle)
                }, a.createElement("span", null, "⎘"))) : ""), Object.keys(p).sort().map(function(d) {
                    return a.createElement(Ae, {
                        key: d,
                        field: p[d],
                        selections: h,
    ...
    function nt() {
        ...
        }, "GraphiQL Explorer by ", a.createElement("a", {
            href: "https://www.onegraph.com"
        }, "OneGraph")), a.createElement("div", null, "Contribute on", " ", a.createElement("a", {
    ...
    var we = function(i) {
        ...
        function t() {
            ...
            e._handleRootViewMount = function(r) {
                if (e.state.operationToScrollTo && e.state.operationToScrollTo === r) {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                var m = r && r.getFields()
                  ...
                  , C = d.definitions
                  , _ = C.map(function(y) {
                    return y.kind === "FragmentDefinition" || y.kind === "OperationDefinition" ? y : null
                }).filter(Boolean)
                  ...
                  , B = function(S) {
                    var O = void 0;
                    S.kind === "FragmentDefinition" ? O = "fragment" : O = S.operation;
                  ...
                  , G = function(S) {
                    var O = d.definitions
                      , V = d.definitions.length === 1 && d.definitions[0] === le.definitions[0]
                      , L = V ? [] : O.filter(function(te) {
                        return te.kind === "OperationDefinition" ? te.operation === S : !1
                    })
                    ...
                    n.setState({
                        operationToScrollTo: S + "-" + E
                    }),
                    n.props.onEdit((0,
                    v.print)(fe))
                }
                  , U = [m ? a.createElement("option", {
                    key: "query",
                    className: "toolbar-button",
                    style: u.styles.buttonStyle,
                    type: "link",
                    value: "query"
                }, "Query") : null, h ? a.createElement("option", {
                    key: "mutation",
                    className: "toolbar-button",
                    style: u.styles.buttonStyle,
                    type: "link",
                    value: "mutation"
                }, "Mutation") : null, F ? a.createElement("option", {
                    key: "subscription",
                    className: "toolbar-button",
                    style: u.styles.buttonStyle,
                    type: "link",
                  ...
                  , K = U.length === 0 || this.props.hideActions ? null : a.createElement("div", {
                    style: {
                        minHeight: "50px",
                        maxHeight: "50px",
                        overflow: "none"
                ...
                }, "Add new", " "), a.createElement("select", {
                    onChange: function(S) {
                    ...
                    className: "toolbar-button",
                    onClick: function() {
                        return n.state.newOperationType ? G(n.state.newOperationType) : null
                    },
                  ...
                  , M = this.props.externalFragments && this.props.externalFragments.reduce(function(y, S) {
                  ...
                  , X = k({}, $, M)
                  , ee = this.props.showAttribution ? a.createElement(nt, null) : null;
                return a.createElement("div", {
                    ref: function(S) {
                        n._ref = S
                    },
                    ...
                    var O = y && y.name && y.name.value
                      , V = y.kind === "FragmentDefinition" ? "fragment" : y && y.operation || "query"
                      , L = function(H) {
                        var Z = D(y, H);
                        n.props.onEdit((0,
                        v.print)(Z))
                      ...
                      , T = y.kind === "FragmentDefinition" && y.typeCondition.kind === "NamedType" && l.getType(y.typeCondition.name.value)
                      , J = T instanceof v.GraphQLObjectType ? T.getFields() : null
                      , ce = V === "query" ? m : V === "mutation" ? h : V === "subscription" ? F : y.kind === "FragmentDefinition" ? J : null
                      , fe = y.kind === "FragmentDefinition" ? y.typeCondition.name.value : null
                      , te = function(H) {
                        var Z = (0,
                        v.print)(H);
                        n.props.onEdit(Z)
                    ...
                    return a.createElement(tt, {
                        ...
                        onEdit: function(H, Z) {
                            var me = void 0;
                            if ((typeof Z > "u" ? "undefined" : je(Z)) === "object" && typeof Z.commit < "u" ? me = Z.commit : me = !0,
                            H) {
                                var de = k({}, d, {
    ...
    we.defaultProps = {
        getDefaultFieldNames: be,
        getDefaultScalarArgValue: Ce
    };
    var rt = function(i) {
        R(t, i);
        function t() {
        ...
        return P(t, [{
            ...
            value: function() {
                ...
                }, a.createElement("div", null, "Something went wrong"), a.createElement("details", {
                    style: {
                        whiteSpace: "pre-wrap"
                    }
                }, this.state.error ? this.state.error.toString() : null, a.createElement("br", null), this.state.errorInfo ? this.state.errorInfo.componentStack : null)) : this.props.children
            }
        }]),
        t
    }(a.Component)
    ...
    Fe = re.Explorer = xe.default,
    re.default = xe.default;
    const dt = ""
      , ot = {
    ...
    function ft(i) {
        const {setOperationName: t} = W.useEditorContext({
            nonNull: !0
        })
          , {schema: s} = W.useSchemaContext({
            nonNull: !0
        })
          , {run: n} = W.useExecutionContext({
            nonNull: !0
        })
          , e = N.useCallback(f => {
            f && t(f),
