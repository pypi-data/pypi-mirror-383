...
from .exp_renyientr import (RenyiEntropy, QuasiEntropy, SandRenyiEntropy, 
                            SandQuasiEntropy)
...
renyientr     = _shorthand("renyientr", RenyiEntropy)
quasientr     = _shorthand("quasientr", QuasiEntropy)
sandrenyientr = _shorthand("sandrenyientr", SandRenyiEntropy)
sandquasientr = _shorthand("sandquasientr", SandQuasiEntropy)
