...
from picos.expressions.variables import HermitianVariable, SymmetricVariable
...
class PowerTraceConstraint(Constraint):
    ...
    class Conversion(ConstraintConversion):
        ...
        def convert(cls, con, options):
            ...
            from ..expressions import (HermitianVariable, RealVariable,
                                       SymmetricVariable)
            from ..expressions.algebra import I, block, rsoc
            ...
            Var = HermitianVariable if x.complex else SymmetricVariable
                ...
                while len(lis) > 2:
                    ...
                    while lis:
                        ...
                        if v1 is v2:
                            ...
                            if n == 1:
                                v0 = RealVariable('__v[' + str(varcnt) + ']')
                                P.add_constraint((v1 & v2 & v0) << rsoc())
                            else:
                                v0 = Var('__v[' + str(varcnt) + ']', (n, n))
                                P.add_constraint(
                                    block([[v1, v0], [v0, v2]]) >> 0)
