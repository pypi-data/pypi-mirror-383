...
class Problem(Valuable):
    ...
    def get_constraint(self, idOrIndOrCon):
        ...
        >>> prob=pic.Problem()
        >>> x=[pic.RealVariable('x[{0}]'.format(i),2) for i in range(5)]
        >>> y=pic.RealVariable('y',5)
    ...
    def add_list_of_constraints(self, lst, it=None, indices=None, key=None):
        ...
        >>> w={}
        >>> for ij in IJ:
        ...         w[ij]=pic.RealVariable('w[{},{}]'.format(*ij),3)
        ...
    ...
    def remove_constraint(self, idOrIndOrCon):
        ...
        >>> from pprint import pprint
        >>> P = picos.Problem()
        >>> x = [picos.RealVariable('x[{0}]'.format(i), 2) for i in range(4)]
        >>> y = picos.RealVariable('y', 4)
    ...
    def add_variable(
        ...
        >>> x
        <3×1 Real Variable: x>
        >>> # Variables exist independently of problems:
        >>> P.variables
