...
- **DB:** The basic database object, capable of Hash, BTree, Recno,
  Queue and Heap [#53]_ access methods.
...
.. function:: full_version()
   ...
   [#53]_ Returns a tuple with the full version string, family,
   release, major, minor and patch level.
...
Each exception derives from the **DBError** exception class so if you just want
to catch generic errors you can use **DBError** to do it. Since
...
error message itself.
    ...
    +----------------------------+-------------------------------------------+
    | **DBNotSupportedError**    | ENOTSUP                                   |
    +----------------------------+-------------------------------------------+
    | **DBHeapFull** [#53]_      | DB_HEAP_FULL                              |
    +----------------------------+-------------------------------------------+
    | **DBMetaChksumFail**       | DB_META_CHKSUM_FAIL                       |
    | [#62]_                     |                                           |
    +----------------------------+-------------------------------------------+
...
.. [#no53] Available only when compiled against Berkeley DB = 4.8.
