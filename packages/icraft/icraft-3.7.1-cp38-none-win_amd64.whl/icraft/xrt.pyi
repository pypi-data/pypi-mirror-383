...
import xir
__all__ = ['ADDR', 'BOTH', 'Backend', 'BuyiDevice', 'CPTR', 'Device', 'HostDevice', 'HostMemRegion', 'MemChunk', 'MemPtr', 'MemRegion', 'PtrType', 'RegRegion', 'Session', 'Tensor']
class Backend(xir.ObjectRef):
    ...
    def fork(self) -> Backend:
        ...
        复制一个Backend用于多线程
        """
    def forwardOp(self, op: xir.Operation, inputs: list[Tensor]) -> list[Tensor]:
        """
        				前向指定的算子.
        				...
        				:return:			前向的结果
        """
    def getForwardFunc(self, op: xir.Operation) -> typing.Callable[[xir.Operation, list[Tensor], Backend], list[Tensor]] | None:
        """
        				获取指定算子的前向函数.
...
class MemChunk(xir.ObjectRef):
    ...
    def isOn(self, arg0: MemRegion) -> bool:
        ...
        """
    def read(self, dest: str, src_offset: int, byte_size: int) -> None:
        """
        				读取指定偏移的数据.
        ...
        """
    def write(self, dest_offset: int, src: str, byte_size: int) -> None:
        """
        				将数据写到指定偏移位置.
...
class MemRegion(xir.ObjectRef):
    ...
    def device(self) -> ...:
        ...
        """
    @typing.overload
    def malloc(self, byte_size: int, auto_free: bool = True) -> ...:
        """
        				申请分配指定大小的内存.
...
class Tensor(xir.ObjectRef):
    ...
    def __init__(self, dtype: xir.TensorType) -> None:
        ...
        6. __init__(self: xrt.Tensor, b: buffer, layout: xir.Layout = <xir.Layout object at 0x000001D2998A6DB0>) -> None
