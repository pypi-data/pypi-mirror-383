...
DEFAULT_BASE_URL = os.environ.get("DL_URL", "https://hub.gdsfactory.plus")
...
class Client:
    ...
    def add_pipeline(
        ...
        *,
        ...
        # Normalize tag arrays: convert {"key": "value"} dicts to "key: value" strings
        # This handles YAML like "- wafer: ${step0,0}" which parses as dict
        schema = self._normalize_tag_arrays(schema)
