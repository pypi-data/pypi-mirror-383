...
class SeatoolsConfig(Config):
    ...
    def __init__(self, ioc_app: Callable[..., Any] | str, app: ASGIApplication | Callable[..., Any] | str, host: str = "127.0.0.1",
                 port: int = 8000, uds: str | None = None, fd: int | None = None, loop: LoopFactoryType | str = "auto",
                 ...
                 timeout_keep_alive: int = 5, timeout_notify: int = 30, timeout_graceful_shutdown: int | None = None, timeout_worker_healthcheck = None,
        ...
        super().__init__(app, host, port, uds, fd, loop, http, ws, ws_max_size, ws_max_queue, ws_ping_interval,
                         ...
                         timeout_graceful_shutdown, timeout_worker_healthcheck, callback_notify, ssl_keyfile, ssl_certfile, ssl_keyfile_password,
...
def run(
    ...
    *,
    ...
    config = SeatoolsConfig(
        ...
        ws_per_message_deflate=False if ws_per_message_deflate is False or config.get(
            'ws_per_message_deflate') is False else True,
        ...
        timeout_worker_healthcheck=timeout_worker_healthcheck or config.get('timeout_worker_healthcheck'),
