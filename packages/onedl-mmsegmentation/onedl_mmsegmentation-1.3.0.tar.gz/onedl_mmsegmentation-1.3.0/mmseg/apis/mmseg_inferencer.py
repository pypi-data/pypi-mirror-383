...
class MMSegInferencer(BaseInferencer):
    ...
    Args:
        model (str, optional): Path to the config file or the model name
            defined in metafile. Take the `mmseg metafile <https://github.com/vbti-development/onedl-mmsegmentation/blob/main/configs/fcn/metafile.yaml>`_
        ...
        palette (list, optional): Input palette for result rendering, which is
            ...
            Defaults to None.
        dataset_name (str, optional): `Dataset name or alias <https://github.com/vbti-development/onedl-mmsegmentation/blob/main/mmseg/utils/class_names.py#L302-L317>`_
