...
class BaseSegDataset(BaseDataset):
    ...
    def _update_palette(self) -> list:
        ...
        if len(palette) == 0:
            ...
            # See:
            # https://github.com/vbti-development/onedl-mmdetection/issues/5844  # noqa: E501
...
class BaseCDDataset(BaseDataset):
    ...
    def _update_palette(self) -> list:
        ...
        if len(palette) == 0:
            ...
            # It will prevent loss of randomness, as the palette
            # may be different in each iteration if not specified.
            # See: https://github.com/vbti-development/onedl-mmdetection/issues/5844 # noqa: E501
            state = np.random.get_state()
            np.random.seed(42)
            # random palette
            new_palette = np.random.randint(
