...
class SDKConfig(BaseModel):
    ...
    cerebras_key: SecretStr = Field(default_factory=lambda: SecretStr(os.getenv("CEREBRAS_KEY", "")))
    aws_access_key_id: SecretStr = Field(default_factory=lambda: SecretStr(os.getenv("AWS_ACCESS_KEY_ID", "")))
