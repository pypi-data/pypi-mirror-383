...
class SeasonExternalIDsApi:
    ...
    def season_external_ids_list(
        ...
        season_id: Annotated[
            Optional[StrictStr],
            Field(description="The unique identifier of the season. Can specify multiple, delimited by comma."),
        ] = None,
        source: Annotated[
        ...
        :param offset: The offset of the records. See [Pagination](#section/Introduction/Pagination) for more information.
        :type offset: int
        :param season_id: The unique identifier of the season. Can specify multiple, delimited by comma.
        :type season_id: str
