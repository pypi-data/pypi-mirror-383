...
class PersonExternalIDsApi:
    ...
    def person_external_ids_list(
        ...
        person_id: Annotated[
            Optional[StrictStr],
            Field(description="The unique identifier of the person. Can specify multiple, delimited by comma."),
        ] = None,
        source: Annotated[
        ...
        :param offset: The offset of the records. See [Pagination](#section/Introduction/Pagination) for more information.
        :type offset: int
        :param person_id: The unique identifier of the person. Can specify multiple, delimited by comma.
        :type person_id: str
