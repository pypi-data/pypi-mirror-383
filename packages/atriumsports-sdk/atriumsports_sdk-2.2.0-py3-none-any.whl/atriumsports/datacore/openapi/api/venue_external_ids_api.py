...
class VenueExternalIDsApi:
    ...
    def venue_external_ids_list(
        ...
        venue_id: Annotated[
            Optional[StrictStr],
            Field(description="The unique identifier of the venue. Can specify multiple, delimited by comma."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param venue_id: The unique identifier of the venue. Can specify multiple, delimited by comma.
        :type venue_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
