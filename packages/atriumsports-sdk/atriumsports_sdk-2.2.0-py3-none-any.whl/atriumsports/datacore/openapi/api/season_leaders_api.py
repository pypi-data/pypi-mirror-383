...
class SeasonLeadersApi:
    ...
    def sl_list(
        ...
        compute_all: Annotated[
            Optional[StrictBool],
            Field(description="When set to true, bypasses field filtering and computes all available fields"),
        ] = None,
        ...
        :type statistic: str
        :param compute_all: When set to true, bypasses field filtering and computes all available fields
        :type compute_all: bool
    ...
    def _sl_list_serialize(
        ...
        if compute_all is not None:
            _query_params.append(("computeAll", compute_all))
