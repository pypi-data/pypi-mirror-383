...
class CompetitionExternalIDsApi:
    ...
    def competition_external_ids_list(
        ...
        competition_id: Annotated[
            Optional[StrictStr],
            Field(description="The unique identifier of the competition. Can specify multiple, delimited by comma."),
        ] = None,
        external: Annotated[
            Optional[StrictStr],
            Field(
        ...
        :type added: datetime
        :param competition_id: The unique identifier of the competition. Can specify multiple, delimited by comma.
