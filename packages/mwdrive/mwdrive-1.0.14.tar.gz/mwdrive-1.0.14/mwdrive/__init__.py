...
# We want to use the fibre package that is included with the mwdrive package
...
default_usb_search_path = 'usb:idVendor=0x1209,idProduct=0x0D32'
...
def find_any(path: str = default_search_path,
             ...
             timeout: float = None):
    """
    Blocks until the first matching MDrive object is connected and then returns
    that object.
