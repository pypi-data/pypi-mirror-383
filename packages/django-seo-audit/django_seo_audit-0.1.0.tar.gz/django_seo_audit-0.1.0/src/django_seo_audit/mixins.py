...
class SEOAuditableMixin:
    ...
    def get_seo_title(self) -> str:
        """Return SEO title with fallback to name."""
    ...
    def get_og_image_url(self) -> str | None:
        ...
        return og_image.url if og_image else None
    ...
    def get_twitter_image_url(self) -> str | None:
        ...
        return twitter_image.url if twitter_image else None
    ...
    def has_detailed_content(self) -> bool:
        ...
        if hasattr(self, "subpages"):
            substantial_subpages = (
                ...
                .exclude(content="")
                .annotate(content_length=models.functions.Length("content"))
                .filter(
    ...
    def get_breadcrumb_title(self) -> str:
        """Return breadcrumb title with fallback to name."""
        return getattr(self, "breadcrumb_title", "") or getattr(self, "name", "")
