...
class MarkPrice(BaseModel):
    ...
    index_price: Optional[Decimal] = Field(default=None, gt=0, description="Index price (spot reference)")
    ...
    @property
    def next_funding_time_ms(self) -> Optional[int]:
    ...
    @property
    def seconds_to_funding(self) -> Optional[int]:
    ...
    def compare_to_exchange_spot(self, exchange_spot_price: Decimal) -> dict:
        ...
        spread_bps = (spread / exchange_spot_price) * Decimal("10000") if exchange_spot_price > 0 else None
        spread_pct = (spread / exchange_spot_price) * Decimal("100") if exchange_spot_price > 0 else None
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "estimated_settle_price": str(self.estimated_settle_price) if self.estimated_settle_price else None,
            "mark_index_spread_bps": str(self.mark_index_spread_bps) if self.mark_index_spread_bps else None,
