...
class ProjectInfo:
    ...
    def filter_included_models(
        ...
        model_name_relpaths = [
            (model_name, get_project_path_from_full_path(self.root_path, model_abspath))
        ...
        elif self.config.model_allowlist:
            filtered_model_names_by_path = [
                (model_name, model_path)
                for model_name, model_path in model_name_relpaths
                if is_model_in_allowlist(
                    model_name, model_path, self.config.model_allowlist
                )
            ]
        else:
            filtered_model_names_by_path = model_name_relpaths
