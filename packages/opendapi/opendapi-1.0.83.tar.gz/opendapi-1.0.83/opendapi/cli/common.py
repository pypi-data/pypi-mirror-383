...
ENCODED_BREADCRUMB_PREFIX = "OPENDAPI_BREADCRUMB::"


def print_encoded_breadcrumbs(message: str):
    """Prints the error message encoded in a way for the server"""
    base64_bytes = base64.b64encode(message.encode("utf-8"))
    base64_message = f"{ENCODED_BREADCRUMB_PREFIX}{base64_bytes.decode('utf-8')}"
    print_cli_output(base64_message)
