...
def get_linux_hardening_rules() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "severity": "low",
            "level": ["basic", "moderate", "strict"],
            "check": "if [ -f /etc/motd ]; then stat -c '%a' /etc/motd | grep -E '^[0-6][0-4][0-4]' || echo 'Insecure motd permissions'; else echo 'File does not exist'; fi",
        ...
        
        {
            ...
            "severity": "high",
            "level": ["basic", "moderate", "strict"],
            "check": "dpkg -l | grep ufw | awk '{print $1, $2}' || echo 'ufw not installed'",
        ...
        # Privilege Escalation
        {
            ...
            "severity": "high",
            "level": ["basic", "moderate", "strict"],
            "check": "dpkg -l | grep sudo | awk '{print $1, $2}' || echo 'sudo not installed'",
