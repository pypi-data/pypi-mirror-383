...
def get_windows_hardening_rules() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        # Account Policies - Password Policy
        {
            ...
            "level": ["basic", "moderate", "strict"],
            "check_type": "powershell",
            "check": 'Get-ItemProperty -Path "HKLM:\\SYSTEM\\CurrentControlSet\\Services\\Netlogon\\Parameters" -Name "PasswordHistory" | Select-Object -ExpandProperty PasswordHistory',
            "remediate_type": "powershell",
            "remediate": 'Set-ItemProperty -Path "HKLM:\\SYSTEM\\CurrentControlSet\\Services\\Netlogon\\Parameters" -Name "PasswordHistory" -Value 24',
            "rollback_type": "powershell",
            "rollback": 'Set-ItemProperty -Path "HKLM:\\SYSTEM\\CurrentControlSet\\Services\\Netlogon\\Parameters" -Name "PasswordHistory" -Value 0',
            "expected": "24",
