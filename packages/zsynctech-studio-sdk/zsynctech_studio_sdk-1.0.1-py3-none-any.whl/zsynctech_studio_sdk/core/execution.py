...
from zsynctech_studio_sdk.core.context import get_client, INSTANCE_ID, SDK_DIR
...
class Execution:
    ...
    @staticmethod
    def decrypt_credentials(credentials: Optional[List[CredentialModel]], encryption_key: str) -> Optional[Dict[str, str]]:
        ...
        for cred in credentials:
            if cred.encrypted:
                decrypted_dict[cred.key] = decrypt(cred.value, encryption_key)
            else:
