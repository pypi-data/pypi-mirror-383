...
from odoo_soup.compiler import parse_config
from odoo_soup.converter import convert_to_sql
from odoo_soup import config
...
@click.option(
    "--dirty",
    is_flag=True,
    help="Include ALL unconfigured line types as text records (excl. traceback lines)",
)
@soup.command()
@click.argument("table")
def make(dirty, table):
    """
    ...
    # Convert to sql
    skipped, stats = convert_to_sql(dirty, log_files[resp][1])
