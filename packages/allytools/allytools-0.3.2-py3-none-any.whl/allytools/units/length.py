...
class Length:
    ...
    def __add__(self, other: object) -> "Length":
        ...
        return Length(self.value_mm + other.value_mm, self._original_unit)
    ...
    def __mul__(self, other):
        if isinstance(other, (int, float)):
            return Length(self.value_mm * other, self._original_unit)
            ...
            return Length(self.value_mm * angle_rad, self._original_unit)
        return NotImplemented
