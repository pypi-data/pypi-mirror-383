...
import numpy as np
from .General import as_npz

class FrozenContainer(ABC):
    __slots__ = ()
    _registry: Dict[str, Type["FrozenContainer"]] = {}
    ...
    @classmethod
    @abstractmethod
    def create(cls, *args, **kwargs) -> "FrozenContainer":
        raise NotImplementedError

    @classmethod
    def register(cls, name: str | None = None):
        def _decorator(sub: Type["FrozenContainer"]) -> Type["FrozenContainer"]:
    ...
    @classmethod
    def load_from_npz(cls, npz: Mapping[str, Any]) -> "FrozenContainer":
