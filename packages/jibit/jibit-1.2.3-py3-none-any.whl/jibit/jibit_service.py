import aiohttp
from typing import Optional, Dict, Tuple,List, Annotated

from .models import ForeignerIdentityInfo, CorporationIdentityInfo, militaryServiceQualificationInfo, SanaInfo, \
    Balance
