...
class FuzzyTriangular:
    ...
    def __add__(self, other: FuzzyTriangular) -> FuzzyTriangular:
        """Qo‘shish"""
        if not isinstance(other, FuzzyTriangular):
            raise TypeError("Qo‘shish faqat FuzzyTriangular obyektlari orasida amalga oshiriladi.")
        return FuzzyTriangular(
            self.a + other.a,
            self.a1 + other.a1,
            self.a2 + other.a2
    ...
    def __sub__(self, other: FuzzyTriangular) -> FuzzyTriangular:
        """Ayirish"""
        if not isinstance(other, FuzzyTriangular):
            raise TypeError("Ayirish faqat FuzzyTriangular obyektlari orasida amalga oshiriladi.")
        return FuzzyTriangular(
            self.a - other.a,
            self.a1 + other.a2,
            self.a2 + other.a1
    ...
    def __mul__(self, other: Union[FuzzyTriangular, float, int]) -> FuzzyTriangular:
        """Ko‘paytirish"""
        if isinstance(other, (float, int)):
            ...
            raise TypeError("Ko‘paytirish faqat FuzzyTriangular yoki son bilan amalga oshiriladi.")

    def __truediv__(self, other: Union[FuzzyTriangular, float, int]) -> FuzzyTriangular:
        """Bo‘lish"""
        if isinstance(other, (float, int)):
            if other == 0:
                raise DivisionByZeroError("0 ga bo‘lish mumkin emas.")
            return FuzzyTriangular(
                self.a / other,
                self.a1 / other,
                self.a2 / other
            ...
            if other.a == 0 or other.a1 == 0 or other.a2 == 0:
                raise DivisionByZeroError("FuzzyTriangular komponentlaridan biri 0 bo‘lishi mumkin emas.")
            return FuzzyTriangular(
                self.a / other.a,
                self.a1 / other.a1,
                self.a2 / other.a2
            ...
            raise TypeError("Bo‘lish faqat FuzzyTriangular yoki son bilan amalga oshiriladi.")
