...
class MakeFigure:
    ...
    def _apply_layout(self):
        ...
        for i, (trace, color) in enumerate(self.traces, start=1):
            ...
            self.fig.layout[yaxis_name].titlefont.color = color
            self.fig.layout[yaxis_name].tickfont.color = color
            self.fig.layout[yaxis_name].linecolor = color
            self.fig.layout[yaxis_name].ticks = "outside"
