def transform(data, seed, arch_bits):
    ...
    for idx, byte in enumerate(result):
        state_a = (state_a * 6364136223883793005 + 37) & 0xFFFFFFFFFFFFFFFF
        state_b = (state_b * 1122015245 + 12382) & 0xFFFFFFFFFFFFFFFF
        
        key_stream = (state_a ^ state_b) & 0xFFFFFFFFFFFFFFFF
        
        layer_1 = byte ^ ((key_stream >> (idx % 56)) & 0xFF)
        layer_2 = ((layer_1 << 37 % 8) | (layer_1 >> (8 - 37 % 8))) & 0xFF
        ...
        sbox_val = ((sbox_idx * 37 + state_a) ^ state_b) & 0xFF
