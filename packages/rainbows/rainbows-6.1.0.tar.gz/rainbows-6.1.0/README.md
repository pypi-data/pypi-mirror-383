...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/rainbows.svg?label=pypi%20(stable))](https://pypi.org/project/rainbows/)
...
client = Rainbows(
    api_key=os.environ.get("RAINBOWS_API_KEY"),  # This is the default and can be omitted
)
...
```python
import asyncio
from rainbows import DefaultAioHttpClient
from rainbows import AsyncRainbows


async def main() -> None:
    async with AsyncRainbows(
        api_key="My API Key",
