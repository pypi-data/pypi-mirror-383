...
if typing.TYPE_CHECKING:
    import Ansys
import ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.ExternalModel as ExternalModel
import ansys.mechanical.stubs.v252.Ansys.Mechanical.DataModel.Enums.GeometryImportPreference as GeometryImportPreference
...
class DefaultShellMesherType(Enum):
    """
...
class ImportedRemoteLoadType(Enum):
    """
...
class WeldDetectionMethodType(Enum):
    """
    Specify the weld detection method type.
    """

    Automatic = 0
    EdgeMeshSizeFactor = 1
...
class DataModelObjectCategory(Enum):
    ...
    FluidPenetrationPressure = 771
    CompositeFailureCriteria = 776
    GasketMeshControl = 778
    LoadApplication = 779
    PSDPressure = 781
    Gasket = 782
    FileBasedImportedLoads = 783
...
class OutputSelection(Enum):
    ...
    NamedSelection = 1
    None_ = 0
    NamedSelectionOnModeFile = 2
    FollowUpstreamAnalysis = 3
...
class ComponentProtectedType(Enum):
    """
...
class IncrementControl(Enum):
    """
    This enum provides the options for MinIncrementControl property.
    """

    Default = 0
    SetSmallIncrementsToZero = 1

class IncrementTreatment(Enum):
    """
...
class MemberSizeMeasurementType(Enum):
    """
...
class PartingSurfaceControl(Enum):
    """
...
class RemeshHexDominantToTetrahedral(Enum):
    """
    Use this property to specify the Fracture re-meshing type.
    """

    BufferZoneAndMPCContact = 2
    BufferZoneAndPyramidElements = 3
    EntirePart = 1
    Off = 0
