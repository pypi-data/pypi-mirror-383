...
class ImportedAeroacousticSource(object):
    ...
    def SyncAnalysisFrequencies(self) -> None:
        """
...
class ImportedLoadGroup(object):
    ...
    def AddImportedCFDPressure(self) -> Ansys.ACT.Automation.Mechanical.ImportedLoads.ImportedPressure:
        """
