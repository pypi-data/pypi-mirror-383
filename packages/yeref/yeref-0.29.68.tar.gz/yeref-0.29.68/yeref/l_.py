...
l_chat_join_request_handler = {
    "ru": "<blockquote>👮🏽 {0}, ты отправил(а) заявку на вступление в <b>{1}</b>\n\n👩🏽‍💻 <b>Выбери</b> <i>правильный вариант</i> в соответствии с заданием на картинке, чтобы твоя <i>заявка</i> на вступление была <b>одобрена</b></blockquote>",
...
l_mute_handler_chn = {
    'ru': "<blockquote>💤 <b>Канал</b> <b>{0}</b> обеззвучен на {1}</blockquote>",
    'en': "💤 <b>User</b> {0} muted on {1}",
    'es': "💤 <b>Usuario</b> {0} silenciado el {1}",
    'fr': "💤 <b>Utilisateur</b> {0} mis en sourdine sur {1}",
    'zh': "💤 <b>用户</b> {0} 在 {1} 静音",
...
l_grp_need_super = {
    "ru": "🚫 @{0}-бот удален из <b>{1}</b> [id=<code>{2}</code>]. Группа слишком маленькая, необходимо дождаться преобразовавния в супергруппу",
    "en": "🚫 @{0}-bot removed from <b>{1}</b> [id=<code>{2}</code>]",
    "es": "🚫 @{0}-bot eliminado de <b>{1}</b> [id=<code>{2}</code>]",
    "fr": "🚫 @{0}-bot supprimé de <b>{1}</b> [id=<code>{2}</code>]",
    "zh": "🚫 @{0}-bot 已从 <b>{1}</b> [id=<code>{2}</code>] 中删除",
