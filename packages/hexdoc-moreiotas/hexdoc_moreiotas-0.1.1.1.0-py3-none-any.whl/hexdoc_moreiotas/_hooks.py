...
import hexdoc_moreiotas

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class MoreIotasPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return MoreIotasModPlugin(branch=branch)


class MoreIotasModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "moreiotas"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_moreiotas, "_templates"
