...
from guinsoft_ragas import evaluate as ragas_evaluate
from guinsoft_ragas.evaluation import Result
...
def evaluate(
    ...
    >>> from guinsoft_ragas.metrics import faithfulness, answer_relevancy, context_precision
    >>> from guinsoft_ragas.metrics.critique import harmfulness
    >>> from guinsoft_ragas.llama_index import evaluate
