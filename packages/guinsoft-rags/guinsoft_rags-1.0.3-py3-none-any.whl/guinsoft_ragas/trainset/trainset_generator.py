...
from guinsoft_ragas.llms import llm_factory
from guinsoft_ragas.trainset.prompts import (
    ANSWER_FORMULATE,
    COMPRESS_QUESTION,
...
from guinsoft_ragas.trainset.utils import load_as_score
from guinsoft_ragas.utils import load_as_json
...
class TrainsetGenerator:
    ...
    chat_qa: float
        Determines the fraction of conversational questions the resulting train set.
    chunk_size: int
    ...
    def from_default(
        cls,
        openai_generator_llm: str = "gpt-4-1106-preview",
        openai_filter_llm: str = "gpt-4-1106-preview",
        chat_qa: float = 0.3,
        chunk_size: int = 512,
