...
from guinsoft_ragas.embeddings.base import embedding_factory
from guinsoft_ragas.exceptions import OpenAIKeyNotFound
...
if t.TYPE_CHECKING:
    ...
    from guinsoft_ragas.embeddings.base import RagasEmbeddings
