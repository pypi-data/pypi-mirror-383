...
@dataclass
# class AnswerRecallGuinsoft(MetricWithLLM, isgtsplitdone):
class AnswerRecallGuinsoft(MetricWithLLM):
    ...
    """
    name: tuple = ("gt_split_point_out", "analyse","guinsoft_recall")
...
answer_recall_guinsoft = AnswerRecallGuinsoft()
