...
class BarChart(Chart):
    ...
    def _build_chart(self, request: HttpRequest, id: str) -> BarChartContext:
        font = TTFont(Path(__file__).resolve().parent.parent.parent.parent.parent / "fonts" / "NotoSerif.ttf")
        ...
        y_grid_lines = build_y_grid_lines(
            ...
            space=Space(
                ...
                bottom_right=Point(x=self.width_in_px, y=self.height_in_px-x_axis_height),
            ),
        )
        ...
        bars = build_bars(
            ...
            space=Space(
                ...
                bottom_right=Point(x=self.width_in_px-bar_width, y=self.height_in_px-x_axis_height),
            ),
        )
