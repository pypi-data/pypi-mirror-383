...
{
    "distutils": {
        "name": "first_dance.logs",
        "sources": [
            "first_dance/logs.pyx"
        ]
    },
    "module_name": "first_dance.logs"
}
END: Cython Metadata */
...
#define __PYX_HAVE__first_dance__logs
#define __PYX_HAVE_API__first_dance__logs
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "first_dance.logs" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "first_dance.logs"
extern int __pyx_module_is_main_first_dance__logs;
int __pyx_module_is_main_first_dance__logs = 0;

/* Implementation of "first_dance.logs" */
...
__Pyx_RefNannySetupContext("PyInit_logs", 0);
  ...
  if (__pyx_module_is_main_first_dance__logs) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "first_dance.logs")) {
      if (unlikely((PyDict_SetItemString(modules, "first_dance.logs", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init first_dance.logs", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init first_dance.logs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
