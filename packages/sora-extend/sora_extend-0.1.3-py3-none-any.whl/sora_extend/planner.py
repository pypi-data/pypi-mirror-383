...
def plan_prompts_with_ai(
    ...
    if print_progress:
        ...
        console.print(
            Padding(
                Panel.fit(
                    "[bold cyan]Step 1.1:[/bold cyan] Preparing planning request",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
...
""".strip()
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    f"[bold cyan]Step 1.2:[/bold cyan] Calling {planner_model} for segment planning",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    "[bold cyan]Step 1.3:[/bold cyan] Parsing AI response",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    "[bold cyan]Step 1.4:[/bold cyan] Validating and formatting segments",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
