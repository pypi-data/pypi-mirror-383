...
def concatenate_segments(
    segment_paths: list[Path], out_path: Path, print_progress: bool = True
) -> Path:
    """
    ...
    if print_progress:
        ...
        console.print(
            Padding(
                Panel.fit(
                    f"[bold cyan]Step 3.1:[/bold cyan] Loading {len(segment_paths)} video segments",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    "[bold cyan]Step 3.2:[/bold cyan] Combining video segments",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    f"[bold cyan]Step 3.3:[/bold cyan] Writing final video to {out_path.name}",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
    ...
    if print_progress:
        console.print(
            Padding(
                Panel.fit(
                    "[bold cyan]Step 3.4:[/bold cyan] Cleaning up resources",
                    border_style="cyan",
                ),
                (0, 0, 0, 4),
            )
