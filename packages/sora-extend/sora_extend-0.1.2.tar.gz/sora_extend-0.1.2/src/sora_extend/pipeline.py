    ...
    for i, seg in enumerate(segments, start=1):
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.1:[/bold cyan] Creating video generation job",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.2:[/bold cyan] Job started: {job['id']} | status: {job['status']}",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
            ...
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.3:[/bold cyan] Polling for completion",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.4:[/bold cyan] Downloading video segment",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.5:[/bold cyan] Saved to {seg_path}",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.6:[/bold cyan] Extracting last frame for continuity",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
        ...
        if print_progress:
            console.print(
                Padding(
                    Panel.fit(
                        f"[bold cyan]Step 2.{i}.7:[/bold cyan] Saved reference frame → {frame_path.name}",
                        border_style="cyan",
                    ),
                    (0, 0, 0, 4),
                )
