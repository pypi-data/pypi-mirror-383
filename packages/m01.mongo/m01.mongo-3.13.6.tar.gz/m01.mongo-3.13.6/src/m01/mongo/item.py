...
@zope.interface.implementer(interfaces.IMongoContainerItem,
...
@zope.interface.implementer(interfaces.IMongoStorageItem,
    interfaces.IMongoParentAware, zope.location.interfaces.ILocation)
...
@zope.interface.implementer(interfaces.ISecureMongoContainerItem,
    interfaces.IMongoParentAware, zope.location.interfaces.ILocation)
...
@zope.interface.implementer(interfaces.ISecureMongoStorageItem,
    interfaces.IMongoParentAware, zope.location.interfaces.ILocation)
...
@zope.interface.implementer(interfaces.IMongoSubObject,
    zope.location.interfaces.ILocation)
class MongoSubObject(base.MongoSubObjectBase):
    """Mongo sub Object class"""


@zope.interface.implementer(interfaces.IMongoObject,
    zope.location.interfaces.ILocation)
