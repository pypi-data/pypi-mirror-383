...
setup provides the following variables:
  ...
  >>> p01.env.getEnviron('P01_ENV_TEST_UNICODE', required=True)
  u'42'

  >>> p01.env.getEnviron('P01_ENV_TEST_STRING', required=True, rType=str)
  'Hello World'
...
or a custom converter will show an error like:
  ...
  Traceback (most recent call last):
  ...
  ValueError: p01.env key "P01_ENV_TEST_STRING" convertion failed for value "Hello World" with error: "could not convert string to float: Hello World"
