...
def angle_of_cluster(trajectory, wrap=False, initial=0, N_cutoff=1):
    ...
    phi_cluster = cumulative_trapezoid(dphi_avg, initial=initial)  # angle integral of differential angles
...
def transform_to_lattice(trajectory, lattice):
    ...
    return np.einsum("Tij,TNj->TNi", R, P)
