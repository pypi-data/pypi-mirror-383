...
class _vap( Mcush.Mcush ):
    DEFAULT_NAME = 'VAP'
    DEFAULT_IDN = re_compile( r'VAP.*,([0-9]+\.[0-9]+.*)' )
...
class VAP100( _vap):
    ...
    DEFAULT_NAME = 'VAP100'
    DEFAULT_IDN = re_compile( r'VAP1[0-9]*.*,([0-9]+\.[0-9]+.*)' )
...
class VAP200( _vap ):
    ...
    DEFAULT_NAME = 'VAP200'
    DEFAULT_IDN = re_compile( r'VAP2[0-9]*.*,([0-9]+\.[0-9]+.*)' )
...
class VAP200Extend( Mcush.Mcush ):
    ...
    DEFAULT_IDN = re_compile( r'VAP200Extend,([0-9]+\.[0-9]+.*)' )
