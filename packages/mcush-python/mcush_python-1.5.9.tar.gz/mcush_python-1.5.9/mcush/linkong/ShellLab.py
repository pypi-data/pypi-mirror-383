...
class ShellLab(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab(-[A-Z][0-9a-zA-Z\-]*)?,([0-9]+\.[0-9]+.*)' )
...
class ShellLabLamp(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-L1[a-zA-Z]*,([0-9]+\.[0-9]+.*)' )
...
class ShellLabStrip(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-L2[a-zA-Z]*,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSpotLight(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-SpotLight,([0-9]+\.[0-9]+.*)' )
...
class ShellLabCAN(ShellLab):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-C[0-9a-zA-Z\-]*,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSegmentDisplay(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-L3[a-zA-Z]*,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensor(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-[A-Z][0-9a-zA-Z]*,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorT(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-T,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorTH(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-TH,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorEncoder(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-Encoder,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorPH(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-PH,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorPressure(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-Pressure,([0-9]+\.[0-9]+.*)' )
...
class ShellLabSensorWeight(ShellLabSensor):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-Sensor-Weight,([0-9]+\.[0-9]+.*)' )
...
class ShellLabHID(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-HID,([0-9]+\.[0-9]+.*)' )
...
class ShellLabKeySwitch(Mcush.Mcush):
    ...
    DEFAULT_IDN = re_compile( r'ShellLab-K[0-9][a-zA-Z]*,([0-9]+\.[0-9]+.*)' )
