...
myst_url_schemes = {
    ...
    "gh-issue": {
        "url": "https://github.com/aknierim/labreportpy/issue/{{path}}#{{fragment}}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
}
...
json_url = "https://labreportpy.readthedocs.io/en/latest/_static/switcher.json"
...
html_theme_options = {
    ...
    "announcement": """
        <p>labreportpy is not stable yet, so expect large and rapid
        changes to structure before the 1.0 release.</p>
    """,
}
