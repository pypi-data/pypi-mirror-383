"""
XGBoost Genetic Algorithm Optimizer

Genetic algorithm-based hyperparameter optimization for XGBoost models.
...
class XGBoostGA:
    ...
    Optimizes XGBoost hyperparameters using genetic algorithm with:
    ...
    Example:
        >>> from kaggler.tabular import XGBoostGA
        >>> optimizer = XGBoostGA(population_size=20, n_generations=10)
    ...
    def __init__(
        ...
        """
        Initialize XGBoostGA optimizer.
        ...
        Args:
            ...
            early_stopping_rounds: Early stopping for XGBoost
        ...
        self.best_individual: Optional[XGBoostIndividual] = None
        self.best_model = None
        self.population: List[XGBoostIndividual] = []
    ...
    def _create_individual(self) -> XGBoostIndividual:
        ...
        return XGBoostIndividual(params=params)

    def _evaluate_fitness(
        self,
        individual: XGBoostIndividual,
        X: pd.DataFrame,
        y: pd.Series,
    ) -> float:
        """
        ...
        try:
            ...
            model = xgb.XGBClassifier(**individual.params)
            ...
            scores = cross_val_score(
                ...
                y,
                cv=self.n_folds,
                scoring="roc_auc" if self.eval_metric == "auc" else "accuracy",
                n_jobs=1,  # XGBoost already uses parallel processing
            )
    ...
    def _crossover(
        self,
        parent1: XGBoostIndividual,
        parent2: XGBoostIndividual,
    ) -> Tuple[XGBoostIndividual, XGBoostIndividual]:
        """
        ...
        for key in ["objective", "eval_metric", "tree_method", "random_state", "n_jobs"]:
            child1_params[key] = parent1.params[key]
            child2_params[key] = parent2.params[key]

        return (
            XGBoostIndividual(params=child1_params),
            XGBoostIndividual(params=child2_params),
        )

    def _mutate(self, individual: XGBoostIndividual) -> XGBoostIndividual:
        """
        ...
        return XGBoostIndividual(params=mutated_params)
    ...
    def optimize(
        ...
        # Create model without early_stopping_rounds in params
        model_params = {k: v for k, v in self.best_individual.params.items() if k != 'early_stopping_rounds'}
    ...
    def get_feature_importance(self) -> pd.DataFrame:
        ...
        elif hasattr(self.best_model, 'get_booster') and hasattr(self.best_model.get_booster(), 'feature_names'):
