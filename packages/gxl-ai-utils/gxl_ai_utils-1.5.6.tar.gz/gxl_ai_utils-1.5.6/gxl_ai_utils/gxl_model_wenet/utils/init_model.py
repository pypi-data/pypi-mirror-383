...
from ..ctl_model.asr_model_ctl import CTLModel
...
def init_model(args, configs):
    if 'paraformer' in configs:
        ...
        """
        from ..utils.init_ali_paraformer import (init_model as
    ...
    if 'ctlmodel' in configs:
        from ..ctl_model.encoder import DualConformerEncoder as ConformerEncoder
        from ..ctl_model.encoder import DualTransformerEncoder as TransformerEncoder
    else:
