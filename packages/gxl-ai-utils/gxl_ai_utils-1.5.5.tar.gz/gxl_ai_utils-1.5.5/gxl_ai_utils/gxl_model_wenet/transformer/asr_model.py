...
from ..transformer.search import (ctc_greedy_search,
...
class ASRModel(torch.nn.Module):
    ...
    def __init__(
        ...
        """
        耿雪龙:
            总的模型训练骨架. 音频编码器将声音编码为若干隐层表示向量, 编码器根据音频特征和输入的时间步
            前得到的文字信息(的特征编码)得到当前时间步的文本输出. 中间使用ctc直接得到输出声音, 不借助
            文本信息, 将其ctc_loss以一定权重加到总损失中.
        Args:
            vocab_size:
            encoder:
            decoder:
    ...
    def forward_attention_decoder(
        ...
        #   Issue: https://github.com/.-e2e/./issues/1113
        # Equal to:
