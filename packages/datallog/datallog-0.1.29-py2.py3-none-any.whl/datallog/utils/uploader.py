...
def upload(filename: str, file: bytes, max_size: int = 1, authorization: str = None, x_api_key: str = None):
    payload = {
            "filename": filename,
            "max_size": max_size
        }
    ...
    response = requests.post('https://api-mwm.datallog.com/uploader/get-presigned-url', headers=headers, json=payload)
