...
class ExplainCommandFunction(FunctionPlugin):
    ...
    description = "Explain what a shell command does, with safety analysis and alternatives"
    category = "shell"
    parameters = {}
    ...
    function_description = "Explain what a shell command does, with safety analysis and alternatives"
