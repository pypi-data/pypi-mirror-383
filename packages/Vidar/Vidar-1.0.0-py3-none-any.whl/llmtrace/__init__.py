...
from llmtrace.api import BatchedAPIExporter, CustomAPIExporter
...
class ObservabilitySDK:
    ...
    def _shutdown(self, timeout_ms: int = 5000):
        ...
        try:
            ...
            print(f"[LLMTrace] Successfully flushed all traces.")
        except Exception as e:
            print(f"[LLMTrace] Warning: Failed to flush traces on shutdown: {e}")
