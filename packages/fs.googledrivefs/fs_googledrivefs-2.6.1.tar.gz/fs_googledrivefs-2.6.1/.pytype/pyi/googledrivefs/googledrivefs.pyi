...
import logging
import os
from typing import Any, Dict, Generator, NoReturn, Optional, Tuple, Type, TypeVar, Union, overload
...
class GoogleDriveFS(Any):
    ...
    def _download_to_file(self, path, metadata, file_obj, chunk_size) -> NoReturn: ...
    def _export_as(self, path, metadata, file_obj, chunk_size, mimeType) -> NoReturn: ...
    ...
    def makedir(self, path, permissions = ..., recreate = ...) -> SubGoogleDriveFS: ...
    ...
    def search(self, condition) -> Generator[Any, Any, None]: ...
    def setinfo(self, path, info) -> None: ...
    def share(self, path, email = ..., role = ...) -> str: ...
...
def _GenerateChildren(children, page) -> Generator[Any, Any, None]: ...
