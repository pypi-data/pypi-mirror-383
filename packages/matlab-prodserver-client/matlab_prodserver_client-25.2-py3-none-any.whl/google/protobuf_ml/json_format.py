...
_WKTJSONMETHODS = {
    'google.protobuf_ml.Any': ['_AnyMessageToJsonObject', '_ConvertAnyMessage'],
    'google.protobuf_ml.Duration': [
        '_GenericMessageToJsonObject',
        '_ConvertGenericMessage',
    ],
    'google.protobuf_ml.FieldMask': [
        '_GenericMessageToJsonObject',
        '_ConvertGenericMessage',
    ],
    ...
    'google.protobuf_ml.Struct': [
        '_StructMessageToJsonObject',
        '_ConvertStructMessage',
    ],
    'google.protobuf_ml.Timestamp': [
        '_GenericMessageToJsonObject',
        '_ConvertGenericMessage',
    ],
    'google.protobuf_ml.Value': [
