...
class BrowserSession:
    ...
    def extract_content(self, include_interactive: bool = True, include_anchors: bool = True,
                       max_anchors: int = 50) -> Dict[str, Any]:
        """Extract LLM-friendly content with clean text, interactive elements, and anchors"""
        return self.client.browser_extract_content(self.session_id, include_interactive,
...
class BrowserManager:
    ...
    def extract_content(self, session_id: str = None, include_interactive: bool = True,
                       include_anchors: bool = True, max_anchors: int = 50) -> Dict[str, Any]:
        """Extract LLM-friendly content (auto-creates session if none provided)"""
        if not session_id:
            session_id = self._ensure_default_session()
        return self.client.browser_extract_content(session_id, include_interactive,
                                                   include_anchors, max_anchors)
...
class InstaVM:
    ...
    def browser_extract_content(self, session_id: str, include_interactive: bool = True,
                                include_anchors: bool = True, max_anchors: int = 50) -> Dict[str, Any]:
        """
        ...
        Example:
            ```python
            content = client.browser_extract_content(session_id)
        ...
        url = f"{self.base_url}/v1/browser/interactions/content"
        headers = {"X-API-Key": self.api_key}
        data = {
            "session_id": session_id,
