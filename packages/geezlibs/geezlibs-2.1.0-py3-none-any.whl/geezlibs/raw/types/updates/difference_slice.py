...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Parameters:
        new_messages (List of :obj:`Message <geezlibs.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <geezlibs.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <geezlibs.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <geezlibs.raw.base.updates.State>`):
            N/A
