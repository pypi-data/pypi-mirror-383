...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezlibs.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <geezlibs.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <geezlibs.raw.base.PopularContact>`):
            N/A
