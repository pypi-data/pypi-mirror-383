...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezlibs.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <geezlibs.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <geezlibs.raw.base.VideoSize>`, *optional*):
            N/A
