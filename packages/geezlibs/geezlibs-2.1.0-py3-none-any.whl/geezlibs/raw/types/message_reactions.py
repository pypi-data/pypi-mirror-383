...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezlibs.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <geezlibs.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <geezlibs.raw.base.MessagePeerReaction>`, *optional*):
            N/A
