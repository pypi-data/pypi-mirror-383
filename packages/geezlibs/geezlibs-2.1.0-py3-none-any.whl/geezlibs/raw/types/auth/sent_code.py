...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezlibs.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <geezlibs.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <geezlibs.raw.base.auth.CodeType>`, *optional*):
            N/A
