...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~geezlibs.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <geezlibs.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <geezlibs.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <geezlibs.raw.base.PremiumSubscriptionOption>`):
            N/A
