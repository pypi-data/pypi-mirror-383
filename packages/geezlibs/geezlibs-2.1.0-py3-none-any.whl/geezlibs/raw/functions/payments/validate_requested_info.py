...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <geezlibs.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <geezlibs.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <geezlibs.raw.base.payments.ValidatedRequestedInfo>`
    """
