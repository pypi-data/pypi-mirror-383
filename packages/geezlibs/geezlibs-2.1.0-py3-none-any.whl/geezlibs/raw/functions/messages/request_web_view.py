...
class RequestWebView(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <geezlibs.raw.base.InputUser>`):
            N/A
        ...
        theme_params (:obj:`DataJSON <geezlibs.raw.base.DataJSON>`, *optional*):
            N/A
        ...
        send_as (:obj:`InputPeer <geezlibs.raw.base.InputPeer>`, *optional*):
            N/A

    Returns:
        :obj:`WebViewResult <geezlibs.raw.base.WebViewResult>`
    """
