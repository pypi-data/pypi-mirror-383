...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <geezlibs.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <geezlibs.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <geezlibs.raw.base.account.EmailVerified>`
    """
