...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        file (:obj:`InputFile <geezlibs.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <geezlibs.raw.base.InputFile>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`photos.Photo <geezlibs.raw.base.photos.Photo>`
    """
