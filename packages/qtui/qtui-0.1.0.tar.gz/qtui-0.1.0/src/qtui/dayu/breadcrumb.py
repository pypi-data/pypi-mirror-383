...
from .button_group import MButtonGroup
from .label import MLabel
from .tool_button import MToolButton
from .types import MBreadcrumbData
...
class MBreadcrumb(QtWidgets.QWidget):
    ...
    def __init__(self, separator: str = "/", parent: QtWidgets.QWidget | None = None):
        ...
        self._button_group = MButtonGroup[MToolButton]()
        self._label_list: list[MLabel] = []

    def set_item_list(self, data_list: list[MBreadcrumbData]):
    ...
    def add_item(self, data_dict: MBreadcrumbData, index: int | None = None):
        """Add a item"""
        button = MToolButton()
