...
class FluColors(QObject):
    ...
    def createAccentColor(self, val: QColor) -> FluAccentColor:
        accent_color = FluAccentColor(self)
        accent_color.normal = val
        accent_color.dark = FluTools().withOpacity(val, 0.9)
        accent_color.light = FluTools().withOpacity(val, 0.9)
        accent_color.darker = FluTools().withOpacity(accent_color.dark, 0.8)
        accent_color.lighter = FluTools().withOpacity(accent_color.light, 0.8)
        accent_color.darkest = FluTools().withOpacity(accent_color.darker, 0.7)
        accent_color.lightest = FluTools().withOpacity(accent_color.lighter, 0.7)
        return accent_color
