...
class MBlockButtonGroup(MButtonGroupBase[MBlockButton]):
    """MBlockButtonGroup"""
...
class MMenuTabWidget(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        bar_widget.setAttribute(QtCore.Qt.WidgetAttribute.WA_StyledBackground)
    ...
    def add_menu(self, data_dict: MButtonGroupData, index: int | None = None):
        """Add a menu"""
