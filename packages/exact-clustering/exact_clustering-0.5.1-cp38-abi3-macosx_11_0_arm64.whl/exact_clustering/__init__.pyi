...
class WeightedKMedianL1:
    def __new__(cls, data:typing.Sequence[tuple[builtins.float, typing.Sequence[builtins.float]]]) -> WeightedKMedianL1: ...
    def price_of_hierarchy(self) -> builtins.float: ...
    def price_of_greedy(self) -> builtins.float: ...

class WeightedKMedianL2:
    def __new__(cls, data:typing.Sequence[tuple[builtins.float, typing.Sequence[builtins.float]]]) -> WeightedKMedianL2: ...
    def price_of_hierarchy(self) -> builtins.float: ...
    def price_of_greedy(self) -> builtins.float: ...

class WeightedKMedianL2Squared:
    def __new__(cls, data:typing.Sequence[tuple[builtins.float, typing.Sequence[builtins.float]]]) -> WeightedKMedianL2Squared: ...
    def price_of_hierarchy(self) -> builtins.float: ...
    def price_of_greedy(self) -> builtins.float: ...
