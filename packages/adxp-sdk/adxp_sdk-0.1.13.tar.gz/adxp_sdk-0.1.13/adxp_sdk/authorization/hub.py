...
class AXAuthorizationHub:
    """
    SDK for managing Projects, Roles, Users, and Groups
    """

    def __init__(self, credentials: BaseCredentials, headers: Dict[str, str] = None, base_url: str = None):
        """
        Initialize the authorization hub object.

        Args:
            credentials: Authentication credentials (BaseCredentials)
            headers: HTTP headers (deprecated, use credentials instead)
            base_url: Base URL (deprecated, use credentials instead)
        """
