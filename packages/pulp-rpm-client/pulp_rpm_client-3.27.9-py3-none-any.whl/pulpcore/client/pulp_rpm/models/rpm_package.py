...
class RpmPackage(object):
    ...
    @property
    def file_url(self):
        """Gets the file_url of this RpmPackage.  # noqa: E501

        A url that Pulp can download and turn into the content unit.  # noqa: E501

        :return: The file_url of this RpmPackage.  # noqa: E501
        :rtype: str
        """
    ...
    def file_url(self, file_url):
        """Sets the file_url of this RpmPackage.

        A url that Pulp can download and turn into the content unit.  # noqa: E501

        :param file_url: The file_url of this RpmPackage.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
