...
class RpmPackageGroupResponse(object):
    ...
    def __init__(self, pulp_href=None, prn=None, pulp_created=None, pulp_last_updated=None, id=None, default=None, user_visible=None, display_order=None, name=None, description=None, packages=None, biarch_only=None, desc_by_lang=None, name_by_lang=None, digest=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def prn(self):
        """Gets the prn of this RpmPackageGroupResponse.  # noqa: E501

        The Pulp Resource Name (PRN).  # noqa: E501

        :return: The prn of this RpmPackageGroupResponse.  # noqa: E501
        :rtype: str
        """
        return self._prn
    ...
    @prn.setter
    def prn(self, prn):
        """Sets the prn of this RpmPackageGroupResponse.

        The Pulp Resource Name (PRN).  # noqa: E501

        :param prn: The prn of this RpmPackageGroupResponse.  # noqa: E501
        :type: str
        """
