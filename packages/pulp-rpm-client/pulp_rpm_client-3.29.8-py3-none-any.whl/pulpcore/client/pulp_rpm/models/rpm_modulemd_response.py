...
class RpmModulemdResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "pulp_labels", "name", "stream", "version", "static_context", "context", "arch", "artifacts", "dependencies", "packages", "profiles", "description"]
