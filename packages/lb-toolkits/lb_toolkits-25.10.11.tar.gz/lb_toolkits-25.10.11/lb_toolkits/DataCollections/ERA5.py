...
class DataCollectionERA5 :
    ...
    ERA5_HOUR_Single_Levels = DataCollectionDefinition(
        api_id = 'ERA5',
        collections = "reanalysis-era5-single-levels",
    ...
    ERA5_HOUR_Pressure_Levels = DataCollectionDefinition(
        api_id = 'ERA5',
        collections = "reanalysis-era5-pressure-levels",
        productType = 'reanalysis',
        bands = [
            "divergence",
    ...
    ERA5_HOUR_Land = DataCollectionDefinition(
        api_id = 'ERA5',
        collections = "reanalysis-era5-land",
        productType = None,
        bands = [
            "2m_dewpoint_temperature",
            "2m_temperature",
    ...
    ERA5_MONTH_Land = DataCollectionDefinition(
        api_id = 'ERA5',
        collections = "reanalysis-era5-land-monthly-means",
        ...
        description = 'ERA5-Land monthly averaged data from 1950 to present'
    )
