...
from .ERA5 import DataCollectionERA5

from .ESA import DataCollectionESA
from .USGS import DataCollectionUSGS

from .JMA import DataCollectionAHI, DataCollectionGOSAT
from .OTHER import *
from .EUMDAC import DataCollectionEUMDAC
from .NOAA import DataCollectionNOAA

class DataCollections(
    DataCollectionNOAA,
    DataCollectionEUMDAC,
    DataCollectionFY,
    DataCollectionHY,
    DataCollectionAHI,
    DataCollectionGFS,
