...
The full [API documentation](API.md) has more details.  A quick example can
motivate usage.  Not all the capabilities of this package are shown in the
below code, but most of the typical patterns are present.
