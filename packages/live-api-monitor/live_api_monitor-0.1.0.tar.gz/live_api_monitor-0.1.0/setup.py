...
setup(
    ...
    url='https://github.com/mount-isaac/api-watch-dog',
    ...
    project_urls={
        "Bug Reports": "https://github.com/mount-isaac/api-watch-dog/issues",
        "Source": "https://github.com/mount-isaac/api-watch-dog",
    }
)