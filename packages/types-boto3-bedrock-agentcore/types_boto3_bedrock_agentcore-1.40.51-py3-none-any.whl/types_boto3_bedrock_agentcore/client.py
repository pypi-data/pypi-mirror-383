...
class BedrockAgentCoreDataPlaneFrontingLayerClient(BaseClient):
    ...
    def batch_create_memory_records(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#batch_create_memory_records)
        """
    ...
    def batch_delete_memory_records(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#batch_delete_memory_records)
        """
    ...
    def batch_update_memory_records(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#batch_update_memory_records)
        """
    ...
    def complete_resource_token_auth(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#complete_resource_token_auth)
        """
    ...
    def get_agent_card(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#get_agent_card)
        """
    ...
    def stop_runtime_session(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_bedrock_agentcore/client/#stop_runtime_session)
        """
