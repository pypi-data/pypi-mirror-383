...
class ServiceOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "allFieldsRaw", "defaultInstanceForType", "deprecated", "descriptorForType", "features", "featuresOrBuilder", "initializationErrorString", "initialized", "memoizedSerializedSize", "parserForType", "serializedSize", "uninterpretedOptionCount", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "unknownFields"]
