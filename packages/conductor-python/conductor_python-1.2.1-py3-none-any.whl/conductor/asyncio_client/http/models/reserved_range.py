...
class ReservedRange(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "end", "initializationErrorString", "initialized", "memoizedSerializedSize", "parserForType", "serializedSize", "start", "unknownFields"]
