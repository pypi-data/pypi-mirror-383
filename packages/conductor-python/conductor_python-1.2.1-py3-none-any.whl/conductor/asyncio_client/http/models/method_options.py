...
class MethodOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "allFieldsRaw", "defaultInstanceForType", "deprecated", "descriptorForType", "features", "featuresOrBuilder", "idempotencyLevel", "initializationErrorString", "initialized", "memoizedSerializedSize", "parserForType", "serializedSize", "uninterpretedOptionCount", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "unknownFields"]
