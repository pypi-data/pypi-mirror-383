...
class Group(BaseModel):
    ...
    Group
    """ # noqa: E501
    default_access: Optional[Dict[str, List[StrictStr]]] = Field(default=None, alias="defaultAccess")
    description: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    roles: Optional[List[Role]] = None
    __properties: ClassVar[List[str]] = ["defaultAccess", "description", "id", "roles"]
