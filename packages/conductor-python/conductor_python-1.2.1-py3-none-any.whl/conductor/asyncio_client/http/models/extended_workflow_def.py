...
class ExtendedWorkflowDef(BaseModel):
    """
    ExtendedWorkflowDef
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["createTime", "createdBy", "description", "enforceSchema", "failureWorkflow", "inputParameters", "inputSchema", "inputTemplate", "name", "outputParameters", "outputSchema", "overwriteTags", "ownerApp", "ownerEmail", "rateLimitConfig", "restartable", "schemaVersion", "tags", "tasks", "timeoutPolicy", "timeoutSeconds", "updateTime", "updatedBy", "variables", "version", "workflowStatusListenerEnabled", "workflowStatusListenerSink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedWorkflowDef from a JSON string"""
