...
class SourceCodeInfoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "locationCount", "locationList", "locationOrBuilderList", "unknownFields"]
