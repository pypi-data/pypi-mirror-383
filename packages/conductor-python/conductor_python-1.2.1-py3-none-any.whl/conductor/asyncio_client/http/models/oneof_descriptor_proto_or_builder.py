...
class OneofDescriptorProtoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "name", "nameBytes", "options", "optionsOrBuilder", "unknownFields"]
