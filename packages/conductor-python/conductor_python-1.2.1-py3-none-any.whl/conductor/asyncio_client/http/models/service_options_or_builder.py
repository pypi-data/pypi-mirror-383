...
class ServiceOptionsOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "deprecated", "descriptorForType", "features", "featuresOrBuilder", "initializationErrorString", "initialized", "uninterpretedOptionCount", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "unknownFields"]
