...
class ExtensionRangeOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "end", "initializationErrorString", "initialized", "options", "optionsOrBuilder", "start", "unknownFields"]
