...
class EditionDefaultOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "edition", "initializationErrorString", "initialized", "unknownFields", "value", "valueBytes"]
