...
class Declaration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "fullName", "fullNameBytes", "initializationErrorString", "initialized", "memoizedSerializedSize", "number", "parserForType", "repeated", "reserved", "serializedSize", "type", "typeBytes", "unknownFields"]
