...
class MethodDescriptorProtoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "clientStreaming", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "inputType", "inputTypeBytes", "name", "nameBytes", "options", "optionsOrBuilder", "outputType", "outputTypeBytes", "serverStreaming", "unknownFields"]
