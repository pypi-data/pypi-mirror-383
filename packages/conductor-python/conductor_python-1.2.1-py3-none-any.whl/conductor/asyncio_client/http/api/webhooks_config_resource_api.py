...
class WebhooksConfigResourceApi:
    ...
    async def create_webhook(
        ...
        :param webhook_config: (required)
        :type webhook_config: WebhookConfig
    ...
    @validate_call
    async def delete_tag_for_webhook(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
        ...
        _param = self._delete_tag_for_webhook_serialize(
            id=id,
            tag=tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def delete_tag_for_webhook_with_http_info(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_tag_for_webhook_without_preload_content(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    def _delete_tag_for_webhook_serialize(
        self,
        id,
        tag,
        _request_auth,
    ...
    async def get_all_webhook(
        ...
        _param = self._get_all_webhook_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_all_webhook_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_webhook_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_webhook_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def get_tags_for_webhook(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_tags_for_webhook_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_tags_for_webhook_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_tags_for_webhook_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_tags_for_webhook_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    async def put_tag_for_webhook(
        ...
        _param = self._put_tag_for_webhook_serialize(
            id=id,
            tag=tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def put_tag_for_webhook_with_http_info(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    @validate_call
    async def put_tag_for_webhook_without_preload_content(
        self,
        id: StrictStr,
        tag: List[Tag],
        _request_timeout: Union[
    ...
    def _put_tag_for_webhook_serialize(
        self,
        id,
        tag,
        _request_auth,
