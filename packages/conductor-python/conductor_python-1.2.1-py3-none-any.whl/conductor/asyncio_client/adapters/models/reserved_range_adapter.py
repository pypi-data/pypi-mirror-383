...
from conductor.asyncio_client.http.models import ReservedRange


class ReservedRangeAdapter(ReservedRange):
    all_fields: Optional[Dict[str, Any]] = Field(default=None, alias="allFields")
    default_instance_for_type: Optional["ReservedRangeAdapter"] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "defaultInstanceForType": (
                    ReservedRangeAdapter.from_dict(obj["defaultInstanceForType"])
