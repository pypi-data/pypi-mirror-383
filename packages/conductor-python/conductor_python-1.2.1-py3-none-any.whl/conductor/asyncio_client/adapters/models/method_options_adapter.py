...
class MethodOptionsAdapter(MethodOptions):
    ...
    default_instance_for_type: Optional["MethodOptionsAdapter"] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "defaultInstanceForType": (
                    MethodOptionsAdapter.from_dict(obj["defaultInstanceForType"])
...
MethodOptionsAdapter.model_rebuild(raise_errors=False)
