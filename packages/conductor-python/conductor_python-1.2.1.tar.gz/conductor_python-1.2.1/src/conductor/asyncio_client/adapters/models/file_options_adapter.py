...
from conductor.asyncio_client.http.models import FileOptions
...
class FileOptionsAdapter(FileOptions):
    ...
    default_instance_for_type: Optional["FileOptionsAdapter"] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "defaultInstanceForType": (
                    FileOptionsAdapter.from_dict(obj["defaultInstanceForType"])
