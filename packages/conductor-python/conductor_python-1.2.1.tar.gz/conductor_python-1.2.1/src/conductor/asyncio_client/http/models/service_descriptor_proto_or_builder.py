...
class ServiceDescriptorProtoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "methodCount", "methodList", "methodOrBuilderList", "name", "nameBytes", "options", "optionsOrBuilder", "unknownFields"]
