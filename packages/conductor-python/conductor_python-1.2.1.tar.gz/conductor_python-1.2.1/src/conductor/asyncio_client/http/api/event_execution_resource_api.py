...
class EventExecutionResourceApi:
    ...
    async def get_event_handlers_for_event1(
        ...
        _param = self._get_event_handlers_for_event1_serialize(
    ...
    @validate_call
    async def get_event_handlers_for_event1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchResultHandledEventResponse]:
        """Get All active Event Handlers for the last 24 hours
    ...
    @validate_call
    async def get_event_handlers_for_event1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_event_handlers_for_event1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def get_event_handlers_for_event2(
        ...
        _param = self._get_event_handlers_for_event2_serialize(
            event=event,
            var_from=var_from,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ExtendedEventExecution]",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def get_event_handlers_for_event2_with_http_info(
        self,
        event: StrictStr,
        var_from: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ExtendedEventExecution]]:
        """Get event handlers for a given event
    ...
    @validate_call
    async def get_event_handlers_for_event2_without_preload_content(
        self,
        event: StrictStr,
        var_from: StrictInt,
        _request_timeout: Union[
    ...
    def _get_event_handlers_for_event2_serialize(
        self,
        event,
        var_from,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/event/execution/{event}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
