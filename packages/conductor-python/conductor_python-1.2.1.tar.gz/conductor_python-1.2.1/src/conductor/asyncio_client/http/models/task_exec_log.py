...
class TaskExecLog(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdTime", "log", "taskId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskExecLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskExecLog from a dict"""
        if obj is None:
            return None
