...
class WorkflowSchedule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createTime", "createdBy", "cronExpression", "description", "name", "paused", "pausedReason", "runCatchupScheduleInstances", "scheduleEndTime", "scheduleStartTime", "startWorkflowRequest", "tags", "updatedBy", "updatedTime", "zoneId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowSchedule from a JSON string"""
