...
class LocationOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "leadingComments", "leadingCommentsBytes", "leadingDetachedCommentsCount", "leadingDetachedCommentsList", "pathCount", "pathList", "spanCount", "spanList", "trailingComments", "trailingCommentsBytes", "unknownFields"]
