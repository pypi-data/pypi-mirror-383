...
class FieldOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "allFieldsRaw", "ctype", "debugRedact", "defaultInstanceForType", "deprecated", "descriptorForType", "editionDefaultsCount", "editionDefaultsList", "editionDefaultsOrBuilderList", "features", "featuresOrBuilder", "initializationErrorString", "initialized", "jstype", "lazy", "memoizedSerializedSize", "packed", "parserForType", "retention", "serializedSize", "targetsCount", "targetsList", "uninterpretedOptionCount", "uninterpretedOptionList", "uninterpretedOptionOrBuilderList", "unknownFields", "unverifiedLazy", "weak"]
