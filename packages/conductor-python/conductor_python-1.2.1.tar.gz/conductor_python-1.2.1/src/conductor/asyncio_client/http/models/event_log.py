...
class EventLog(BaseModel):
    ...
    handler_name: Optional[StrictStr] = Field(default=None, alias="handlerName")
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "event", "eventType", "handlerName", "id", "taskId", "workerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "handlerName": obj.get("handlerName"),
            "id": obj.get("id"),
