...
class MetricsResourceApi:
    ...
    async def prometheus_task_metrics(
        ...
        _param = self._prometheus_task_metrics_serialize(
            task_name=task_name,
            start=start,
            end=end,
            step=step,
    ...
    @validate_call
    async def prometheus_task_metrics_with_http_info(
        self,
        task_name: StrictStr,
        start: StrictStr,
        end: StrictStr,
    ...
    @validate_call
    async def prometheus_task_metrics_without_preload_content(
        self,
        task_name: StrictStr,
        start: StrictStr,
        end: StrictStr,
    ...
    def _prometheus_task_metrics_serialize(
        self,
        task_name,
        start,
        end,
