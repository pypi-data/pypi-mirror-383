...
class StartWorkflowRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["correlationId", "createdBy", "externalInputPayloadStoragePath", "idempotencyKey", "idempotencyStrategy", "input", "name", "priority", "taskToDomain", "version", "workflowDef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartWorkflowRequest from a JSON string"""
