...
class UninterpretedOptionOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aggregateValue", "aggregateValueBytes", "allFields", "defaultInstanceForType", "descriptorForType", "doubleValue", "identifierValue", "identifierValueBytes", "initializationErrorString", "initialized", "nameCount", "nameList", "nameOrBuilderList", "negativeIntValue", "positiveIntValue", "stringValue", "unknownFields"]
