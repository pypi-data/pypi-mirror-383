...
class EnumDescriptorProtoOrBuilder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allFields", "defaultInstanceForType", "descriptorForType", "initializationErrorString", "initialized", "name", "nameBytes", "options", "optionsOrBuilder", "reservedNameCount", "reservedNameList", "reservedRangeCount", "reservedRangeList", "reservedRangeOrBuilderList", "unknownFields", "valueCount", "valueList", "valueOrBuilderList"]
