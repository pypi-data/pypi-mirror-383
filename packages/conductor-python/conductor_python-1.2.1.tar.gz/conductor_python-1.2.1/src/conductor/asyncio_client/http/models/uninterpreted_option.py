...
class UninterpretedOption(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aggregateValue", "aggregateValueBytes", "allFields", "defaultInstanceForType", "descriptorForType", "doubleValue", "identifierValue", "identifierValueBytes", "initializationErrorString", "initialized", "memoizedSerializedSize", "nameCount", "nameList", "nameOrBuilderList", "negativeIntValue", "parserForType", "positiveIntValue", "serializedSize", "stringValue", "unknownFields"]
