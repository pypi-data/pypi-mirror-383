"""Views for django-directory-cms package."""
...
def page_detail(request, slug):
    ...
    return render(request, "django_directory_cms/page_detail.html", context)
...
def page_list(request):
    ...
    return render(request, "django_directory_cms/page_list.html", context)
