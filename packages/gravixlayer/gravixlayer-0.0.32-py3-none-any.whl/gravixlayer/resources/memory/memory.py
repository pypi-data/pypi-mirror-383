"""
Memory management system for GravixLayer SDK - Mem0-like functionality
Uses GravixLayer vector database for storage and retrieval
"""
import os
import uuid
...
class Memory:
    """
    Mem0-like memory system using GravixLayer vector database
    Creates user-specific vector indexes for memory storage
    """
    ...
    def __init__(self, client, embedding_model: str = "text-embedding-ada-002", 
        ...
        self.working_memory_ttl = timedelta(hours=2)  # Working memory expires after 2 hours
        self.agent = MemoryAgent(client, inference_model)
    ...
    async def _ensure_user_index(self, user_id: str) -> str:
        """
    ...
    async def add(self, content: Union[str, List[Dict[str, str]]], user_id: str, 
        ...
        index_id = await self._ensure_user_index(user_id)
    ...
    async def get_memories_by_type(self, user_id: str, memory_type: MemoryType, 
        ...
        try:
            ...
            all_vectors = await vectors.list()
