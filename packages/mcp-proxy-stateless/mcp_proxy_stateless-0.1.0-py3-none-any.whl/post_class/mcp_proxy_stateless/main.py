...
class StatelessStreamableHTTPClient:
    ...
    def __init__(self, url: str, headers: Dict[str, Any] | None = None, *, insecure: bool = False) -> None:
        self._url = url
...
async def _run(url: str, headers: Dict[str, str], *, insecure: bool) -> None:
    remote = StatelessStreamableHTTPClient(url=url, headers=headers, insecure=insecure)
...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        asyncio.run(_run(args.url, headers, insecure=args.insecure))
