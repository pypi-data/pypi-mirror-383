...
TOPIC_STATUS = "JCG123/1"
TOPIC_TEST = "door/lock/test"
...
def on_connect(client, userdata, flags, rc):
    ...
    if rc == 0:
        ...
        if not connected_once:
            ...
            client.publish(TOPIC_TEST, payload)
            connected_once = True
...
def publish_command(lock_id: str, value: str):
    """发布开关门指令"""
    payload = f'''{{
        "deviceID": "{lock_id}",
        "value": "{value}" 
...
# def get_last_status():
#     """返回最新的门锁状态"""
#     client.loop_read(TOPIC_STATUS)  # 处理网络事件，确保接收消息
#     return last_status
