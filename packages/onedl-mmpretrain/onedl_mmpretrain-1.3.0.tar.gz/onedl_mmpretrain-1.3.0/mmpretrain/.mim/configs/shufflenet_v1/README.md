...
```shell
python tools/test.py configs/shufflenet_v1/shufflenet-v1-1x_16xb64_in1k.py https://mmassets.onedl.ai/mmclassification/v0/shufflenet_v1/shufflenet_v1_batch1024_imagenet_20200804-5d6cec73.pth
```
