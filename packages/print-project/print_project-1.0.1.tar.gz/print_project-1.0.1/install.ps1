...
# ALTERNATIVE Usage: 
#   PowerShell: iwr -useb https://raw.githubusercontent.com/smaxiso/print-project/master/install.ps1 | iex
#   Or: Invoke-WebRequest -Uri "https://raw.githubusercontent.com/smaxiso/print-project/master/install.ps1" -UseBasicParsing | Invoke-Expression
