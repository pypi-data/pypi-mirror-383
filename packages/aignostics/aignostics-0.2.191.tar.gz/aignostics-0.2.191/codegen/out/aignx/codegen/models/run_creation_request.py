...
class RunCreationRequest(BaseModel):
    """
    Request schema for `Initiate Application Run` endpoint. It describes which application version is chosen, and which user data should be processed.
    """ # noqa: E501
    application_version_id: StrictStr = Field(description="Unique ID for the application version to use for processing. Must include version suffix (e.g., 'he-tme:v1.0.0-beta')")
    ...
    __properties: ClassVar[List[str]] = ["application_version_id", "metadata", "items"]
