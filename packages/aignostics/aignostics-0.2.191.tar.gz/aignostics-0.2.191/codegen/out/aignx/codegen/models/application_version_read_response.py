...
class ApplicationVersionReadResponse(BaseModel):
    """
    Response schema for `List Available Application Versions` endpoint
    """ # noqa: E501
    ...
    input_artifacts: List[InputArtifactReadResponse] = Field(description="Lists required input fields, that should be provided by the caller")
    output_artifacts: List[OutputArtifactReadResponse] = Field(description="Lists the structure of the output artifacts generated by the application")
