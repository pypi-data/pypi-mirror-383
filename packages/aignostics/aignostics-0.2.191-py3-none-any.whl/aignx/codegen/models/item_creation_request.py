...
class ItemCreationRequest(BaseModel):
    """
    Individual item (slide) to be processed in an application run.
    """ # noqa: E501
    reference: StrictStr = Field(description="Unique identifier for this item within the run. Used for referencing results. Must be unique across all items in the same application run")
    ...
    __properties: ClassVar[List[str]] = ["reference", "metadata", "input_artifacts"]
