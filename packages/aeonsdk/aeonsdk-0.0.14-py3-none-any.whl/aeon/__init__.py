...
class Aeon:
    ...
    # Orchestration
    @staticmethod
    async def send_task(to: str, event: str, from_: Optional[str] = None):
        """
        ...
        Parameters:
            task (dict): Information of the task recipient and the event to be send.
                ...
                - 'from_' (str, optional): Agent that send the event (handled internally).
        """
        ...
        try:
            ...
            id = await Aeon.track_trigger(from_, to, event)
