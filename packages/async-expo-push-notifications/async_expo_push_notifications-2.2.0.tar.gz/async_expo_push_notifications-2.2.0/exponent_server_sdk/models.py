...
class PushTicket(BaseModel):
    ...
    # Known error strings
    ERROR_DEVICE_NOT_REGISTERED: str = 'DeviceNotRegistered'
    ERROR_MESSAGE_TOO_BIG: str = 'MessageTooBig'
    ERROR_MESSAGE_RATE_EXCEEDED: str = 'MessageRateExceeded'
...
class PushReceipt(BaseModel):
    ...
    ERROR_MESSAGE_TOO_BIG: str = 'MessageTooBig'
    ERROR_MESSAGE_RATE_EXCEEDED: str = 'MessageRateExceeded'
    INVALID_CREDENTIALS: str = 'InvalidCredentials'
