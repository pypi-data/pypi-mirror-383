...
class VrpResource(SyncAPIResource):
    ...
    def evaluate(
        ...
        *,
        ...
        custom_distance_matrices: Optional[vrp_evaluate_params.CustomDistanceMatrices] | Omit = omit,
    ...
    def solve(
        ...
        *,
        ...
        custom_distance_matrices: Optional[vrp_solve_params.CustomDistanceMatrices] | Omit = omit,
        hook: Optional[str] | Omit = omit,
        label: Optional[str] | Omit = omit,
        options: Optional[OptionsParam] | Omit = omit,
        relations: Optional[Iterable[RelationParam]] | Omit = omit,
    ...
    def suggest(
        ...
        *,
        ...
        resources: Iterable[ResourceParam],
        millis: Optional[str] | Omit = omit,
        custom_distance_matrices: Optional[vrp_suggest_params.CustomDistanceMatrices] | Omit = omit,
        hook: Optional[str] | Omit = omit,
        label: Optional[str] | Omit = omit,
        options: Optional[OptionsParam] | Omit = omit,
        relations: Optional[Iterable[RelationParam]] | Omit = omit,
    ...
    def sync_evaluate(
        ...
        *,
        jobs: Iterable[JobParam],
        resources: Iterable[ResourceParam],
        custom_distance_matrices: Optional[vrp_sync_evaluate_params.CustomDistanceMatrices] | Omit = omit,
        hook: Optional[str] | Omit = omit,
        label: Optional[str] | Omit = omit,
        options: Optional[OptionsParam] | Omit = omit,
        relations: Optional[Iterable[RelationParam]] | Omit = omit,
    ...
    def sync_solve(
        ...
        *,
        ...
        resources: Iterable[ResourceParam],
        millis: Optional[str] | Omit = omit,
        custom_distance_matrices: Optional[vrp_sync_solve_params.CustomDistanceMatrices] | Omit = omit,
        hook: Optional[str] | Omit = omit,
        label: Optional[str] | Omit = omit,
        options: Optional[OptionsParam] | Omit = omit,
        relations: Optional[Iterable[RelationParam]] | Omit = omit,
    ...
    def sync_suggest(
        ...
        *,
        ...
        resources: Iterable[ResourceParam],
        millis: Optional[str] | Omit = omit,
        custom_distance_matrices: Optional[vrp_sync_suggest_params.CustomDistanceMatrices] | Omit = omit,
        hook: Optional[str] | Omit = omit,
        label: Optional[str] | Omit = omit,
        options: Optional[OptionsParam] | Omit = omit,
        relations: Optional[Iterable[RelationParam]] | Omit = omit,
