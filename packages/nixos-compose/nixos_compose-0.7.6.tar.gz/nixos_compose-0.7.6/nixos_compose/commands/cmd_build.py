...
from ..actions import get_nix_command, realpath_from_store, artifact_copy_all_kernel_initrd
...
def cli(
    ...
    if  mounted_store_url:
        build_cmd = [ "--extra-experimental-features", "mounted-ssh-store",
            "--store", f"mounted-ssh-ng://{mounted_store_url}"
        ]
