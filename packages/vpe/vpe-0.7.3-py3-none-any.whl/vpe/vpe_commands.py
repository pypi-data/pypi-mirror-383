...
class LogSubCommand(SubcommandHandlerBase):
    ...
    subcommands = {
        ...
        'toggle': (':simple', 'Toggle whether the log file buffer is shown.'),
    ...
    def handle_toggle(self, _args: Namespace) -> None:
        """Handle the 'Vpe log toggle' command."""
        core.log.toggle_shown()
