...
from pyagenity_api.cli.constants import CONFIG_FILENAMES, PROJECT_ROOT
from pyagenity_api.cli.exceptions import ConfigurationError
...
class ConfigManager:
    ...
    def find_config_file(self, config_path: str) -> Path:
        ...
        package_locations = [
            PROJECT_ROOT / "pyagenity_api" / config_path,
            PROJECT_ROOT / config_path,
        ]
