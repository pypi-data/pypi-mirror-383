Contributing to roman_snpit_utils
================================================
...
system and the Python, NumPy, and `roman_snpit_utils` versions you are using.

Contributing Code and Documentation
-----------------------------------

So you are interested in contributing to the roman_snpit_utils Project?  Excellent!
...
from GitHub users' forks of roman_snpit_utils If you are new to this
