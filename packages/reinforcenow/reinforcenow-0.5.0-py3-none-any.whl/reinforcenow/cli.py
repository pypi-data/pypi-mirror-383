...
def orgs():
    ...
    try:
        ...
        # Display organizations with current one highlighted
        ...
        for idx, org in enumerate(organizations, 1):
            ...
            if is_current:
                click.echo(f"  \033[92m▶ {idx}. {org_name}\033[0m (role: {org_role}) \033[92m[ACTIVE]\033[0m")
            else:
        ...
        selection = click.prompt(
            "Select an organization (enter number, or 'q' to quit)",
            type=str,
            default="q"
        )
