...
- ❌ Not supported: file://, ftp://, local paths, relative paths
        ...
        return [
            Prompt(
                ...
                arguments=[
                    PromptArgument(
                        name="url",
                        description="Enter a valid HTTP or HTTPS URL (e.g., https://example.com). Note: Local files and file:// URLs are not supported by this tool.",
                        required=True,
                    )
                ],
            )
