...
class AgentChatbot(Component):
    ...
    def example_value(self) -> Any:
        if self.type == "messages":
            TERMINAL_CONTENT = """Last login: Fri Oct 10 16:01:24 on ttys001
frank@MacBook-Pro ~ % pwd
/Users/frank
frank@MacBook-Pro ~ % ls -la
total 48
drwxr-xr-x+ 10 frank  staff    320 Oct 10 15:54 .
drwxr-xr-x   5 root   admin    160 Oct  8 09:12 ..
-rw-------@  1 frank  staff   6148 Oct 10 14:20 .DS_Store
drwx------   5 frank  staff    160 Oct  7 22:33 .ssh
drwxr-xr-x  14 frank  staff    448 Oct 10 15:50 Projects
drwxr-xr-x   3 frank  staff     96 Oct  9 11:08 Downloads
frank@MacBook-Pro ~ % cd Projects/dsa-scheduler
frank@MacBook-Pro dsa-scheduler % git status
On branch main
Your branch is up to date with 'origin/main'.

nothing to commit, working tree clean
frank@MacBook-Pro dsa-scheduler % python3 main.py --config configs/wan14b_sparse.json
[INFO]  Using config: configs/wan14b_sparse.json
[INFO]  Initializing DSA Scheduler (sparsity=0.9, overlap=true)...
[INFO]  Building attention graph...
[INFO]  Launching distributed kernels via Triton...
[INFO]  Overlap communication: enabled
[INFO]  Runtime started (14B params, 4 GPUs)
[INFO]  Processing prompt: 'A dog running through a snow field'
[INFO]  Generating video (16 frames, 512×512)...
[OK]    Done. Output saved to ./outputs/snowdog_001.mp4
frank@MacBook-Pro dsa-scheduler % ls outputs/
snowdog_001.mp4
frank@MacBook-Pro dsa-scheduler % ffprobe outputs/snowdog_001.mp4 | grep Duration
  Duration: 00:00:03.20, start: 0.000000, bitrate: 1258 kb/s
frank@MacBook-Pro dsa-scheduler % git pull
Already up to date.
frank@MacBook-Pro dsa-scheduler % echo 'Session completed ✅'
Session completed ✅
frank@MacBook-Pro dsa-scheduler %
            """
            return [
                Message(name="user", role="user", content="Help me search for weather in Singapore today.").model_dump(),
                Message(name="terminal", role="assistant", content=TERMINAL_CONTENT).model_dump(),
