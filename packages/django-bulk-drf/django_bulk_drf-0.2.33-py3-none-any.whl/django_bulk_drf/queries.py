...
class QueryOptimizer:
    ...
    def analyze(self):
        ...
        logger.debug(f"[QUERY OPTIMIZER] Analyzing serializer: {self.serializer_class.__name__}")
        ...
        logger.debug(f"[QUERY OPTIMIZER] Detected select_related: {self._select_related}")
        logger.debug(f"[QUERY OPTIMIZER] Detected prefetch_related: {self._prefetch_related}")
