...
class BulkResponseFormatter:
    ...
    @staticmethod
    def format_full(result, serializer=None):
        """
    ...
    @staticmethod
    def format_success(result, serializer=None, prefer_minimal=False):
        """
        ...
        return BulkResponseFormatter.format_full(result, serializer)

    @staticmethod
    def format_partial_success(result, serializer=None, prefer_minimal=False):
        """
