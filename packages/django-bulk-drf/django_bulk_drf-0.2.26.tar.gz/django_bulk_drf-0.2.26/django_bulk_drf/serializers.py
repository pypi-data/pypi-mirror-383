...
class BulkListSerializer(serializers.ListSerializer):
    ...
    def _prepare_operation_context(self):
        ...
        context = {
            ...
            "select_related_fields": getattr(view, "select_related_fields", None) if view else None,
            "prefetch_related_fields": getattr(view, "prefetch_related_fields", None) if view else None,
        }
        return context
