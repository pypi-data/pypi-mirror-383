...
class PortInputNode(BaseNode):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.nodes.port_node.PortInputNode
        :parts: 1
    ...
    def add_output(self, name='output', multi_output=True, display_name=True,
        ...
        """
        Warnings:
            This function is called by :meth:`NodeGraphQtPy.SubGraph.expand_group_node`
...
class PortOutputNode(BaseNode):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.nodes.port_node.PortOutputNode
        :parts: 1
