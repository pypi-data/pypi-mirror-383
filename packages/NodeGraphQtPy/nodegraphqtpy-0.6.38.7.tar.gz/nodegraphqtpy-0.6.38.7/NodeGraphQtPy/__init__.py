...
# -*- coding: utf-8 -*-
"""
**NodeGraphQtPy** is a node graph framework that can be implemented and re purposed
into applications that supports **PySide2**.

project: https://github.com/jchanvfx/NodeGraphQtPy
documentation: https://jchanvfx.github.io/NodeGraphQtPy/api/html/index.html
...
.. code-block:: python
    ...
    from NodeGraphQtPy import QtWidgets, NodeGraph, BaseNode
