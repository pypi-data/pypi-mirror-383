...
__doc__ = """
| The :py:mod:`NodeGraphQtPy.constants` namespace contains variables and enums 
 used throughout the NodeGraphQtPy library.
"""
...
class VersionEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.VersionEnum`
    """
...
class LayoutDirectionEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.ViewerLayoutEnum`
    """
...
class ViewerEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.ViewerEnum`
    """
...
class ViewerNavEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.ViewerNavEnum`
    """
...
class NodeEnum(Enum):
    """
    Node styling layout:
    :py:mod:`NodeGraphQtPy.constants.NodeEnum`
    """
    #: default node width.
    WIDTH = 160
    #: default node height.
...
class PortEnum(Enum):
    """
    Port styling layout:
    :py:mod:`NodeGraphQtPy.constants.PortEnum`
    """
    #: default port size.
    SIZE = 22.0
...
class PortTypeEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.PortTypeEnum`
    """
...
class PipeEnum(Enum):
    """
    Pipe styling layout:
    :py:mod:`NodeGraphQtPy.constants.PipeEnum`
    """
    #: default width.
    WIDTH = 1.2
    #: default color.
...
class PipeSlicerEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.PipeSlicerEnum`
    """
    #: default width.
    WIDTH = 1.5
    #: default color.
...
class PipeLayoutEnum(Enum):
    ...
    :py:mod:`NodeGraphQtPy.constants.PipeLayoutEnum`
    """
...
class NodePropWidgetEnum(Enum):
    """
    Mapping used for the :class:`NodeGraphQtPy.PropertiesBinWidget` to display a
    node property in the specified widget type.

    :py:mod:`NodeGraphQtPy.constants.NodePropWidgetEnum`
    """
