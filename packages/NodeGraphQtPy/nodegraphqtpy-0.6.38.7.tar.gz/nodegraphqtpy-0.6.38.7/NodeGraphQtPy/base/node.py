...
from NodeGraphQtPy.constants import NodePropWidgetEnum
...
class NodeObject(object):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodeObject
    ...
    .. important:: re-implement this attribute to provide a unique node type.
        ...
        .. code-block:: python
            ...
            from NodeGraphQtPy import NodeObject
    ...
    def graph(self):
        ...
        Returns:
            NodeGraphQtPy.NodeGraph: node graph instance.
        """
        return self._graph
    ...
    def create_property(self, name, value, items=None, range=None,
        ...
        Hint:
            ...
            :attr:`NodeGraphQtPy.constants.NodePropWidgetEnum`.

        Args:
            name (str): name of the property.
            value (object): data.
            items (list[str]): items used by widget type
                attr:`NodeGraphQtPy.constants.NodePropWidgetEnum.QCOMBO_BOX`
            range (tuple or list): ``(min, max)`` values used by
                :attr:`NodeGraphQtPy.constants.NodePropWidgetEnum.SLIDER`
            widget_type (int): widget flag to display in the
                :class:`NodeGraphQtPy.PropertiesBinWidget`
            widget_tooltip (str): widget tooltip for the property widget
                displayed in the :class:`NodeGraphQtPy.PropertiesBinWidget`
