...
from NodeGraphQtPy.constants import ViewerEnum, Z_VAL_NODE_WIDGET
...
class NodeBaseWidget(QtWidgets.QGraphicsProxyWidget):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodeBaseWidget
        :parts: 1
...
class NodeComboBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.widgets.node_widgets.NodeComboBox
        :parts: 1
...
class NodeLineEdit(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.widgets.node_widgets.NodeLineEdit
        :parts: 1
...
class NodeCheckBox(NodeBaseWidget):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.widgets.node_widgets.NodeCheckBox
        :parts: 1
