...
class _PortConnectionsContainer(QtWidgets.QWidget):
    ...
    def _on_focus_to_node(self, port):
        ...
        Args:
            port (NodeGraphQtPy.Port): connected port.
        """
        if port:
            node = port.node()
...
class NodePropEditorWidget(QtWidgets.QWidget):
    ...
    def get_widget(self, name):
        ...
        Returns:
            NodeGraphQtPy.custom_widgets.properties_bin.prop_widgets_abstract.BaseProperty: property widget.
        """
        if name == 'name':
...
class PropertiesBinWidget(QtWidgets.QWidget):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.PropertiesBinWidget
        :parts: 1
    ...
    See Also:
            :meth:`NodeGraphQtPy.BaseNode.add_custom_widget`,
            :meth:`NodeGraphQtPy.NodeObject.create_property`,
