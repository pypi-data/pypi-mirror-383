...
class NodeGraphMenu(object):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodeGraphMenu
        :parts: 1
    ...
    def get_command(self, name):
        ...
        Returns:
            NodeGraphQtPy.NodeGraphCommand: context menu command.
        """
...
class NodesMenu(NodeGraphMenu):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodesMenu
        :parts: 1
...
class NodeGraphCommand(object):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodeGraphCommand
        :parts: 1
