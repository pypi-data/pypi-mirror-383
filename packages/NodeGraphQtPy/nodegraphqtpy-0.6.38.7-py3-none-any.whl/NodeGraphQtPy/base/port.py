...
from NodeGraphQtPy.constants import PortTypeEnum
...
class Port(object):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.Port
    ...
    def add_accept_port_type(self, port_name, port_type, node_type):
        ...
        See Also:
            :meth:`NodeGraphQtPy.Port.add_reject_ports_type`,
            :meth:`NodeGraphQtPy.BaseNode.add_accept_port_type`
    ...
    def add_reject_port_type(self, port_name, port_type, node_type):
        ...
        See Also:
            :meth:`NodeGraphQtPy.Port.add_accept_ports_type`,
            :meth:`NodeGraphQtPy.BaseNode.add_reject_port_type`
    ...
    def rejected_port_types(self):
        ...
        See Also:
            :meth:`NodeGraphQtPy.BaseNode.rejected_port_types`
