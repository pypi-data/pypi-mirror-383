...
from NodeGraphQtPy.errors import NodeCreationError, NodeDeletionError
...
class NodeGraph(QtCore.QObject):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.NodeGraph
    ...
    :parameters: 
        :class:`NodeGraphQtPy.NodeGraphMenu` or :class:`NodeGraphQtPy.NodesMenu`, 
    ...
    def set_grid_mode(self, mode=None):
        ...
        (default: :attr:`NodeGraphQtPy.constants.ViewerEnum.GRID_DISPLAY_LINES`).

        See: :attr:`NodeGraphQtPy.constants.ViewerEnum`
    ...
    def _deserialize_context_menu(self, menu, menu_data, anchor_path=None):
        ...
        Args:
            menu (NodeGraphQtPy.NodeGraphMenu or NodeGraphQtPy.NodesMenu):
                parent context menu.
    ...
    def pipe_style(self):
        ...
        Returns:
            int: pipe style value. :attr:`NodeGraphQtPy.constants.PipeLayoutEnum`
        """
    ...
    def set_pipe_style(self, style=PipeLayoutEnum.CURVED.value):
        ...
        See: :attr:`NodeGraphQtPy.constants.PipeLayoutEnum`
    ...
    def set_layout_direction(self, direction):
        ...
        **Layout Types:**
        ...
        - :attr:`NodeGraphQtPy.constants.LayoutDirectionEnum.HORIZONTAL`
        - :attr:`NodeGraphQtPy.constants.LayoutDirectionEnum.VERTICAL`
    ...
    def paste_nodes(self):
        ...
        Returns:
            list[NodeGraphQtPy.BaseNode]: list of pasted node instances.
        """
        clipboard = QtWidgets.QApplication.clipboard()
...
class SubGraph(NodeGraph):
    ...
    :class:`NodeGraphQtPy.GroupNode`.

    .. inheritance-diagram:: NodeGraphQtPy.SubGraph
        :top-classes: PySide2.QtCore.QObject
    ...
    def _clone_context_menu_from_parent(self):
        ...
        def clone_menu(menu, menu_to_clone):
            """
            Args:
                menu (NodeGraphQtPy.NodeGraphMenu):
                menu_to_clone (NodeGraphQtPy.NodeGraphMenu):
            """
            sub_items = []
