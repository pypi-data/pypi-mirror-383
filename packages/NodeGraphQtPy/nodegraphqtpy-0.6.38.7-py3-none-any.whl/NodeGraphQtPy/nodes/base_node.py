...
from NodeGraphQtPy.base.commands import NodeVisibleCmd, NodeWidgetVisibleCmd
from NodeGraphQtPy.base.node import NodeObject
from NodeGraphQtPy.base.port import Port
from NodeGraphQtPy.constants import NodePropWidgetEnum, PortTypeEnum
from NodeGraphQtPy.errors import (
    PortError,
    PortRegistrationError,
    NodeWidgetError
)
from NodeGraphQtPy.qgraphics.node_base import NodeItem
from NodeGraphQtPy.widgets.node_widgets import (
    NodeBaseWidget,
    NodeCheckBox,
    NodeComboBox,
    NodeLineEdit
...
class BaseNode(NodeObject):
    ...
    .. inheritance-diagram:: NodeGraphQtPy.BaseNode
    ...
    def add_custom_widget(self, widget, widget_type=None, tab=None):
        ...
        Args:
            ...
            widget_type: widget flag to display in the
                ...
                (default: :attr:`NodeGraphQtPy.constants.NodePropWidgetEnum.HIDDEN`).
    ...
    def add_accept_port_type(self, port, port_type_data):
        ...
        See Also:
            :meth:`NodeGraphQtPy.BaseNode.accepted_port_types`

        Args:
            port (NodeGraphQtPy.Port): port to assign constrain to.
    ...
    def add_reject_port_type(self, port, port_type_data):
        ...
        See Also:
            :meth:`NodeGraphQtPy.Port.rejected_port_types`
