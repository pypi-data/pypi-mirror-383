...
def compare_before_after(before, after, evaluation):
    ...
    cv2.rectangle(before, (en_loc_before[3], en_loc_before[0]), (en_loc_before[1], en_loc_before[2]), (255, 0, 255), 2)
    ...
    cv2.rectangle(after, (en_loc_after[3], en_loc_after[0]), (en_loc_after[1], en_loc_after[2]), (255, 0, 255), 2)
