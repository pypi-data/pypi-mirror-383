    ...
    *For internal use only*
    ...
    def set(
...

        {
            ...
            # Scalars
            UniformType.BOOL:  lambda prog, name, val: setattr(prog[name], 'value', val),
            UniformType.INT:   lambda prog, name, val: setattr(prog[name], 'value', val),
            UniformType.FLOAT: lambda prog, name, val: setattr(prog[name], 'value', val),
            # Vectors
            UniformType.VECTOR2: lambda prog, name, val: setattr(prog[name], 'value', val),
            UniformType.VECTOR3: lambda prog, name, val: setattr(prog[name], 'value', val),
            UniformType.VECTOR4: lambda prog, name, val: setattr(prog[name], 'value', val),
            # Matrixes
        ...
        }.get(type)(self.program, name, value)
