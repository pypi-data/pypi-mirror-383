...
def __code_new_method__OperatorsPseudoSpectral3D__project_perpk3d_noloop():
...
def __code_new_method__OperatorsPseudoSpectral3D__project_perpk3d():
    return '\n\ndef new_method(self, vx_fft, vy_fft, vz_fft):\n    return backend_func(self.Kx, self.Ky, self.Kz, self.inv_K_square_nozero, vx_fft, vy_fft, vz_fft)\n\n'
...
def __code_new_method__OperatorsPseudoSpectral3D__divfft_from_vecfft():
...
def __code_new_method__OperatorsPseudoSpectral3D__rotfft_from_vecfft():
    return '\n\ndef new_method(self, vx_fft, vy_fft, vz_fft):\n    return backend_func(self.Kx, self.Ky, self.Kz, vx_fft, vy_fft, vz_fft)\n\n'
...
def __code_new_method__OperatorsPseudoSpectral3D__rotfft_from_vecfft_outin():
...
def __code_new_method__OperatorsPseudoSpectral3D__rotzfft_from_vxvyfft():
